import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as l,A as h}from"./iframe-badbAK5Z.js";import{I as y}from"./Input-0MH-m_Ya.js";import{L as p}from"./FieldTemplate-CQL0eRRj.js";import{u as g}from"./useTranslation-uxHS973M.js";const a=o=>e.jsx(y,{leftIcon:"SearchIcon",allowClear:!0,...o});a.__docgenInfo={description:`検索に特化した入力コンポーネント。
検索アイコンを標準装備し、入力がある場合はクリアボタンを表示します。`,methods:[],displayName:"SearchInput"};const b={title:"Components/Basic Inputs/SearchInput",component:a,tags:[]},r={render:function(i){const{t:n}=g(h);return e.jsx(p,{label:n("doc_search"),children:e.jsx(a,{...i,placeholder:n("story_searchinput_placeholder")})})}},s={render:function(i){const{t:n}=g(h),[_,S]=l.useState(""),[d,m]=l.useState([]),[v,u]=l.useState(!1),f=async t=>{if(S(t),!t.trim()){m([]);return}u(!0),await new Promise(c=>setTimeout(c,800)),m([n("components:smart_search_result_1",{val:t}),n("components:smart_search_result_2",{val:t}),n("components:smart_search_match",{val:t})]),u(!1)};return e.jsxs("div",{style:{width:400},children:[e.jsx(p,{label:n("components:smart_search_ai_title"),children:e.jsxs("div",{style:{position:"relative"},children:[e.jsx(a,{...i,width:400,value:_,onChange:t=>f(t.target.value),placeholder:n("components:smart_search_placeholder")}),v&&e.jsx("div",{style:{position:"absolute",right:40,top:"50%",transform:"translateY(-50%)",fontSize:12,color:"var(--wim-color-text-secondary)"},children:n("components:smart_search_thinking")})]})}),d.length>0&&e.jsxs("div",{style:{marginTop:8,padding:12,border:"1px solid var(--wim-color-border)",borderRadius:8,background:"var(--wim-color-surface-variant)"},children:[e.jsx("div",{style:{fontSize:12,fontWeight:"bold",marginBottom:8,color:"var(--wim-color-primary)"},children:n("components:smart_search_suggestions")}),e.jsx("ul",{style:{margin:0,paddingLeft:20,fontSize:14},children:d.map((t,c)=>e.jsx("li",{style:{padding:"4px 0"},children:t},c))})]})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
