"use client";
import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{t as r}from"./react-DmCNssFd.js";import{Cr as i,Sr as a,Tr as o,ur as s,xr as c}from"./iframe-DkmqI5Zh.js";import{gr as l,t as u}from"./src-BWkk1A6b.js";var d=e({Default:()=>h,Interactive:()=>g,Variants:()=>_,WithMaxLength:()=>v,__namedExportsOrder:()=>y,default:()=>m}),f,p,m,h,g,_,v,y,b=t((()=>{f=n(r(),1),i(),a(),u(),p=s(),m={title:`Components/Basic Inputs/SmartSearchInput`,component:l,parameters:{layout:`padded`}},h={render:e=>{let{t}=o(c);return(0,p.jsx)(l,{...e,placeholder:t(`story.smartsearchinput_placeholder`)})},args:{width:`md`}},g={render:()=>{let{t:e}=o(c),[t,n]=(0,f.useState)(``),[r,i]=(0,f.useState)([]);return(0,p.jsxs)(`div`,{style:{width:`100%`,maxWidth:`800px`,margin:`0 auto`,display:`flex`,flexDirection:`column`,gap:`24px`},children:[(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`p`,{style:{marginBottom:`8px`,fontSize:`14px`,color:`var(--wim-color-text-secondary)`},children:e(`story.smartsearchinput_interactive_hint`)}),(0,p.jsx)(l,{value:t,onChange:n,onSubmit:e=>{i(t=>[e,...t]),n(``)},placeholder:e(`story.smartsearchinput_ai_placeholder`),allowClear:!0,fullWidth:!0})]}),r.length>0&&(0,p.jsxs)(`div`,{children:[(0,p.jsx)(`p`,{style:{marginBottom:`8px`,fontSize:`13px`,fontWeight:600,color:`var(--wim-color-text-secondary)`},children:e(`story.smartsearchinput_submitted_label`)}),(0,p.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`8px`},children:r.map((e,t)=>(0,p.jsx)(`div`,{style:{padding:`8px 12px`,background:`var(--wim-color-ghost-bg)`,borderRadius:`var(--wim-radius-md)`,fontSize:`14px`,border:`1px solid var(--wim-color-border)`,overflowWrap:`break-word`,minWidth:0},children:e},t))})]})]})}},_={render:()=>{let{t:e}=o(c);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`24px`,width:`100%`,maxWidth:`800px`,margin:`0 auto`},children:[(0,p.jsx)(l,{variant:`outline`,placeholder:e(`story.smartsearchinput_placeholder`),fullWidth:!0}),(0,p.jsx)(l,{variant:`ghost`,placeholder:e(`story.smartsearchinput_placeholder`),fullWidth:!0}),(0,p.jsx)(l,{intent:`danger`,error:e(`story.smartsearch_error_invalid`),defaultValue:`error example`,fullWidth:!0})]})}},v={render:()=>{let{t:e}=o(c);return(0,p.jsx)(l,{placeholder:e(`story.smartsearchinput_placeholder`),maxLength:200,fullWidth:!0})}},y=[`Default`,`Interactive`,`Variants`,`WithMaxLength`],h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      t
...
}`,...v.parameters?.docs?.source}}}}));b();export{h as Default,g as Interactive,_ as Variants,v as WithMaxLength,y as __namedExportsOrder,m as default,b as n,d as t};