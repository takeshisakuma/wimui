import{j as s}from"./jsx-runtime-u17CrQMm.js";import{C as a}from"./Container-Bm1o3_En.js";import{B as o}from"./Box-CgPS2gkV.js";const i={title:"Component/Layout/Container",component:a,tags:[],argTypes:{size:{control:"select",options:["xs","sm","md","lg","xl"]}}},e={args:{children:s.jsx(o,{bg:"#f0f0f0",p:20,style:{border:"1px solid #ccc"},children:"Container content"}),bg:"#f9f9f9"}},r={render:()=>s.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:["xs","sm","md","lg","xl"].map(t=>s.jsx(a,{size:t,bg:"#f8fafc",p:10,children:s.jsxs(o,{bg:"#eff6ff",p:10,style:{textAlign:"center",border:"1px dashed #3b82f6"},children:["Size: ",t]})},t))})},n={args:{fluid:!0,bg:"#f8fafc",children:s.jsx(o,{bg:"#eff6ff",p:20,style:{textAlign:"center",border:"1px dashed #3b82f6"},children:"Fluid Container (100% width)"})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
