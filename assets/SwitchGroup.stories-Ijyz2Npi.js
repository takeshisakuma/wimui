import{j as a}from"./jsx-runtime-u17CrQMm.js";import{r as h}from"./iframe-8vWRHjs9.js";import{c as q}from"./index-BgvlPezX.js";import{S as x}from"./Switch-D3RXNKXf.js";import{u as b}from"./useTranslation-oYtfLuBR.js";const l=({options:t,value:r,defaultValue:n=[],onChange:u,direction:v="vertical",name:y,className:_,label:d})=>{const g=r!==void 0,[S,T]=h.useState(n),w=`wim-switch-group-label-${h.useId()}`,p=g?r:S,V=(e,m)=>{let c;m?c=[...p||[],e]:c=(p||[]).filter(j=>j!==e),g||T(c),u&&u(c)};return a.jsxs("div",{className:q("wim-switch-group",v==="horizontal"&&"wim-switch-group--horizontal",_),role:"group","aria-labelledby":d?w:void 0,children:[d&&a.jsx("div",{id:w,className:"wim-switch-group-label",children:d}),t.map(e=>a.jsx(x,{label:e.label,value:e.value,checked:(p||[]).includes(e.value),disabled:e.disabled,name:y,onChange:m=>V(e.value,m.target.checked)},e.value))]})};l.__docgenInfo={description:"SwitchGroup component to manage multiple switches.",methods:[],displayName:"SwitchGroup",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  value: string;
  disabled?: boolean;
