import{j as a}from"./jsx-runtime-u17CrQMm.js";import{c as j}from"./index-CjUQgNv4.js";import{I as M}from"./Icon-CMKyV0sw.js";import{A as o}from"./iframe-BZoygCoD.js";import{u as t}from"./useTranslation-CVcR0t5u.js";const n=({size:e="md",content:r,color:l="black",weight:_="normal",fontStyle:A="normal",iconName:S=void 0,iconPosition:h="left",decoration:f="none",className:E,style:L,children:T,...P})=>{const z=r??T,C={xs:"sm",sm:"sm",md:"md",lg:"lg",xl:"lg"}[e]||"md",x=S?a.jsx(M,{name:S,size:C}):null,N=a.jsxs(a.Fragment,{children:[S&&h==="left"&&x,a.jsx("span",{children:z}),S&&h==="right"&&x]}),b=l&&(l.startsWith("var(")||l.includes("#")||l.includes("rgb"));return a.jsx("span",{className:j("wim-span",`wim-span--${e}`,!b&&`wim-span--${l}`,_==="bold"&&"wim-span--bold",A==="italic"&&"wim-span--italic",f!=="none"&&`wim-span--${f}`,E),style:{color:b?l:void 0,...L},...P,children:N})};n.__docgenInfo={description:"",methods:[],displayName:"Span",props:{size:{required:!1,tsType:{name:"union",raw:'"xs" | "sm" | "md" | "lg" | "xl"',elements:[{name:"literal",value:'"xs"'},{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'},{name:"literal",value:'"xl"'}]},description:"",defaultValue:{value:'"md"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
...
}`,...y.parameters?.docs?.source}}};const O=["ExLargeSpan","LargeSpan","MediumSpan","SmallSpan","ExSmallSpan","SmallSpanWithIcon","LargeSpanWithIconOnRight","IconOnlySpan","BoldSpan","StrikethroughSpan","HighlightSpan"],$=Object.freeze(Object.defineProperty({__proto__:null,BoldSpan:g,ExLargeSpan:i,ExSmallSpan:u,HighlightSpan:y,IconOnlySpan:v,LargeSpan:s,LargeSpanWithIconOnRight:d,MediumSpan:m,SmallSpan:c,SmallSpanWithIcon:p,StrikethroughSpan:w,__namedExportsOrder:O,default:I},Symbol.toStringTag,{value:"Module"}));export{i as E,y as H,s as L,m as M,$ as S,c as a,p as b,w as c};
