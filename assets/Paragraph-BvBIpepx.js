import{j as m}from"./jsx-runtime-u17CrQMm.js";import{c as g}from"./index-CToQi8_n.js";import{u as d}from"./useTranslation-D3GemlCY.js";const w=({size:e="medium",content:l="text",color:a="black",weight:v="normal",lineHeight:r="normal-latn",fontStyle:u="normal",decoration:n="none",className:c,style:s,...h})=>{const{t:i}=d(),p=n!=="none"?m.jsx("span",{className:`wim-paragraph--${n}`,children:i(l)}):i(l),t=a&&(a.startsWith("var(")||a.includes("#")||a.includes("rgb")),o=r&&r.startsWith("var(");return m.jsx("p",{className:g("wim-paragraph",`wim-paragraph--${e==="ex-small"?"xs":e==="small"?"sm":e==="large"?"lg":e==="ex-large"?"xl":"md"}`,!o&&`wim-paragraph--${r}`,v==="bold"&&"wim-paragraph--bold",u==="italic"&&"wim-paragraph--italic",!t&&`wim-paragraph--${a}`,c),style:{color:t?a:void 0,lineHeight:o?r:void 0,...s},...h,children:p})};w.__docgenInfo={description:"",methods:[],displayName:"Paragraph",props:{size:{required:!1,tsType:{name:"union",raw:'"ex-small" | "small" | "medium" | "large" | "ex-large"',elements:[{name:"literal",value:'"ex-small"'},{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'},{name:"literal",value:'"ex-large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
