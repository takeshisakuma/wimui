import{j as e}from"./jsx-runtime-u17CrQMm.js";import{I as t}from"./Input-Dp0fzGkX.js";import{L as a}from"./FieldTemplate-8d9nFvBX.js";import{F as f}from"./FieldError-BqGaV8-X.js";import{A as l}from"./iframe-CrEaZ-m1.js";import{u as s}from"./useTranslation-C_YAF8hH.js";const L={title:"Components/Basic Inputs/Input",component:t,parameters:{layout:"centered"},args:{width:"md",fullWidth:!1,disabled:!1},argTypes:{variant:{control:"select",options:["default","outline","ghost"]},status:{control:"select",options:["default","error"]},disabled:{control:"boolean"},leftIcon:{control:"select",options:["SearchIcon"]},rightIcon:{control:"select",options:["ChevronDownIcon"]},leftIconColor:{control:"select",options:["primary","secondary","tertiary","destructive","positive","caution","informative","disabled"]},rightIconColor:{control:"select",options:["primary","secondary","tertiary","destructive","positive","caution","informative","disabled"]},width:{control:"select",options:["xs","sm","md","lg","xl","100%","200px","10ch"]},fullWidth:{control:"boolean"}}},c={render:function(n){const{t:r}=s(l);return e.jsx(a,{label:r("story_input_label_name"),children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_name")})})}},i={render:function(n){const{t:r}=s(l),g=()=>alert("Dropdown or Modal would open here!");return e.jsx(a,{label:r("story_input_label_dept"),children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_dept"),onClick:g,onRightIconClick:x=>{x.stopPropagation(),g()},readOnly:!0,style:{cursor:"pointer"}})})},args:{rightIcon:"ChevronDownIcon"}},d={render:function(n){const{t:r}=s(l);return e.jsx(a,{label:r("story_input_label_keyword"),children:e.jsx(t,{...n,allowClear:!0,placeholder:r("story_input_placeholder_keyword"),defaultValue:r("story_input_value_keyword")})})}},p={render:function(n){const{t:r}=s(l);return e.jsx(a,{label:r("story_input_label_company"),children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_company")})})},args:{variant:"outline"}},u={render:function(n){const{t:r}=s(l);return e.jsx(a,{label:r("story_input_label_remarks"),children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_remarks")})})},args:{variant:"ghost"}},_={render:function(n){const{t:r}=s(l);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[e.jsx(a,{label:r("story_input_label_email"),required:!0,children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_email"),defaultValue:"invalid-email@"})}),e.jsx(f,{content:r("story_input_error_email")})]})},args:{status:"error"}},h={render:function(n){const{t:r}=s(l);return e.jsx(a,{label:r("story_input_label_userid"),children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_userid")})})},args:{disabled:!0}},m={render:function(n){const{t:r}=s(l);return e.jsx(a,{label:r("story_input_label_contact"),style:{width:"100%"},children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_contact")})})},args:{fullWidth:!0},parameters:{layout:"padded"}},b={render:function(n){const{t:r}=s(l);return e.jsx(a,{label:r("story_input_label_search"),children:e.jsx(t,{...n,placeholder:r("story_input_placeholder_search")})})},args:{leftIcon:"SearchIcon"}},y={render:function(n){return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"24px",width:"100%",maxWidth:"800px"},children:[e.jsx(a,{label:"XS (80px - Secure Code)",children:e.jsx(t,{...n,width:"xs",placeholder:"000"})}),e.jsx(a,{label:"SM (160px - Zip Code)",children:e.jsx(t,{...n,width:"sm",placeholder:"000-0000"})}),e.jsx(a,{label:"MD (320px - Name)",children:e.jsx(t,{...n,width:"md",placeholder:"John Doe"})}),e.jsx(a,{label:"LG (480px - Company)",children:e.jsx(t,{...n,width:"lg",placeholder:"Antigravity Inc."})}),e.jsx(a,{label:"Custom (8ch - Always 8 chars)",children:e.jsx(t,{...n,width:"8ch",placeholder:"12345678"})})]})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
    ...
    return <div style={{
      ...
      gap: "8px"
        ...
        <Label label={t("story_input_label_email")} required>
          <Input {...args} placeholder={t("story_input_placeholder_email")} defaultValue="invalid-email@" />
        </Label>
