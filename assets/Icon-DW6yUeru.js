import{j as n}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as j}from"./index-BRZoJ6_p.js";import{M as h,C as d,a,I as r,e}from"./blocks-Bnoxqp6H.js";import{T as o}from"./T-DKX3xNM1.js";import{I as m,M as l,a as t}from"./Icon.stories-C79Z1jfl.js";import{I as c}from"./Icon-DjP0alSe.js";import"./iframe-CtzyBWFe.js";import"./preload-helper-PPVm8Dsz.js";import"./index-eq0L1KCm.js";import"./index-CnfAmiWZ.js";import"./index-CoLICJJZ.js";import"./index-BcttMTGM.js";import"./useTranslation-BoUpQfq3.js";import"./index-B7Z--H5j.js";function x(i){const s={code:"code",h1:"h1",h2:"h2",h3:"h3",h4:"h4",li:"li",p:"p",strong:"strong",ul:"ul",...j(),...i.components};return n.jsxs(n.Fragment,{children:[n.jsx(h,{of:m}),`
...
`,n.jsxs("table",{children:[n.jsx("thead",{children:n.jsxs("tr",{children:[n.jsx("th",{children:"項目"}),n.jsx("th",{children:"内容"})]})}),n.jsxs("tbody",{children:[n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"アニメーション"})}),n.jsx("td",{children:n.jsxs(s.p,{children:["単一のアイコンが無限に回転する（",n.jsx("code",{children:"rotate 360deg"}),"）"]})})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"用途"})}),n.jsx("td",{children:n.jsxs(s.p,{children:["ボタン内、入力フィールド、テキストの横など"," ",`
`,n.jsx("strong",{children:"インライン（行内）"})," で「処理中」を示す場合"]})})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"特徴"})}),n.jsx("td",{children:n.jsxs(s.p,{children:["既存の UI レイアウトに自然に溶け込むサイズ（",n.jsx("code",{children:"small"})," /"," ",`
`,n.jsx("code",{children:"medium"})," / ",n.jsx("code",{children:"large"}),"）で表示できる"]})})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"例"})}),n.jsx("td",{children:n.jsx(s.p,{children:"ボタン送信中のスピナー、検索実行中のインジケーター、データ更新中のアイコン"})})]})]})]}),`
`,n.jsx(s.h3,{id:"loader-コンポーネントのアニメーション",children:"Loader コンポーネントのアニメーション"}),`
`,n.jsxs("table",{children:[n.jsx("thead",{children:n.jsxs("tr",{children:[n.jsx("th",{children:"項目"}),n.jsx("th",{children:"内容"})]})}),n.jsxs("tbody",{children:[n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"アニメーション"})}),n.jsx("td",{children:n.jsxs(s.p,{children:[`複数の要素（3つのバーやドットなど）が時間差で動く波形アニメーション（
`,n.jsx("code",{children:"bars"})," / ",n.jsx("code",{children:"dots"})," / ",n.jsx("code",{children:"pulse"}),"）"]})})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"用途"})}),n.jsx("td",{children:n.jsxs(s.p,{children:["ページ全体やセクション単位で ",n.jsx("strong",{children:"コンテンツの読み込み待ち"})," ",`
を表示する場合`]})})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"特徴"})}),n.jsx("td",{children:n.jsxs(s.p,{children:[`視覚的なバリエーションが豊富で、独立した読み込みインジケーターとして存在感がある。
`,n.jsx("code",{children:"sm"})," / ",n.jsx("code",{children:"md"})," / ",n.jsx("code",{children:"lg"})," / ",n.jsx("code",{children:"xl"})," ",`
のサイズと複数のカラーに対応`]})})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"例"})}),n.jsx("td",{children:"ページ初期ロード、一覧データの取得中、コンテンツ切り替え時の表示"})]})]})]}),`
`,n.jsx(s.h3,{id:"早見表",children:"早見表"}),`
`,n.jsxs("table",{children:[n.jsx("thead",{children:n.jsxs("tr",{children:[n.jsx("th",{children:"観点"}),n.jsx("th",{children:n.jsxs(s.p,{children:["Icon（",n.jsx("code",{children:"LoadingIcon"})," / ",n.jsx("code",{children:"SpinnerIcon"}),"）"]})}),n.jsx("th",{children:"Loader コンポーネント"})]})}),n.jsxs("tbody",{children:[n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"アニメーション形式"})}),n.jsx("td",{children:"回転（rotate）"}),n.jsx("td",{children:"波形（bars / dots / pulse）"})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"表示場所"})}),n.jsx("td",{children:"インライン（テキストやボタンの横）"}),n.jsx("td",{children:"ページ・セクションの中央"})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"要素数"})}),n.jsx("td",{children:"単一アイコン"}),n.jsx("td",{children:"複数要素（3つのバー/ドット）"})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"主な用途"})}),n.jsx("td",{children:"アクション実行中のフィードバック"}),n.jsx("td",{children:"コンテンツ読み込み待ちの表示"})]}),n.jsxs("tr",{children:[n.jsx("td",{children:n.jsx("strong",{children:"サイズ"})}),n.jsx("td",{children:"small / medium / large"}),n.jsx("td",{children:"sm / md / lg / xl"})]})]})]}),`
...
`,n.jsxs(r,{children:[n.jsx(e,{name:"CircleIcon",children:n.jsx(c,{name:"CircleIcon"})}),n.jsx(e,{name:"SquareIcon",children:n.jsx(c,{name:"SquareIcon"})}),n.jsx(e,{name:"PlayIcon",children:n.jsx(c,{name:"PlayIcon"})}),n.jsx(e,{name:"PauseIcon",children:n.jsx(c,{name:"PauseIcon"})})]})]})}function D(i={}){const{wrapper:s}={...j(),...i.components};return s?n.jsx(s,{...i,children:n.jsx(x,{...i})}):x(i)}export{D as default};
