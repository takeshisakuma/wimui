...
export function clamp(value: number, min: number, max: number): number {
  ...
  return Math.min(Math.max(value, min), max);
}`}},f={args:{filename:`greet.ts`,onApply:a(),onReject:a(),isApplying:!0}},p={args:{filename:`greet.ts`,onApply:a(),onReject:a(),isApplied:!0}},m=[`Default`,`WithFilename`,`WithActions`,`UnifiedView`,`LargeDiff`,`Applying`,`Applied`],s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{}`,...s.parameters?.docs?.source}}},c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    filename: "greet.ts"
  }
...
}`,...p.parameters?.docs?.source}}}}));h();export{p as Applied,f as Applying,s as Default,d as LargeDiff,u as UnifiedView,l as WithActions,c as WithFilename,m as __namedExportsOrder,o as default,h as n,i as t};