import{j as a}from"./jsx-runtime-u17CrQMm.js";import{r as F,A as c}from"./iframe-BCt2Cqzi.js";import{c as A}from"./index-D0GPwUjE.js";import{B as U}from"./Button-BYZRdEHu.js";import{F as M}from"./FieldTemplate-X5NluK2C.js";import{u as t}from"./useTranslation-iqmbh8MZ.js";const n=({label:o,buttonLabel:l,noFileLabel:e,accept:S,multiple:T=!1,disabled:p=!1,onChange:b,className:v,iconName:N,iconPosition:h,size:m="md",error:I,required:x,layout:C="vertical"})=>{const{t:f}=t("common"),y=F.useRef(null),[g,j]=F.useState(null),q=l??f("fileupload.button"),E=e??f("fileupload.no_file"),R=()=>{y.current?.click()},w=_=>{const L=_.target.files;j(L),b&&b(L)},P=g?Array.from(g).map(_=>_.name).join(", "):E;return a.jsx(M,{label:o?f(o):void 0,error:I,required:x,layout:C,className:A("wim-file-upload",`wim-file-upload--${m}`,v),children:a.jsxs("div",{className:"wim-file-upload__controls",children:[a.jsx("input",{type:"file",ref:y,accept:S,multiple:T,disabled:p,onChange:w,className:"wim-file-upload__input","aria-hidden":"true",tabIndex:-1}),a.jsx(U,{label:q,onClick:R,disabled:p,variant:"outlined",icon:N,iconPosition:h,size:m}),a.jsx("span",{className:A("wim-file-upload__file-names",`wim-file-upload__file-names--${m}`,p&&"wim-file-upload__file-names--disabled"),children:P})]})})};n.__docgenInfo={description:"ユーザーがファイルを選択・アップロードするためのコンポーネント。",methods:[],displayName:"FileUpload",props:{label:{required:!1,tsType:{name:"string"},description:""},buttonLabel:{required:!1,tsType:{name:"string"},description:""},noFileLabel:{required:!1,tsType:{name:"string"},description:""},accept:{required:!1,tsType:{name:"string"},description:""},multiple:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(files: FileList | null) => void",signature:{arguments:[{type:{name:"union",raw:"FileList | null",elements:[{name:"FileList"},{name:"null"}]},name:"files"}],return:{name:"void"}}},description:""},className:{required:!1,tsType:{name:"string"},description:""},iconName:{required:!1,tsType:{name:'ReactComponentProps["name"]',raw:'React.ComponentProps<typeof Icon>["name"]'},description:""},iconPosition:{required:!1,tsType:{name:"union",raw:'"left" | "right"',elements:[{name:"literal",value:'"left"'},{name:"literal",value:'"right"'}]},description:""},size:{required:!1,tsType:{name:"union",raw:'"sm" | "md" | "lg"',elements:[{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'}]},description:"",defaultValue:{value:'"md"',computed:!1}},error:{required:!1,tsType:{name:"string"},description:""},required:{required:!1,tsType:{name:"boolean"},description:""},layout:{required:!1,tsType:{name:"union",raw:'"vertical" | "horizontal"',elements:[{name:"literal",value:'"vertical"'},{name:"literal",value:'"horizontal"'}]},description:"",defaultValue:{value:'"vertical"',computed:!1}}}};const z={title:"Components/Advanced Inputs/FileUpload",component:n,parameters:{layout:"centered"},argTypes:{onChange:{action:"changed"},iconName:{control:"select",options:["UploadIcon","CheckIcon","CopyIcon","SearchIcon"]},iconPosition:{control:"radio",options:["left","right"]},size:{control:"radio",options:["sm","md","lg"]}}},r={render:function(l){const{t:e}=t(c);return a.jsx(n,{...l,label:e("story.fileupload_label_profile"),buttonLabel:e("story.fileupload_btn_image"),noFileLabel:e("story.fileupload_no_file")})}},i={render:function(l){const{t:e}=t(c);return a.jsx(n,{...l,label:e("story.fileupload_label_doc"),buttonLabel:e("story.fileupload_btn_file"),noFileLabel:e("story.fileupload_no_file"),multiple:!0})}},s={render:function(l){const{t:e}=t(c);return a.jsx(n,{...l,label:e("story.fileupload_label_image_only"),buttonLabel:e("story.fileupload_btn_image"),noFileLabel:e("story.fileupload_no_file"),accept:"image/*",iconName:"ImageIcon",size:"lg"})}},u={render:function(l){const{t:e}=t(c);return a.jsx(n,{...l,label:e("story.fileupload_label_disabled"),buttonLabel:e("story.fileupload_btn_file"),noFileLabel:e("story.fileupload_no_file"),disabled:!0})}},d={render:function(l){const{t:e}=t(c);return a.jsx(n,{...l,label:e("story.fileupload_label_icon"),buttonLabel:e("story.fileupload_btn_upload"),noFileLabel:e("story.fileupload_no_file"),iconName:"UploadIcon",iconPosition:"left",size:"lg"})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
