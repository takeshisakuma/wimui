import{j as r}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-D-INtma0.js";import{B as d}from"./Button-22ALOdY4.js";import{S as y}from"./Stack-fpXGiEeG.js";import{A as u}from"./Alert-CXoUKBR2.js";import{C as h}from"./Container-Dof54Vgv.js";import{u as m}from"./useTranslation-gsjwUuWZ.js";class l extends p.Component{state={hasError:!1,error:null,errorInfo:null};static getDerivedStateFromError(t){return{hasError:!0,error:t}}componentDidCatch(t,e){this.setState({errorInfo:e}),this.props.onError?.(t,e),console.error("ErrorBoundary caught an error:",t,e)}reset=()=>{this.setState({hasError:!1,error:null,errorInfo:null}),this.props.onReset?.()};render(){const{hasError:t,error:e,errorInfo:o}=this.state,{children:c,fallback:i}=this.props;return t&&e?typeof i=="function"?i(e,o,this.reset):i||r.jsxs("div",{role:"alert",style:{padding:"20px",border:"1px solid red",borderRadius:"8px",background:"#fff5f5",maxWidth:"100%",boxSizing:"border-box",wordBreak:"break-word"},children:[r.jsx("h2",{style:{color:"red",marginTop:0},children:"Something went wrong."}),r.jsxs("details",{style:{whiteSpace:"pre-wrap",marginTop:"10px"},children:[e.toString(),r.jsx("br",{}),o?.componentStack]}),r.jsx("button",{onClick:this.reset,style:{marginTop:"15px",padding:"8px 16px",background:"red",color:"white",border:"none",borderRadius:"4px",cursor:"pointer"},children:"Try again"})]}):c}}l.__docgenInfo={description:`A standard React Error Boundary component that catches JavaScript errors
