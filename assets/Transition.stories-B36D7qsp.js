import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as l}from"./iframe-c-ynOOH6.js";import{T as i}from"./Transition-CaaMZL9C.js";import{B as d}from"./Button-BHht7yYi.js";import{S as a}from"./Stack-DMhI8vtO.js";import{C as c}from"./Card-CSUzD5iW.js";import{C as m}from"./Container-CsXRHiSY.js";import{u as f}from"./useTranslation-BS4yh-5V.js";const p={title:"Components/Utilities/Transition",component:i,parameters:{layout:"centered"},tags:[]},n={render:()=>{const[t,s]=l.useState(!1),{t:r}=f(["docs","common","components"]);return e.jsx(m,{size:"sm",children:e.jsxs(a,{align:"center",gap:"xl",py:"xl",children:[e.jsx(d,{animateWidth:!0,priority:"primary",onClick:()=>s(!t),label:r(t?"story_transition_hide_content":"story_transition_show_content")}),e.jsx(a,{h:100,align:"center",justify:"center",children:e.jsx(i,{show:t,enter:"fade-enter",enterFrom:"fade-enter-from",enterTo:"fade-enter-to",leave:"fade-leave",leaveFrom:"fade-leave-from",leaveTo:"fade-leave-to",children:e.jsx(c,{variant:"elevated",padding:"lg",style:{background:"var(--wim-color-surface, #ffffff)",border:"2px solid var(--wim-color-primary, #3b82f6)",color:"var(--wim-color-text-primary, #1e293b)",fontWeight:"bold",minWidth:"150px",textAlign:"center"},children:"Fade Content!"})})})]})})}},o={render:()=>{const[t,s]=l.useState(!1),{t:r}=f(["docs","common","components"]);return e.jsx(m,{size:"sm",children:e.jsxs(a,{align:"center",gap:"xl",py:"xl",children:[e.jsx("style",{children:`
