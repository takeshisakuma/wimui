"use client";
import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{Cr as n,Sr as r,Tr as i,ur as a,xr as o}from"./iframe-CIRVVv_5.js";import{n as s,t as c}from"./Icon-CUNLvyH3.js";import{n as l,t as u}from"./TreeSelect-DRjCeeQu.js";var d=e({CascadeMultiple:()=>_,Default:()=>g,DefaultExpanded:()=>b,Disabled:()=>x,ExclusiveMultiple:()=>v,Searchable:()=>y,__namedExportsOrder:()=>S,default:()=>p}),f,p,m,h,g,_,v,y,b,x,S,C=t((()=>{n(),r(),l(),s(),f=a(),p={title:`Components/Advanced Inputs/TreeSelect`,component:u},m=[{label:`story.treeselect_design`,value:`design`,icon:(0,f.jsx)(c,{name:`EditIcon`,size:`sm`}),children:[{label:`story.treeselect_colors`,value:`colors`,children:[{label:`story.treeselect_primary`,value:`primary`},{label:`story.treeselect_secondary`,value:`secondary`}]},{label:`story.treeselect_typography`,value:`typography`}]},{label:`story.treeselect_components`,value:`components`,icon:(0,f.jsx)(c,{name:`ProjectIcon`,size:`sm`}),children:[{label:`story.treeselect_button`,value:`button`},{label:`story.treeselect_input`,value:`input`}]}],h=(e,t)=>e.map(e=>({...e,label:typeof e.label==`string`?t(e.label):e.label,children:e.children?h(e.children,t):void 0})),g={render:e=>{let{t}=i(o),n=h(m,t);return(0,f.jsx)(u,{...e,treeData:n,placeholder:t(`story.treeselect_placeholder`)})}},_={render:e=>{let{t}=i(o),n=h(m,t);return(0,f.jsx)(u,{...e,treeData:n,multiple:!0,checkStrategy:`cascade`,defaultExpandedKeys:[`design`],placeholder:t(`story.treeselect_placeholder`)})}},v={render:e=>{let{t}=i(o),n=h(m,t);return(0,f.jsx)(u,{...e,treeData:n,multiple:!0,checkStrategy:`exclusive`,defaultExpandedKeys:[`design`],placeholder:t(`story.treeselect_placeholder`)})}},y={render:e=>{let{t}=i(o),n=h(m,t);return(0,f.jsx)(u,{...e,treeData:n,searchable:!0,placeholder:t(`story.treeselect_placeholder`)})}},b={render:e=>{let{t}=i(o),n=h(m,t);return(0,f.jsx)(u,{...e,treeData:n,defaultExpandedKeys:[`design`,`colors`],placeholder:t(`story.treeselect_placeholder`)})}},x={render:e=>{let{t}=i(o),n=h(m,t);return(0,f.jsx)(u,{...e,treeData:n,disabled:!0,value:`colors`,placeholder:t(`story.treeselect_placeholder`)})}},S=[`Default`,`CascadeMultiple`,`ExclusiveMultiple`,`Searchable`,`DefaultExpanded`,`Disabled`],g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      t
...
}`,...x.parameters?.docs?.source}}}}));C();export{_ as CascadeMultiple,g as Default,b as DefaultExpanded,x as Disabled,v as ExclusiveMultiple,y as Searchable,S as __namedExportsOrder,p as default,C as n,d as t};