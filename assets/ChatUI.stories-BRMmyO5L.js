  ...
  render: () => {
    ...
    return <div style={{
      height: "400px"
        ...
        <ChatContainer>
          <ChatMessageList>
            <ChatMessage position="left" showAvatar avatar={<ChatAvatar fallback="A" color="s5" />} senderName={t("story.chat_ai_assistant")} actions={feedback}>
              {t("story.chat_msg_1")}
            </ChatMessage>
            <ChatMessage position="left" showAvatar avatar={<ChatAvatar fallback="A" color="s5" />} senderName={t("story.chat_ai_assistant")} actions={feedback} actionsVisible={false}>
              {t("story.chat_msg_3")}
            </ChatMessage>
          </ChatMessageList>
          <ChatInput placeholder={t("chat.placeholder")} />
  ...
  render: () => {
    ...
    return <div style={{
      height: "400px"
        ...
        <ChatContainer>
          <ChatMessageList>
            <ChatMessage position="left" showAvatar avatar={<ChatAvatar fallback="S" color="s5" />} senderName={t("story.chat_support")}>
              {t("story.chat_msg_3")}
            </ChatMessage>
            <ChatMessage position="right" showAvatar avatar={<ChatAvatar fallback="Y" color="s18" />} senderName={t("story.chat_you")}>
              {t("story.chat_msg_4")}
            </ChatMessage>
          </ChatMessageList>
          <ChatInput placeholder={t("chat.placeholder")} />
      ...
      height: "100vh"
        ...
        <ChatContainer>
          <ChatMessageList ref={messageListRef}>
            {messages.map(msg => <ChatMessage key={msg.id} position={msg.position} variant={msg.variant} senderName={msg.sender} timestamp={msg.timestamp} showAvatar avatar={<ChatAvatar fallback={msg.sender?.charAt(0)} color={msg.position === "left" ? "s5" : "s18"} />}>
                {msg.text}
              </ChatMessage>)}
          </ChatMessageList>
        ...
        <ChatContainer>
          <ChatMessageList ref={messageListRef}>
            ...
            color: "var(--wim-color-text-on-primary)"
                    ...
                    </div> : <ChatAvatar fallback="Y" color="s18" />} actions={msg.position === "left" && !msg.isStreaming && msg.id !== "1" ? <MessageActions /> : undefined}>
