import{j as i}from"./jsx-runtime-u17CrQMm.js";import{R as b,r as y,A as c}from"./iframe-BIQ3_rbw.js";import{c as A}from"./index-B7ARqZ81.js";import{F as h}from"./FeedbackIcon-B9l_g0xa.js";import{F as j}from"./FeedbackCloseButton-DXBVBjP3.js";import{u as o}from"./useTranslation-Iz9XWB8E.js";const n=({id:s,title:t,description:e,icon:r,status:a,onClose:g,closable:N=!0,className:S})=>{const{t:_}=o(),[v,w]=b.useState(!0);if(!v)return null;const x=()=>{w(!1),g&&g(s)},T={success:"positive",error:"destructive",warning:"caution",info:"informative"};return i.jsx("div",{className:A("wim-notification",a&&`wim-notification--${a}`,S),role:"alert",children:i.jsxs("div",{className:"wim-notification-content",children:[(r||a)&&i.jsx("div",{className:"wim-notification-icon",children:i.jsx(h,{status:a,icon:r,size:"md",color:a?T[a]:void 0})}),i.jsxs("div",{className:"wim-notification-message-container",children:[i.jsx("div",{className:"wim-notification-title",children:typeof t=="string"?_(t):t}),e&&i.jsx("div",{className:"wim-notification-description",children:typeof e=="string"?_(e):e})]}),i.jsx(j,{onClose:N?x:void 0,className:"wim-notification-close",size:"sm"})]})})};y.createContext(void 0);n.__docgenInfo={description:"",methods:[],displayName:"Notification",props:{id:{required:!1,tsType:{name:"string"},description:"The unique identifier of notification"},title:{required:!0,tsType:{name:"ReactNode"},description:"The title of notification"},description:{required:!1,tsType:{name:"ReactNode"},description:"The description of notification"},icon:{required:!1,tsType:{name:"ReactNode"},description:"The icon of notification"},status:{required:!1,tsType:{name:"union",raw:'"info" | "success" | "warning" | "error"',elements:[{name:"literal",value:'"info"'},{name:"literal",value:'"success"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"error"'}]},description:"The status of notification"},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"(id?: string) => void",signature:{arguments:[{type:{name:"string"},name:"id"}],return:{name:"void"}}},description:"Callback when notification is closed"},closable:{required:!1,tsType:{name:"boolean"},description:"Whether to show close button",defaultValue:{value:"true",computed:!1}},className:{required:!1,tsType:{name:"string"},description:"Additional class name"}}};const E={title:"Components/Alerts & Notifications/Notification",component:n,tags:[],argTypes:{onClose:{action:"closed"}}},d={render:function(t){const{t:e}=o(c);return i.jsx(n,{...t,title:t.title||e("story.notification_title"),description:t.description||e("story.notification_desc")})}},l={render:function(t){const{t:e}=o(c);return i.jsx(n,{...t,title:t.title||e("story.notification_success_title"),description:t.description||e("story.notification_success_desc")})},args:{status:"success"}},u={render:function(t){const{t:e}=o(c);return i.jsx(n,{...t,title:t.title||e("story.notification_warning_title"),description:t.description||e("story.notification_warning_desc")})},args:{status:"warning"}},f={render:function(t){const{t:e}=o(c);return i.jsx(n,{...t,title:t.title||e("story.notification_error_title"),description:t.description||e("story.notification_error_desc")})},args:{status:"error"}},p={render:function(t){const{t:e}=o(c);return i.jsx(n,{...t,title:t.title||e("story.notification_info_title"),description:t.description||e("story.notification_info_desc")})},args:{status:"info"}},m={render:function(){const[t,e]=y.useState(!1),{t:r}=o(c);return i.jsxs("div",{style:{padding:"24px"},children:[i.jsx("button",{className:"wim-button wim-button--primary",onClick:()=>e(!0),children:r("story.notification_show")}),t&&i.jsx("div",{style:{marginTop:"24px"},children:i.jsx(n,{status:"success",title:r("story.notification_success_title"),description:r("story.notification_triggered_desc"),onClose:()=>e(!1)})})]})}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
