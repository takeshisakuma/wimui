import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as q}from"./index-Bwa-Lhar.js";import{A as u}from"./iframe-Bc6tRPQC.js";import{u as d}from"./useTranslation-DlPMeJ4i.js";const o=({size:t="md",content:e,cite:a,color:m="black",border:p=!0,className:g,children:y,...f})=>{const _=e??y;return r.jsxs("blockquote",{className:q("wim-quote",`wim-quote--${t}`,`wim-quote--${m}`,p&&"wim-quote--border",g),...f,children:[r.jsx("div",{className:"wim-quote__content",children:_}),a&&r.jsx("cite",{className:"wim-quote__cite",children:a})]})};o.__docgenInfo={description:"",methods:[],displayName:"Quote",props:{size:{required:!1,tsType:{name:"union",raw:'"sm" | "md" | "lg"',elements:[{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'}]},description:"",defaultValue:{value:'"md"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
