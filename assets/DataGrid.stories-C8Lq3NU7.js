import{j as t}from"./jsx-runtime-u17CrQMm.js";import{R as g}from"./iframe-Db9rXbo4.js";import{c as je}from"./index-BeEGmSlY.js";import{T as Ie,a as Te,b as Q,c as pe,d as Ae,e as X}from"./Table-CewS78I0.js";import{C as fe}from"./Checkbox-D4YA6uR3.js";import{P as ze}from"./Pagination-BsplIE8U.js";import{S as we}from"./Spinner-BmPXG_XI.js";import{E as Ge}from"./EmptyState-ah4km6N5.js";import{u as U}from"./useTranslation-CwCoJP0K.js";import{B as ge}from"./Badge-BZXVKPWW.js";import{B as Y}from"./Button-R6esN6DB.js";import{I as ee}from"./Icon-BR9xtm29.js";import{A as te}from"./i18nConstants-BpHxieg5.js";function Pe(e,r){return!r||e==="none"?"asc":e==="asc"?"desc":"none"}function l({columns:e,rows:r,loading:s=!1,selection:a=!1,selectedRowKeys:d=[],onSelectionChange:c,rowKey:y="id",sortConfig:u,onSort:x,pagination:w,loadMore:m,striped:D=!1,bordered:C=!1,hoverable:ne=!0,stickyHeader:k=!1,height:R,maxHeight:re,mobileCard:ae=!1,className:se,emptyMessage:Z,a11y_select_all_rows:J}){const{t:oe}=U(["components","common"]),ie=Z??oe("datagrid_empty"),_e=J??oe("a11y_select_all_rows"),[S,T]=g.useState({row:-1,col:a?-1:0}),ye=g.useRef(null),de=g.useRef(null);g.useEffect(()=>{if(!m||!m.hasMore||m.loading)return;const n=new IntersectionObserver(o=>{o[0].isIntersecting&&m.onLoadMore()},{threshold:m.threshold||.1});return de.current&&n.observe(de.current),()=>n.disconnect()},[m]);const he=n=>typeof y=="function"?y(n):n[y],xe=n=>{c&&c(n?r.map(o=>he(o)):[])},Se=(n,o)=>{c&&c(o?[...d,n]:d.filter(h=>h!==n))},ke=n=>{if(!x)return;const o=Pe(u?.direction||"none",u?.key===n);x(n,o)},be=r.length>0&&d.length===r.length,De=d.length>0&&d.length<r.length,ce={};let le=a?48:0,ve=20;e.forEach(n=>{if(n.fixed===!0||n.fixed==="left"){ce[n.key]={offset:le===0?0:`${le}px`,zIndex:ve--};let o=0;typeof n.width=="number"?o=n.width:typeof n.width=="string"&&n.width.endsWith("px")&&(o=parseInt(n.width,10)),le+=o}});const ue={};let me=0,Ce=20;[...e].reverse().forEach(n=>{if(n.fixed==="right"){ue[n.key]={offset:me===0?0:`${me}px`,zIndex:Ce--};let o=0;typeof n.width=="number"?o=n.width:typeof n.width=="string"&&n.width.endsWith("px")&&(o=parseInt(n.width,10)),me+=o}});const Re=n=>{const{row:o,col:h}=S;let p=o,i=h;const f=a?-1:0,j=e.length-1,A=-1,z=r.length-1;switch(n.key){case"ArrowRight":h<j&&i++;break;case"ArrowLeft":h>f&&i--;break;case"ArrowDown":o<z&&p++;break;case"ArrowUp":o>A&&p--;break;case"Home":n.ctrlKey&&(p=A),i=f;break;case"End":n.ctrlKey&&(p=z),i=j;break;case"Enter":case" ":{const v=document.activeElement;if(v?.getAttribute("role")==="columnheader")return;if(v?.classList.contains("wim-table__cell")){const G=v.querySelector('input, button, [role="button"]');G&&(G.click(),n.preventDefault())}return}default:return}(p!==o||i!==h)&&(n.preventDefault(),T({row:p,col:i}),setTimeout(()=>{ye.current?.querySelector(`[data-row="${p}"][data-col="${i}"]`)?.focus()},0))};return t.jsxs("div",{ref:ye,className:je("wim-datagrid",s&&"wim-datagrid--loading",se),role:"grid",tabIndex:0,onKeyDown:Re,children:[t.jsxs("div",{className:"wim-datagrid__container",children:[t.jsxs(Ie,{striped:D,bordered:C,hoverable:ne,stickyHeader:k,fullWidth:!0,height:R,maxHeight:re,mobileCard:ae,children:[t.jsx(Te,{children:t.jsxs(Q,{children:[a&&t.jsx(pe,{selection:!0,stickyLeft:!0,leftOffset:0,stickyZIndex:k?121:21,"data-row":-1,"data-col":-1,tabIndex:S.row===-1&&S.col===-1?0:-1,onFocus:()=>T({row:-1,col:-1}),children:t.jsx(fe,{checked:be,indeterminate:De,onChange:n=>xe(n.target.checked),"aria-label":_e,tabIndex:-1})}),e.map((n,o)=>{const h=n.fixed===!0||n.fixed==="left",p=n.fixed==="right",i=h?ce[n.key]:void 0,f=p?ue[n.key]:void 0;return t.jsx(pe,{style:{width:n.width,minWidth:n.width,maxWidth:n.width,textAlign:n.align},sortable:n.sortable,sortDirection:u?.key===n.key?u.direction:"none",onSort:()=>ke(n.key),stickyLeft:h,leftOffset:i?.offset,stickyRight:p,rightOffset:f?.offset,stickyZIndex:i?k?i.zIndex+100:i.zIndex:f?k?f.zIndex+100:f.zIndex:void 0,"data-row":-1,"data-col":o,tabIndex:S.row===-1&&S.col===o?0:-1,onFocus:()=>T({row:-1,col:o}),children:n.header},n.key)})]})}),t.jsxs(Ae,{children:[r.length===0&&!s?t.jsx(Q,{children:t.jsx(X,{colSpan:e.length+(a?1:0),children:t.jsx("div",{className:"wim-datagrid__empty",children:typeof ie=="string"?t.jsx(Ge,{title:"No Data",description:ie}):ie})})}):r.map((n,o)=>{const h=he(n),p=d.includes(h);return t.jsxs(Q,{selected:p,children:[a&&t.jsx(X,{selection:!0,stickyLeft:!0,leftOffset:0,stickyZIndex:21,"data-row":o,"data-col":-1,tabIndex:S.row===o&&S.col===-1?0:-1,onFocus:()=>T({row:o,col:-1}),children:t.jsx(fe,{checked:p,onChange:i=>Se(h,i.target.checked),"aria-label":oe("datagrid_select_row",{index:o+1}),tabIndex:-1})}),e.map((i,f)=>{const j=i.dataIndex?n[i.dataIndex]:n[i.key],A=i.fixed===!0||i.fixed==="left",z=i.fixed==="right",v=A?ce[i.key]:void 0,G=z?ue[i.key]:void 0;return t.jsx(X,{style:{minWidth:i.width,maxWidth:i.width,textAlign:i.align},label:typeof i.header=="string"?i.header:void 0,stickyLeft:A,leftOffset:v?.offset,stickyRight:z,rightOffset:G?.offset,stickyZIndex:v?.zIndex||G?.zIndex,"data-row":o,"data-col":f,tabIndex:S.row===o&&S.col===f?0:-1,onFocus:()=>T({row:o,col:f}),children:i.render?i.render(j,n,o):j},i.key)})]},h)}),m&&m.hasMore&&t.jsx(Q,{children:t.jsx(X,{colSpan:e.length+(a?1:0),children:t.jsx("div",{ref:de,className:"wim-datagrid__loader",children:m.loading&&t.jsx(we,{size:"small"})})})})]})]}),s&&t.jsx("div",{className:"wim-datagrid__loading-overlay",children:t.jsx(we,{size:"large"})})]}),w&&t.jsx("div",{className:"wim-datagrid__footer",children:t.jsx(ze,{total:w.total,pageSize:w.pageSize,current:w.current,onChange:w.onPageChange})})]})}l.__docgenInfo={description:"",methods:[],displayName:"DataGrid",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"DataGridColumn",elements:[{name:"T"}],raw:"DataGridColumn<T>"}],raw:"DataGridColumn<T>[]"},description:"Column definitions"},rows:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:"Data rows"},loading:{required:!1,tsType:{name:"boolean"},description:"Loading state",defaultValue:{value:"false",computed:!1}},selection:{required:!1,tsType:{name:"boolean"},description:"Whether to show selection checkboxes",defaultValue:{value:"false",computed:!1}},selectedRowKeys:{required:!1,tsType:{name:"Array",elements:[{name:"ReactKey",raw:"React.Key"}],raw:"React.Key[]"},description:"Array of selected row keys",defaultValue:{value:"[]",computed:!1}},onSelectionChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(selectedRowKeys: React.Key[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"ReactKey",raw:"React.Key"}],raw:"React.Key[]"},name:"selectedRowKeys"}],return:{name:"void"}}},description:"Callback when selection changes"},rowKey:{required:!1,tsType:{name:"union",raw:"keyof T | ((row: T) => React.Key)",elements:[{name:"T"},{name:"unknown"}]},description:"Unique key for each row",defaultValue:{value:'"id"',computed:!1}},sortConfig:{required:!1,tsType:{name:"signature",type:"object",raw:'{ key: string; direction: "asc" | "desc" | "none" }',signature:{properties:[{key:"key",value:{name:"string",required:!0}},{key:"direction",value:{name:"union",raw:'"asc" | "desc" | "none"',elements:[{name:"literal",value:'"asc"'},{name:"literal",value:'"desc"'},{name:"literal",value:'"none"'}],required:!0}}]}},description:"Current sort configuration"},onSort:{required:!1,tsType:{name:"signature",type:"function",raw:'(key: string, direction: "asc" | "desc" | "none") => void',signature:{arguments:[{type:{name:"string"},name:"key"},{type:{name:"union",raw:'"asc" | "desc" | "none"',elements:[{name:"literal",value:'"asc"'},{name:"literal",value:'"desc"'},{name:"literal",value:'"none"'}]},name:"direction"}],return:{name:"void"}}},description:"Callback when sorting changes"},pagination:{required:!1,tsType:{name:"signature",type:"object",raw:`{\r
  total: number;\r
  pageSize: number;\r
  current: number;\r
