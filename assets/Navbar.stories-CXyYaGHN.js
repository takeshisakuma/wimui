  ...
  render: () => <div style={{
    ...
    border: "1px solid #ccc"
      ...
      padding: "80px 20px"
        ...
        <p>\r
          On mobile (md and below), the links hide and a hamburger menu appears.\r
        </p>\r
      </div>\r
    </div>
