...
}`,...y.parameters?.docs?.source}}};const q=["Default","Top","Bottom","Left","Right","WithDelay"],S=Object.freeze(Object.defineProperty({__proto__:null,Bottom:f,Default:g,Left:x,Right:v,Top:h,WithDelay:y,__namedExportsOrder:q,default:R},Symbol.toStringTag,{value:"Module"}));export{f as B,g as D,x as L,v as R,S as T,y as W,h as a};
