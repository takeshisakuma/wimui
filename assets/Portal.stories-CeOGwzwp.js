import{j as n}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-D-2TzvPc.js";import{P as b}from"./Portal-B17e3Log.js";import{B as j}from"./Button-rBumGM_U.js";import{I as B}from"./Icon-CccJ-EGP.js";import{C as o}from"./Card-D5svk0r1.js";import{S as d}from"./Stack-DTrd9wlN.js";import{T as P}from"./Textarea-jSEARYVw.js";import{B as z}from"./Badge-C5nzORhf.js";import{C as I}from"./Container-BzjUh7eq.js";import{B as s}from"./Box-DXspQTY7.js";import{G as T}from"./Grid-C4xZlpQd.js";import{S as H}from"./SimpleGrid-BlBqlM7-.js";import{A as N}from"./Alert-RGt05qJG.js";import{u as S}from"./useTranslation-DD4zKDMJ.js";const A={title:"Components/Internal/Portal",component:b,parameters:{layout:"centered"},tags:[]},f={render:function(){const[a,i]=c.useState(!1),{t:e}=S(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return n.jsx(o,{variant:"outline",padding:"lg",style:{width:"100%",maxWidth:"400px",height:"250px",padding:"32px",position:"relative",overflow:"hidden"},children:n.jsxs(o.Body,{style:{height:"100%",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center"},children:[n.jsxs("div",{style:{textAlign:"center",marginBottom:"16px"},children:[n.jsx("p",{dangerouslySetInnerHTML:{__html:e("story_portal_desc_overflow")}}),n.jsx("p",{children:e("story_portal_desc_escape")})]}),n.jsx(j,{onClick:()=>i(!a),label:e(a?"story_portal_btn_hide":"story_portal_btn_show"),priority:"primary"}),a&&n.jsx(b,{children:n.jsxs(o,{variant:"elevated",padding:"lg",style:{position:"fixed",bottom:"40px",right:"40px",width:"280px",maxWidth:"calc(100vw - 80px)",zIndex:1e4,animation:"popUp 0.3s ease-out"},children:[n.jsx("style",{children:`
                                  @keyframes popUp {
                                      from { transform: translateY(20px); opacity: 0; }
                                      to { transform: translateY(0); opacity: 1; }
                                  }
                              `}),n.jsxs(d,{gap:"xs",children:[n.jsx("h4",{style:{margin:"0 0 8px 0",color:"var(--wim-primary)"},children:e("story_portal_power_title")}),n.jsx("p",{style:{margin:0,fontSize:"14px",lineHeight:"1.5"},dangerouslySetInnerHTML:{__html:e("story_portal_power_desc")}}),n.jsx(s,{mt:"md",textAlign:"right",children:n.jsx(j,{size:"small",label:e("story_portal_btn_ok"),onClick:()=>i(!1)})})]})]})})]})})}},g={render:function(){const[a,i]=c.useState(null),{t:e}=S(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return n.jsxs(I,{size:"md",children:[n.jsx("p",{children:e("story_portal_container_desc")}),n.jsxs(H,{cols:{base:1,sm:2},spacing:"lg",style:{marginTop:"24px"},children:[n.jsxs(o,{variant:"outline",children:[n.jsx(o.Header,{children:n.jsx("strong",{children:e("story_portal_source_title")})}),n.jsxs(o.Body,{children:[n.jsx("p",{style:{fontSize:"12px"},children:e("story_portal_source_desc")}),n.jsx(s,{mt:"md",style:{display:"flex",justifyContent:"center"},children:n.jsx(b,{container:a,children:n.jsx(N,{status:"success",icon:n.jsx(B,{name:"CheckCircleIcon"}),style:{width:"fit-content"},children:e("story_portal_sent_success")})})})]})]}),n.jsx(s,{ref:i,bg:"var(--wim-neutral-50, #f8fafc)",style:{border:"2px dashed var(--wim-primary, #3b82f6)",minHeight:"150px",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"8px"},children:!a&&n.jsx(s,{textAlign:"center",color:"primary",children:e("story_portal_loading")})})]})]})}},u={render:function(){const[a,i]=c.useState(null),[e,v]=c.useState([]),{t}=S(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]),C=(r,p="info")=>{const x=Math.random().toString(36).slice(2,9);v(m=>[{id:x,msg:r,type:p},...m].slice(0,10))},y=({name:r,type:p,color:x,displayName:m})=>{const[_,k]=c.useState(!1);return n.jsx(o,{variant:"outline",padding:"sm",children:n.jsxs(d,{gap:"xs",children:[n.jsx("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"center"},children:n.jsx("strong",{children:m})}),n.jsx(j,{size:"small",priority:_?"secondary":"primary",onClick:()=>{const l=!_;k(l),C(`${m}${t(l?"story_portal_log_started":"story_portal_log_stopped")}`,l?"success":"warning")},label:t(_?"story_portal_btn_stop":"story_portal_btn_start")}),_&&n.jsx(b,{container:a,children:n.jsxs("div",{style:{padding:"8px 12px",marginBottom:"8px",borderRadius:"4px",fontSize:"12px",background:x,border:"1px solid rgba(0,0,0,0.1)",animation:"slideIn 0.2s ease-out"},children:[n.jsx("style",{children:"@keyframes slideIn { from { opacity:0; transform:translateX(-10px); } to { opacity:1; transform:translateX(0); } }"}),n.jsxs("strong",{children:["[",m,"]"]})," ",t("story_portal_status_desc")]})})]})})};return n.jsx(I,{size:"xl",children:n.jsxs(T,{cols:{base:1,md:"1fr 300px"},gap:"xl",children:[n.jsxs(d,{gap:"md",children:[n.jsx("h4",{children:t("story_portal_panel_title")}),n.jsx("p",{style:{fontSize:"14px",color:"#666"},children:t("story_portal_panel_desc")}),n.jsxs(H,{cols:{base:1,sm:2},spacing:"md",children:[n.jsx(y,{name:"A",displayName:t("story_portal_sensor_a"),color:"#ecfdf5"}),n.jsx(y,{name:"B",displayName:t("story_portal_sensor_b"),color:"#eff6ff"}),n.jsx(y,{name:"C",displayName:t("story_portal_camera"),color:"#fff7ed"}),n.jsx(y,{name:"D",displayName:t("story_portal_alarm"),color:"#fef2f2"})]})]}),n.jsxs(o,{variant:"flat",style:{background:"#1e293b",color:"#f8fafc",minHeight:"400px",display:"flex",flexDirection:"column"},children:[n.jsx(o.Header,{style:{borderBottom:"1px solid #334155",color:"#94a3b8"},children:n.jsxs(d,{direction:"row",justify:"between",align:"center",children:[n.jsx("span",{style:{fontSize:"12px",fontWeight:"bold"},children:t("story_portal_monitor_title")}),n.jsx(z,{content:t("story_portal_monitor_live"),color:"error",size:"small"})]})}),n.jsxs(o.Body,{style:{flex:1,overflowY:"auto",padding:"12px"},children:[n.jsx(s,{ref:i,style:{marginBottom:"16px",borderBottom:"1px solid #334155",paddingBottom:"16px",minHeight:"20px"}}),n.jsxs("div",{style:{fontSize:"11px",fontFamily:"monospace"},children:[n.jsx("div",{style:{color:"#64748b",marginBottom:"8px"},children:t("story_portal_history_title")}),e.map(r=>n.jsx("div",{style:{marginBottom:"4px",color:r.type==="success"?"#4ade80":r.type==="warning"?"#fbbf24":"#94a3b8"},children:`> ${r.msg}`},r.id)),e.length===0&&n.jsx("div",{style:{color:"#475569"},children:t("story_portal_waiting")})]})]})]})]})})}},h={parameters:{layout:"fullscreen"},render:function(){const[a,i]=c.useState(null),[e,v]=c.useState(null),{t}=S(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]),C=[{id:1,title:t("story_portal_task1_title"),detail:t("story_portal_task1_detail")},{id:2,title:t("story_portal_task2_title"),detail:t("story_portal_task2_detail")},{id:3,title:t("story_portal_task3_title"),detail:t("story_portal_task3_detail")}],y=({task:r,isSelected:p,onSelect:x,container:m})=>{const[_,k]=c.useState("");return n.jsxs("div",{role:"button",tabIndex:0,onClick:()=>x(r.id),onKeyDown:l=>{(l.key==="Enter"||l.key===" ")&&x(r.id)},style:{padding:"16px",border:"1px solid",borderColor:p?"#3b82f6":"#e2e8f0",marginBottom:"12px",cursor:"pointer",background:p?"#eff6ff":"white",borderRadius:"8px",transition:"all 0.2s"},children:[n.jsxs(d,{direction:"row",justify:"between",align:"center",children:[n.jsx("strong",{children:r.title}),n.jsx(B,{name:"ChevronRightIcon",style:{color:p?"#3b82f6":"#cbd5e1"}})]}),p&&n.jsx(b,{container:m,children:n.jsxs("div",{style:{animation:"fadeInUp 0.3s ease-out"},children:[n.jsx("style",{children:"@keyframes fadeInUp { from { opacity: 0; transform: translateY(10px); } to { opacity: 1; transform: translateY(0); } }"}),n.jsx(z,{content:`TASK-00${r.id}`,variant:"outline",size:"small",style:{marginBottom:"12px"}}),n.jsx("h3",{style:{margin:"0 0 16px 0"},children:r.title}),n.jsx(o,{variant:"flat",style:{background:"#f8fafc",marginBottom:"20px"},children:n.jsx("p",{style:{margin:0,fontSize:"14px",lineHeight:"1.6",color:"#334155"},children:r.detail})}),n.jsxs(d,{direction:{base:"column",sm:"column",md:"column",lg:"column"},gap:"xs",children:[n.jsx("label",{style:{fontSize:"13px",fontWeight:"bold",color:"#64748b"},children:t("story_portal_task_memo")}),n.jsx(P,{value:_,onChange:l=>k(l.target.value),placeholder:t("story_portal_memo_placeholder"),rows:5,fullWidth:!0}),n.jsx("p",{style:{fontSize:"11px",color:"#94a3b8"},children:t("story_portal_memo_note")})]})]})})]})};return n.jsx(I,{size:"xl",className:"portal-side-container",children:n.jsxs(o,{variant:"outline",padding:"none",className:"side-panel-card",style:{overflow:"hidden"},children:[n.jsx("style",{children:`
...
}`,...u.parameters?.docs?.source},description:{story:`具体的なユースケース 1: 通知センター (ログ出力)\r
ページ内の特定のエリアを「通知受取用」として定義し、様々なコンポーネントから\r
情報を Portal で送り込む例です。`,...u.parameters?.docs?.description}}};h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  parameters: {
    layout: "fullscreen"
  },
  render: function Render() {
...
}`,...h.parameters?.docs?.source},description:{story:`具体的なユースケース 2: サイドパネル詳細表示\r
複雑なリストアイテムにおいて、UI的な制約で「詳細は画面端のパネルに出したい」が\r
「ロジックや状態はアイテム自身に持たせたい」という場合に Portal が役立ちます。`,...h.parameters?.docs?.description}}};const D=["OverflowEscape","CustomContainer","NotificationCenter","SidePanelDetail"],Q=Object.freeze(Object.defineProperty({__proto__:null,CustomContainer:g,NotificationCenter:u,OverflowEscape:f,SidePanelDetail:h,__namedExportsOrder:D,default:A},Symbol.toStringTag,{value:"Module"}));export{g as C,u as N,f as O,Q as P,h as S};
