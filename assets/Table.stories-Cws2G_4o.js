import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as M}from"./iframe-w6xcIbmN.js";import{P as o}from"./index-C20hvN60.js";import{I as q}from"./Icon-BREoFI_T.js";import{B as V}from"./Badge-BYi8F2oL.js";import{C as k}from"./Checkbox-C1Kkypvd.js";const a=({striped:n=!1,bordered:l=!1,hoverable:t=!1,fullWidth:i=!1,stickyHeader:c=!1,scrollbar:d="default",height:s,maxHeight:r,className:b,children:S,...v})=>{const w=["wim-table",n?"wim-table--striped":"",l?"wim-table--bordered":"",t?"wim-table--hoverable":"",i?"wim-table--full-width":"",c?"wim-table--sticky-header":"",b].filter(Boolean).join(" "),R=["wim-table-container",c?"wim-table-container--sticky":"",d==="subtle"?"subtle-scrollbar":"",d==="hidden"?"no-scrollbar":""].filter(Boolean).join(" "),B={height:s,maxHeight:r,overflow:s||r?"auto":void 0};return e.jsx("div",{className:R,style:B,children:e.jsx("table",{className:w,...v,children:S})})},_=({className:n,children:l,...t})=>e.jsx("thead",{className:["wim-table__header",n].filter(Boolean).join(" "),...t,children:l}),D=({className:n,children:l,...t})=>e.jsx("tbody",{className:["wim-table__body",n].filter(Boolean).join(" "),...t,children:l}),E=({className:n,children:l,...t})=>e.jsx("tfoot",{className:["wim-table__footer",n].filter(Boolean).join(" "),...t,children:l}),L=({selected:n=!1,className:l,children:t,...i})=>e.jsx("tr",{className:["wim-table__row",n?"wim-table__row--selected":"",l].filter(Boolean).join(" "),...i,children:t}),A=({sortable:n=!1,sortDirection:l="none",onSort:t,className:i,children:c,...d})=>{const s=["wim-table__head",n?"wim-table__head--sortable":"",d.selection?"wim-table__head--selection":"",i].filter(Boolean).join(" ");return e.jsx("th",{className:s,...d,onClick:n?t:d.onClick,children:e.jsxs("div",{className:"wim-table__head-content",children:[c,n&&e.jsx("span",{className:["wim-table__sort-icon",`wim-table__sort-icon--${l}`].join(" "),children:e.jsx(q,{name:"ChevronDownIcon",size:"small"})})]})})},N=({selection:n=!1,className:l,children:t,...i})=>e.jsx("td",{className:["wim-table__cell",n?"wim-table__cell--selection":"",l].filter(Boolean).join(" "),...i,children:t});a.Header=_;a.Body=D;a.Footer=E;a.Row=L;a.Head=A;a.Cell=N;a.propTypes={striped:o.bool,bordered:o.bool,hoverable:o.bool,fullWidth:o.bool,stickyHeader:o.bool,scrollbar:o.oneOf(["default","subtle","hidden"]),height:o.oneOfType([o.string,o.number]),maxHeight:o.oneOfType([o.string,o.number]),className:o.string,children:o.node.isRequired};a.__docgenInfo={description:"",methods:[{name:"Header",docblock:null,modifiers:["static"],params:[{name:`{\r
    className,\r
    children,\r
    ...props\r
...
}`,...j.parameters?.docs?.source}}};const P=["Default","Striped","Bordered","Hoverable","FullWidth","WithActions","Sortable","RowSelection","StickyHeader","SubtleScrollbar","HiddenScrollbar"],K=Object.freeze(Object.defineProperty({__proto__:null,Bordered:T,Default:m,FullWidth:f,HiddenScrollbar:j,Hoverable:h,RowSelection:y,Sortable:H,StickyHeader:u,Striped:p,SubtleScrollbar:x,WithActions:g,__namedExportsOrder:P,default:W},Symbol.toStringTag,{value:"Module"}));export{T as B,f as F,h as H,y as R,p as S,K as T,g as W,u as a,x as b,H as c};
