import{j as w}from"./jsx-runtime-u17CrQMm.js";import{R as d}from"./iframe-BCt2Cqzi.js";import{c as p}from"./index-D0GPwUjE.js";import{u as h}from"./useTranslation-iqmbh8MZ.js";const g=({tag:o="h1",size:n="xl",color:a="black",align:t="left",decoration:e="none",className:m,style:v,children:r,...c})=>{const{t:u}=h(),l=typeof r=="string"?u(r):r,s=e!=="none"?w.jsx("span",{className:e==="highlight"?"wim-heading__highlight":`wim-heading--${e}`,children:l}):l,i=a&&(a.startsWith("var(")||a.includes("#")||a.includes("rgb"));return d.createElement(o,{className:p("wim-heading",`wim-heading--${n}`,!i&&`wim-heading--${a}`,`wim-heading--${t}`,m),style:{color:i?a:void 0,...v},...c},s)};g.__docgenInfo={description:"",methods:[],displayName:"Heading",props:{tag:{required:!1,tsType:{name:"union",raw:'"h1" | "h2" | "h3" | "h4" | "h5" | "h6"',elements:[{name:"literal",value:'"h1"'},{name:"literal",value:'"h2"'},{name:"literal",value:'"h3"'},{name:"literal",value:'"h4"'},{name:"literal",value:'"h5"'},{name:"literal",value:'"h6"'}]},description:"The semantic HTML tag to use.",defaultValue:{value:'"h1"',computed:!1}},size:{required:!1,tsType:{name:"union",raw:'"xs" | "sm" | "md" | "lg" | "xl" | "2xl" | "3xl" | "4xl"',elements:[{name:"literal",value:'"xs"'},{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'},{name:"literal",value:'"xl"'},{name:"literal",value:'"2xl"'},{name:"literal",value:'"3xl"'},{name:"literal",value:'"4xl"'}]},description:"The visual size of the heading.",defaultValue:{value:'"xl"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
