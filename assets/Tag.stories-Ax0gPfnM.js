import{j as n}from"./jsx-runtime-u17CrQMm.js";import{I as d}from"./IndicatorBase-BknHWjsy.js";import{I as u}from"./Icon-mnVo4eg5.js";import{u as m}from"./useTranslation-BH3LN071.js";const s=({children:a,icon:r,...e})=>n.jsx(d,{prefixClass:"wim-tag",icon:r,...e,children:a});s.__docgenInfo={description:"カテゴリ分けや属性のラベルとして使用される非インタラクティブなコンポーネント。",methods:[],displayName:"Tag",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示するコンテンツ"},status:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
