import{j as n}from"./jsx-runtime-u17CrQMm.js";import{c as h}from"./index-H3n4JP4B.js";const g=({size:t="md",content:m,color:a="black",weight:v="normal",lineHeight:e="normal-latn",fontStyle:c="normal",decoration:r="none",className:u,style:s,children:w,...p})=>{const l=m??w,d=r!=="none"?n.jsx("span",{className:`wim-paragraph--${r}`,children:l}):l,i=a&&(a.startsWith("var(")||a.includes("#")||a.includes("rgb")),o=e&&e.startsWith("var(");return n.jsx("p",{className:h("wim-paragraph",`wim-paragraph--${t}`,!o&&`wim-paragraph--${e}`,v==="bold"&&"wim-paragraph--bold",c==="italic"&&"wim-paragraph--italic",!i&&`wim-paragraph--${a}`,u),style:{color:i?a:void 0,lineHeight:o?e:void 0,...s},...p,children:d})};g.__docgenInfo={description:"",methods:[],displayName:"Paragraph",props:{size:{required:!1,tsType:{name:"union",raw:'"xs" | "sm" | "md" | "lg" | "xl"',elements:[{name:"literal",value:'"xs"'},{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'},{name:"literal",value:'"xl"'}]},description:"",defaultValue:{value:'"md"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
