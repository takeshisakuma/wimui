import{j as n}from"./jsx-runtime-u17CrQMm.js";import{R as W,r as u}from"./iframe-B3BjqrJG.js";import{c as y}from"./index-C7GNrL9d.js";import{I as L}from"./Icon-DD0AwZFO.js";const o=({options:e,value:a,onChange:r,size:s="medium",fullWidth:j=!1,className:O,label:f})=>{const[z,b]=W.useState(null),w=W.useRef([]),I=`wim-segmented-label-${u.useId()}`,C=e.findIndex(t=>t.value===a),N={width:`calc((100% - 4px) / ${e.length})`,transform:`translateX(${C*100}%)`},q=(t,i)=>{let l=i;switch(t.key){case"ArrowLeft":case"ArrowUp":l=i-1,l<0&&(l=e.length-1);break;case"ArrowRight":case"ArrowDown":l=i+1,l>=e.length&&(l=0);break;default:return}t.preventDefault(),r(e[l].value),w.current[l]?.focus()};return n.jsxs("div",{className:y("wim-segmented-control-container",O),children:[f&&n.jsx("div",{id:I,className:"wim-label",style:{marginBottom:"8px"},children:f}),n.jsxs("div",{className:y("wim-segmented-control",`wim-segmented-control--${s==="small"?"sm":s==="large"?"lg":"md"}`,j&&"wim-segmented-control--full-width"),role:"radiogroup","aria-labelledby":f?I:void 0,children:[n.jsx("div",{className:"wim-segmented-control__slider",style:N,"aria-hidden":"true"}),e.map((t,i)=>{const l=t.value===a,V=l||C===-1&&i===0;return n.jsxs("button",{ref:x=>{w.current[i]=x},type:"button",className:y("wim-segmented-control__item",l&&"wim-segmented-control__item--active",!t.label&&t.iconName&&"wim-segmented-control__item--icon-only"),onClick:()=>r(t.value),onKeyDown:x=>q(x,i),onFocus:()=>b(i),onBlur:()=>b(null),role:"radio","aria-checked":l,tabIndex:V?0:-1,"aria-label":t.label||t.value,children:[t.iconName&&n.jsx(L,{name:t.iconName,size:s}),t.label&&n.jsx("span",{className:"wim-segmented-control__label",children:t.label})]},t.value)})]})]})};o.__docgenInfo={description:"",methods:[],displayName:"SegmentedControl",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
    label?: string;\r
    value: string;\r
    iconName?: "CircleIcon" | "SquareIcon" | "LoadingIcon" | "ExternalLinkIcon";\r
}`,signature:{properties:[{key:"label",value:{name:"string",required:!1}},{key:"value",value:{name:"string",required:!0}},{key:"iconName",value:{name:"union",raw:'"CircleIcon" | "SquareIcon" | "LoadingIcon" | "ExternalLinkIcon"',elements:[{name:"literal",value:'"CircleIcon"'},{name:"literal",value:'"SquareIcon"'},{name:"literal",value:'"LoadingIcon"'},{name:"literal",value:'"ExternalLinkIcon"'}],required:!1}}]}}],raw:"Option[]"},description:""},value:{required:!0,tsType:{name:"string"},description:""},onChange:{required:!0,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},size:{required:!1,tsType:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},label:{required:!1,tsType:{name:"string"},description:"アクセシビリティ用のラベル"}}};const _={title:"Component/Selection Controls/SegmentedControl",component:o,parameters:{layout:"centered"},argTypes:{size:{control:{type:"select"},options:["small","medium","large"]},fullWidth:{control:"boolean"}}},S=[{label:"Day",value:"day"},{label:"Week",value:"week"},{label:"Month",value:"month"}],c={args:{size:"small",fullWidth:!0},decorators:[e=>n.jsx("div",{style:{width:"100%",maxWidth:"600px"},children:n.jsx(e,{})})],render:e=>{const[a,r]=u.useState("day");return n.jsx(o,{...e,options:S,value:a,onChange:r})}},d={args:{size:"medium",fullWidth:!0},decorators:[e=>n.jsx("div",{style:{width:"100%",maxWidth:"600px"},children:n.jsx(e,{})})],render:e=>{const[a,r]=u.useState("day");return n.jsx(o,{...e,options:S,value:a,onChange:r})}},m={args:{size:"large",fullWidth:!0},decorators:[e=>n.jsx("div",{style:{width:"100%",maxWidth:"600px"},children:n.jsx(e,{})})],render:e=>{const[a,r]=u.useState("day");return n.jsx(o,{...e,options:S,value:a,onChange:r})}},g={args:{size:"medium",fullWidth:!0},render:e=>{const[a,r]=u.useState("on"),s=[{label:"On",value:"on"},{label:"Off",value:"off"}];return n.jsx(o,{...e,options:s,value:a,onChange:r})}},v={args:{size:"medium",fullWidth:!1},render:e=>{const[a,r]=u.useState("circle"),s=[{label:"Circle",value:"circle",iconName:"CircleIcon"},{label:"Square",value:"square",iconName:"SquareIcon"},{label:"External",value:"external",iconName:"ExternalLinkIcon"}];return n.jsx(o,{...e,options:s,value:a,onChange:r})}},p={args:{size:"medium",fullWidth:!1},render:e=>{const[a,r]=u.useState("circle"),s=[{value:"circle",iconName:"CircleIcon"},{value:"square",iconName:"SquareIcon"},{value:"external",iconName:"ExternalLinkIcon"}];return n.jsx(o,{...e,options:s,value:a,onChange:r})}},h={args:{size:"medium",fullWidth:!0},decorators:[e=>n.jsx("div",{style:{width:"100%",maxWidth:"600px"},children:n.jsx(e,{})})],render:e=>{const[a,r]=u.useState("long1"),s=[{label:"This is a very long text label that might cause overflow",value:"long1"},{label:"Another long text variant",value:"long2"},{label:"Short",value:"short"}];return n.jsx(o,{...e,options:s,value:a,onChange:r})}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    size: "small",
    fullWidth: true
  },
