import{j as n}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-OBwMRLSV.js";import{P as i}from"./Portal-Lq4WXo4h.js";import{B as s}from"./Button-Dcn0nTG2.js";import{I as d}from"./Icon-CD7KZzHo.js";const l={title:"Component/Utilities/Portal",component:i,parameters:{layout:"centered"},tags:[]},r={render:()=>{const[e,o]=a.useState(!1);return n.jsxs("div",{style:{width:"100%",maxWidth:"400px",height:"200px",border:"2px dashed #999",padding:"20px",position:"relative",overflow:"hidden",display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",background:"#f9f9f9",borderRadius:"8px"},children:[n.jsxs("div",{style:{textAlign:"center",marginBottom:"10px"},children:[n.jsxs("p",{children:["このグレーの枠線内は ",n.jsx("strong",{children:"overflow: hidden"})," です。"]}),n.jsx("p",{children:"Portal を使わないと右下のポップアップは見切れてしまいます。"})]}),n.jsx(s,{onClick:()=>o(!e),label:e?"メッセージを閉じる":"身代わり（Portal）を表示",priority:"primary"}),e&&n.jsx(i,{children:n.jsxs("div",{style:{position:"fixed",bottom:"40px",right:"40px",width:"280px",maxWidth:"calc(100vw - 80px)",backgroundColor:"#333",color:"white",padding:"20px",borderRadius:"12px",boxShadow:"0 10px 25px rgba(0,0,0,0.2)",zIndex:1e4,border:"1px solid #444",animation:"popUp 0.3s ease-out"},children:[n.jsx("style",{children:`
                                @keyframes popUp {
                                    from { transform: translateY(20px); opacity: 0; }
                                    to { transform: translateY(0); opacity: 1; }
                                }
                            `}),n.jsx("h4",{style:{margin:"0 0 8px 0",color:"#60a5fa"},children:"Portal の力"}),n.jsxs("p",{style:{margin:0,fontSize:"14px",lineHeight:"1.5"},children:["私は親要素の ",n.jsx("code",{children:"overflow: hidden"})," を無視して、画面の右下に独立して表示されています。"]}),n.jsx("div",{style:{marginTop:"12px",textAlign:"right"},children:n.jsx(s,{size:"small",label:"了解",onClick:()=>o(!1)})})]})})]})}},t={render:()=>{const[e,o]=a.useState(null);return n.jsxs("div",{style:{width:"100%",maxWidth:"500px"},children:[n.jsx("p",{children:"下の青い枠は Portal の「転送先（container）」です。"}),n.jsxs("div",{style:{display:"flex",gap:"20px",marginTop:"20px",flexWrap:"wrap"},children:[n.jsxs("div",{style:{flex:"1 1 200px",padding:"20px",border:"1px solid #ddd",borderRadius:"8px"},children:[n.jsx("h4",{children:"送信元"}),n.jsx("p",{style:{fontSize:"12px",color:"#666"},children:"ここに Portal コンポーネントを配置しています。"}),n.jsx(i,{container:e,children:n.jsxs("div",{style:{padding:"10px",background:"#dcfce7",border:"1px solid #166534",color:"#166534",borderRadius:"4px",fontSize:"14px",fontWeight:"bold",textAlign:"center",display:"flex",alignItems:"center",justifyContent:"center",gap:"8px"},children:[n.jsx(d,{name:"CheckCircleIcon",style:{width:"20px",height:"20px"}}),"送信完了！"]})})]}),n.jsx("div",{ref:o,style:{flex:"1 1 200px",padding:"20px",border:"2px solid #3b82f6",borderRadius:"8px",background:"#eff6ff",minHeight:"100px",display:"flex",alignItems:"center",justifyContent:"center"},children:!e&&n.jsx("span",{style:{color:"#3b82f6"},children:"読み込み中..."})})]})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  render: () => {
...
}`,...t.parameters?.docs?.source},description:{story:"特定の DOM 要素へのレンダリング例",...t.parameters?.docs?.description}}};const p=["OverflowEscape","CustomContainer"],g=Object.freeze(Object.defineProperty({__proto__:null,CustomContainer:t,OverflowEscape:r,__namedExportsOrder:p,default:l},Symbol.toStringTag,{value:"Module"}));export{t as C,r as O,g as P};
