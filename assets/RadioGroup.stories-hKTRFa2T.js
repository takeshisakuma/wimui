import{j as n}from"./jsx-runtime-u17CrQMm.js";import{r as c}from"./iframe-C5pzRvkm.js";import{c as V}from"./index-DRNRcLaq.js";import{R as S}from"./Radio-BaWwjyEo.js";const i=({options:l,value:s,defaultValue:m,onChange:p,direction:g="vertical",name:v,className:f})=>{const d=s!==void 0,[b,h]=c.useState(m),y=d?s:b,O=e=>{d||h(e),p&&p(e)};return n.jsx("div",{className:V("wim-radio-group",g==="horizontal"&&"wim-radio-group--horizontal",f),role:"radiogroup",children:l.map(e=>n.jsx(S,{label:e.label,value:e.value,checked:y===e.value,disabled:e.disabled,name:v,onChange:()=>O(e.value)},e.value))})};i.__docgenInfo={description:"RadioGroup component to manage multiple radio buttons.",methods:[],displayName:"RadioGroup",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{\r
    label: string;\r
    value: string;\r
    disabled?: boolean;\r
