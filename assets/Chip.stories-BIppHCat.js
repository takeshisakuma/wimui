import{j as e}from"./jsx-runtime-u17CrQMm.js";import{C as n}from"./Chip-D9gRXFrT.js";import{I as m}from"./Icon-FTO_0HBc.js";import{A as y}from"./Avatar-Bs6h9-pu.js";import{u as t}from"./useTranslation-BONq47qB.js";const g={title:"Components/Selection Controls/Chip",component:n,tags:[],argTypes:{status:{control:"select",options:["primary","secondary","neutral"]},variant:{control:"select",options:["solid","outline"]},size:{control:"select",options:["small","medium"]},onClick:{action:"clicked"},onDelete:{action:"deleted"}},parameters:{docs:{description:{component:"Data Display/Chip Component"}}}},a={render:function(o){const{t:s}=t(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return e.jsx(n,{...o,label:s("story_chip_default")})}},r={render:function(o){const{t:s}=t(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return e.jsx(n,{...o,label:s("story_chip_clickable"),onClick:u=>console.log("Chip clicked",u)})}},i={render:function(o){const{t:s}=t(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return e.jsx(n,{...o,label:s("story_chip_deletable"),onDelete:u=>console.log("Chip deleted",u)})}},d={render:function(o){return e.jsx(n,{...o,label:"Jane Doe",avatar:e.jsx(y,{initials:"JD",size:"small"})})}},l={render:function(o){const{t:s}=t(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return e.jsx(n,{...o,label:s("story_selectbox_opt4"),icon:e.jsx(m,{name:"CircleIcon",size:"small"})})}},_={render:function(o){const{t:s}=t(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return e.jsx(n,{...o,label:s("story_chip_selected"),selected:!0,onClick:()=>{}})}},p={render:function(o){const{t:s}=t(["docs","docs_guides","docs_actions","docs_inputs","docs_display","docs_navigation","docs_overlay","docs_layout","docs_stories","common","components"]);return e.jsxs("div",{style:{display:"flex",gap:"10px"},children:[e.jsx(n,{...o,label:s("story_chip_solid"),variant:"solid",onClick:()=>{}}),e.jsx(n,{...o,label:s("story_chip_outline"),variant:"outline",onClick:()=>{}}),e.jsx(n,{...o,label:s("story_chip_selected_label"),variant:"outline",selected:!0,onClick:()=>{}})]})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
