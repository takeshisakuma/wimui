import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-B26gg4xa.js";import{T as l}from"./Transition-DfSbECAL.js";import{B as v}from"./Button-CJxFN8BM.js";const y={title:"Component/Utilities/Transition",component:l,parameters:{layout:"centered"},tags:[]},f=({show:t,onClick:n,label:d})=>{const i=a.useRef(null),[c,m]=a.useState("auto");return a.useLayoutEffect(()=>{if(i.current){const p=i.current.offsetWidth;m(p);const r=i.current,h=r.style.width;r.style.width="auto",r.style.minWidth="0";const u=r.offsetWidth;r.style.width=h;const x=requestAnimationFrame(()=>{m(u)});return()=>cancelAnimationFrame(x)}},[d]),e.jsx(v,{ref:i,onClick:n,label:d,priority:"primary",style:{transition:"width 300ms cubic-bezier(0.4, 0, 0.2, 1), transform 0.2s, background-color 0.2s",width:c==="auto"?"auto":`${c}px`,minWidth:"0",overflow:"hidden",whiteSpace:"nowrap"}})},o={render:()=>{const[t,n]=a.useState(!1);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"20px"},children:[e.jsx(f,{show:t,onClick:()=>n(!t),label:t?"非表示にする":"コンテンツを表示する"}),e.jsx("div",{style:{height:"100px"},children:e.jsx(l,{show:t,enter:"fade-enter",enterFrom:"fade-enter-from",enterTo:"fade-enter-to",leave:"fade-leave",leaveFrom:"fade-leave-from",leaveTo:"fade-leave-to",children:e.jsx("div",{style:{width:"100px",height:"100px",background:"var(--wim-primary, #0070f3)",color:"white",display:"flex",alignItems:"center",justifyContent:"center",borderRadius:"8px",boxShadow:"0 4px 12px rgba(0,0,0,0.1)"},children:"Fade!"})})})]})}},s={render:()=>{const[t,n]=a.useState(!1);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",alignItems:"center",gap:"20px"},children:[e.jsx("style",{children:`
...
}`,...s.parameters?.docs?.source}}};const w=["Fade","Slide"],T=Object.freeze(Object.defineProperty({__proto__:null,Fade:o,Slide:s,__namedExportsOrder:w,default:y},Symbol.toStringTag,{value:"Module"}));export{o as F,s as S,T};
