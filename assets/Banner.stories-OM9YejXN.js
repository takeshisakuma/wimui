import{j as n}from"./jsx-runtime-u17CrQMm.js";import{c as R}from"./index-RI8tovNH.js";import{F as j}from"./FeedbackIcon-rfsCj7q7.js";import{F as w}from"./FeedbackCloseButton-BqXC7Pl3.js";import{u as a}from"./useTranslation-CQ4FXEP8.js";import{B as A}from"./Button-DtwumVcK.js";import{A as o}from"./iframe-CIEHBSGf.js";const s=({title:t,description:r,status:e="info",icon:b=!0,extra:y,onClose:N,className:S,children:f,...x})=>{const{t:g}=a();return n.jsx("div",{className:R("wim-banner",`wim-banner--${e}`,S),role:"banner",...x,children:n.jsxs("div",{className:"wim-banner__container",children:[n.jsxs("div",{className:"wim-banner__content",children:[b!==!1&&n.jsx("div",{className:"wim-banner__icon",children:n.jsx(j,{status:e,icon:typeof b=="boolean"?void 0:b,size:"small"})}),n.jsxs("div",{className:"wim-banner__text",children:[t&&n.jsx("span",{className:"wim-banner__title",children:g(t)}),t&&(r||f)&&n.jsx("span",{className:"wim-banner__separator",children:" - "}),(r||f)&&n.jsx("span",{className:"wim-banner__description",children:r?g(r):f})]})]}),n.jsxs("div",{className:"wim-banner__actions",children:[y&&n.jsx("div",{className:"wim-banner__action",children:y}),n.jsx(w,{onClose:N,className:"wim-banner__close",size:"small"})]})]})})};s.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。
