import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as s}from"./iframe-Be3gXwOX.js";import{c as V}from"./index-CL3wGj0C.js";import{T as N}from"./Textarea-C4P1DPpA.js";import{L as w}from"./Label-mcYgyGlz.js";const c=({options:a,trigger:p="@",value:M,defaultValue:k,onChange:m,onSelect:S,...L})=>{const[_,j]=s.useState(k||""),y=M!==void 0,h=y?M:_,[D,l]=s.useState(!1),[I,O]=s.useState(""),[q,E]=s.useState(0),[A,x]=s.useState(-1),[b,v]=s.useState(0),g=s.useRef(null),P=s.useRef(null),r=a.filter(e=>e.display.toLowerCase().includes(I.toLowerCase())),R=e=>{const n=e.target.value,f=e.target.selectionStart;E(f),y||j(n),m&&m(e);const o=n.slice(0,f),i=o.lastIndexOf(p);if(i!==-1){const C=o.slice(i+p.length);if(!C.includes(" ")){x(i),O(C),l(!0),v(0);return}}l(!1),x(-1)},T=e=>{const n=h.slice(0,A),f=h.slice(q),o=`${n}${p}${e.display} ${f}`;y||j(o),m&&m({target:{value:o},currentTarget:{value:o}}),S&&S(e),l(!1),x(-1),setTimeout(()=>{if(g.current){g.current.focus();const i=n.length+p.length+e.display.length+1;g.current.setSelectionRange(i,i)}},0)},U=e=>{D&&r.length>0&&(e.key==="ArrowDown"?(e.preventDefault(),v(n=>(n+1)%r.length)):e.key==="ArrowUp"?(e.preventDefault(),v(n=>(n-1+r.length)%r.length)):e.key==="Enter"||e.key==="Tab"?(e.preventDefault(),T(r[b])):e.key==="Escape"&&l(!1))};return t.jsxs("div",{className:"wim-mentions-container",ref:P,children:[t.jsx(N,{...L,ref:g,value:h,onChange:R,onKeyDown:U,onBlur:()=>{setTimeout(()=>l(!1),200)}}),D&&r.length>0&&t.jsx("div",{className:"wim-mentions-list",role:"listbox",children:r.map((e,n)=>t.jsx("div",{className:V("wim-mentions-item",n===b&&"wim-mentions-item--selected"),onClick:()=>T(e),role:"option","aria-selected":n===b,tabIndex:-1,children:e.display},e.id))})]})};c.__docgenInfo={description:"テキスト入力中に特定の文字（@など）をトリガーにして候補を表示し、選択できるようにするコンポーネント。",methods:[],displayName:"Mentions",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  id: string | number;
  display: string;
