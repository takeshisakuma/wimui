import{j as r}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-3pJU0r9w.js";import{B as c}from"./Button-CjpAdaFM.js";class a extends p.Component{state={hasError:!1,error:null,errorInfo:null};static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,n){this.setState({errorInfo:n}),this.props.onError?.(e,n),console.error("ErrorBoundary caught an error:",e,n)}reset=()=>{this.setState({hasError:!1,error:null,errorInfo:null}),this.props.onReset?.()};render(){const{hasError:e,error:n,errorInfo:i}=this.state,{children:d,fallback:l}=this.props;return e&&n?typeof l=="function"?l(n,i,this.reset):l||r.jsxs("div",{role:"alert",style:{padding:"20px",border:"1px solid red",borderRadius:"8px",background:"#fff5f5"},children:[r.jsx("h2",{style:{color:"red",marginTop:0},children:"Something went wrong."}),r.jsxs("details",{style:{whiteSpace:"pre-wrap",marginTop:"10px"},children:[n.toString(),r.jsx("br",{}),i?.componentStack]}),r.jsx("button",{onClick:this.reset,style:{marginTop:"15px",padding:"8px 16px",background:"red",color:"white",border:"none",borderRadius:"4px",cursor:"pointer"},children:"Try again"})]}):d}}a.__docgenInfo={description:`A standard React Error Boundary component that catches JavaScript errors
...
}`,...t.parameters?.docs?.source}}};const m=["Default","CustomFallback"],x=Object.freeze(Object.defineProperty({__proto__:null,CustomFallback:t,Default:o,__namedExportsOrder:m,default:h},Symbol.toStringTag,{value:"Module"}));export{t as C,o as D,x as E};
