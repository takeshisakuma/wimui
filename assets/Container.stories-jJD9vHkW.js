import{j as n}from"./jsx-runtime-u17CrQMm.js";import{C as a}from"./Container-r2Mox7bB.js";import{B as i}from"./Box-BolIhvCT.js";import{A as c}from"./iframe-By123agS.js";import{u as l}from"./useTranslation-svuQDxOH.js";const m={title:"Components/Layout/Container",component:a,tags:[],argTypes:{size:{control:"radio",options:["xs","sm","md","lg","xl"]}}},e={render:function(o){const{t:r}=l(c);return n.jsx(a,{...o,children:n.jsx(i,{bg:"var(--wim-color-bg-component)",p:20,style:{border:"1px solid var(--wim-color-border)"},children:r("story.container_content")})})},args:{bg:"#f9f9f9"}},t={render:function(){const{t:o}=l(c);return n.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:["xs","sm","md","lg","xl"].map(r=>n.jsx(a,{size:r,bg:"var(--wim-color-bg-secondary)",p:10,children:n.jsxs(i,{bg:"var(--wim-color-bg-component)",p:10,style:{textAlign:"center",border:"1px solid var(--wim-color-border)"},children:[o("story.container_size"),": ",r]})},r))})}},s={render:function(o){const{t:r}=l(c);return n.jsx(a,{...o,fluid:!0,children:n.jsx(i,{bg:"var(--wim-color-bg-component)",p:20,style:{textAlign:"center",border:"1px solid var(--wim-color-border)"},children:r("story.container_fluid")})})},args:{bg:"var(--wim-color-bg-secondary)"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
