...
}`,...j.parameters?.docs?.source}}};const E=["Default","Striped","Bordered","Hoverable","FullWidth","WithActions","Sortable","RowSelection","StickyHeader","SubtleScrollbar","HiddenScrollbar","MobileCard"],G=Object.freeze(Object.defineProperty({__proto__:null,Bordered:y,Default:i,FullWidth:T,HiddenScrollbar:C,Hoverable:p,MobileCard:j,RowSelection:x,Sortable:g,StickyHeader:b,Striped:u,SubtleScrollbar:H,WithActions:h,__namedExportsOrder:E,default:M},Symbol.toStringTag,{value:"Module"}));export{y as B,T as F,p as H,x as R,u as S,G as T,h as W,b as a,H as b,g as c};
