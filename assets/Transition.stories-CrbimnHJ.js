import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as l,A as d}from"./iframe-LKGfyusM.js";import{T as i}from"./Transition-BLcc2mZy.js";import{B as c}from"./Button-lRD2j2vn.js";import{S as o}from"./Stack-iGQ7_knH.js";import{C as m}from"./Card-Dtw6wr6M.js";import{C as f}from"./Container-KEB3LGuY.js";import{u as p}from"./useTranslation-1YWFUbjG.js";const h={title:"Components/Internal/Transition",component:i,parameters:{layout:"centered"}},n={render:()=>{const[t,s]=l.useState(!1),{t:r}=p(d);return e.jsx(f,{size:"sm",children:e.jsxs(o,{align:"center",gap:"xl",py:"xl",children:[e.jsx(c,{animateWidth:!0,priority:"primary",onClick:()=>s(!t),label:r(t?"story_transition_hide_content":"story_transition_show_content")}),e.jsx(o,{h:100,align:"center",justify:"center",children:e.jsx(i,{show:t,enter:"fade-enter",enterFrom:"fade-enter-from",enterTo:"fade-enter-to",leave:"fade-leave",leaveFrom:"fade-leave-from",leaveTo:"fade-leave-to",children:e.jsx(m,{variant:"elevated",padding:"lg",style:{background:"var(--wim-color-surface, #ffffff)",border:"2px solid var(--wim-color-primary, #3b82f6)",color:"var(--wim-color-text-primary, #1e293b)",fontWeight:"bold",minWidth:"150px",textAlign:"center"},children:r("story_transition_fade_content")})})})]})})}},a={render:()=>{const[t,s]=l.useState(!1),{t:r}=p(d);return e.jsx(f,{size:"sm",children:e.jsxs(o,{align:"center",gap:"xl",py:"xl",children:[e.jsx("style",{children:`
...
}`,...a.parameters?.docs?.source}}};const y=["Fade","Slide"],T=Object.freeze(Object.defineProperty({__proto__:null,Fade:n,Slide:a,__namedExportsOrder:y,default:h},Symbol.toStringTag,{value:"Module"}));export{n as F,a as S,T};
