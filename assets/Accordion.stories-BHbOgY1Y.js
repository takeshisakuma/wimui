import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as m,R as j}from"./iframe-BdHo9cuV.js";import{P as o}from"./index-BxUS1-Uu.js";import{I as N}from"./Icon-BsQ7L9U9.js";const I=m.createContext(null),w=()=>{const r=m.useContext(I);if(!r)throw new Error("Accordion components must be used within an Accordion");return r},n=({type:r="single",defaultValue:i,value:c,onValueChange:l,collapsible:p=!0,className:t,children:A})=>{const[f,a]=m.useState(()=>i?Array.isArray(i)?i:[i]:[]),g=c!==void 0,d=g?Array.isArray(c)?c:[c]:f,C=m.useCallback(u=>{let s;r==="single"?d.includes(u)?s=p?[]:[u]:s=[u]:d.includes(u)?s=d.filter(x=>x!==u):s=[...d,u],g||a(s),l?.(r==="single"?s[0]:s)},[d,p,g,l,r]);return e.jsx(I.Provider,{value:{value:d,onValueChange:C,type:r},children:e.jsx("div",{className:["wim-accordion",t].filter(Boolean).join(" "),children:A})})},T=m.createContext(null),R=({value:r,disabled:i=!1,className:c,children:l})=>{const{value:p}=w(),t=p.includes(r),[A,f]=m.useState(t),[a,g]=m.useState(!1),d=j.useRef(t);j.useEffect(()=>{if(t!==d.current){if(t){g(!1);const s=setTimeout(()=>{f(!0)},10);return()=>clearTimeout(s)}else f(!1),g(!0);d.current=t}},[t]);const C=s=>{!t&&s.propertyName==="grid-template-rows"&&g(!1)},u=t||a;return e.jsx(T.Provider,{value:{value:r,disabled:i,isContentOpen:A},children:e.jsx("details",{open:u,onTransitionEnd:C,className:["wim-accordion__item",i?"wim-accordion__item--disabled":"",t?"wim-accordion__item--open":"",c].filter(Boolean).join(" "),children:l})})},_=({children:r,className:i,...c})=>{const{value:l,onValueChange:p}=w(),t=m.useContext(T);if(!t)throw new Error("AccordionTrigger must be used within AccordionItem");l.includes(t.value);const A=a=>{if(t.disabled){a.preventDefault();return}a.preventDefault(),p(t.value)},f=a=>{if(a.key==="Enter"||a.key===" "){if(t.disabled){a.preventDefault();return}a.preventDefault(),p(t.value)}};return e.jsxs("summary",{className:["wim-accordion__trigger",i].filter(Boolean).join(" "),onClick:A,onKeyDown:f,...c,children:[e.jsx("span",{className:"wim-accordion__trigger-content",children:r}),e.jsx(N,{name:"ChevronDownIcon",className:["wim-accordion__chevron",t.isContentOpen?"wim-accordion__chevron--open":""].join(" ")})]})},b=({children:r,className:i,...c})=>{const l=m.useContext(T);if(!l)throw new Error("AccordionContent must be used within AccordionItem");return e.jsx("div",{className:["wim-accordion__content",l.isContentOpen?"wim-accordion__content--open":"",i].filter(Boolean).join(" "),...c,children:e.jsx("div",{className:"wim-accordion__content-inner",children:r})})};n.Item=R;n.Trigger=_;n.Content=b;n.propTypes={type:o.oneOf(["single","multiple"]),defaultValue:o.oneOfType([o.string,o.arrayOf(o.string)]),value:o.oneOfType([o.string,o.arrayOf(o.string)]),onValueChange:o.func,collapsible:o.bool,className:o.string,children:o.node};n.__docgenInfo={description:"",methods:[{name:"Item",docblock:null,modifiers:["static"],params:[{name:"{ value, disabled = false, className, children }: AccordionItemProps",optional:!1,type:{name:"signature",type:"object",raw:`{\r
    value: string;\r
    disabled?: boolean;\r
    className?: string;\r
