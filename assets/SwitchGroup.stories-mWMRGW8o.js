import{j as n}from"./jsx-runtime-u17CrQMm.js";import{r as h,A as w}from"./iframe-CiRA90at.js";import{c as O}from"./index-CERe7Zud.js";import{S as G}from"./Switch-Dd9AQKbQ.js";import{F as C}from"./FieldTemplate-CQJ2hOgk.js";import{u as y}from"./useTranslation-BEAd_Ta8.js";const l=({options:r,value:t,defaultValue:a=[],onChange:u,direction:v="vertical",name:S,className:_,label:f,error:T,required:q,disabled:V})=>{const g=t!==void 0,[j,x]=h.useState(a),b=`wim-switch-group-label-${h.useId()}`,c=g?t:j,A=(e,p)=>{let d;p?d=[...c||[],e]:d=(c||[]).filter(z=>z!==e),g||x(d),u&&u(d)};return n.jsx(C,{label:f,error:T,required:q,labelId:b,className:_,children:n.jsx("div",{className:O("wim-switch-group",v==="horizontal"&&"wim-switch-group--horizontal"),role:"group","aria-labelledby":f?b:void 0,children:r.map(e=>n.jsx(G,{value:e.value,checked:(c||[]).includes(e.value),disabled:V||e.disabled,name:S,onChange:p=>A(e.value,p.target.checked),children:e.label},e.value))})})};l.__docgenInfo={description:"SwitchGroup component to manage multiple switches.",methods:[],displayName:"SwitchGroup",props:{options:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  value: string;
  disabled?: boolean;
