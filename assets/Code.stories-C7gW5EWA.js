import{j as c}from"./jsx-runtime-u17CrQMm.js";import{c as p}from"./index-C7GNrL9d.js";const l=({children:a,code:t,block:s=!1,language:n,className:i})=>{const d=s?"pre":"code";return c.jsx(d,{className:p("wim-code",s?"wim-code--block":"wim-code--inline",n&&`language-${n}`,i),children:s?c.jsx("code",{className:n&&`language-${n}`,children:t||a}):t||a})};l.__docgenInfo={description:"",methods:[],displayName:"Code",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},code:{required:!1,tsType:{name:"string"},description:""},block:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},language:{required:!1,tsType:{name:"string"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const m={title:"Component/Typography & Icons/Code",component:l,parameters:{layout:"padded"},argTypes:{block:{control:"boolean"},language:{control:"text"}}},e={args:{children:"const x = 10;",block:!1}},o={args:{children:`function helloWorld() {
