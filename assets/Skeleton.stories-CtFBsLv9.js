import{j as e,R as w}from"./react-D-G-yZ1o.js";import{P as r}from"./prop-types-CamVAYe7.js";const t=({variant:n="text",animation:i="pulse",width:x,height:m,style:u,className:h="",...v})=>{const g=`wim-skeleton--${n}`,f=i!=="none"?`wim-skeleton--${i}`:"",y={width:x,height:m,...u};return e.jsx("div",{className:["wim-skeleton",g,f,h].filter(Boolean).join(" "),style:y,"aria-hidden":"true",...v})};t.propTypes={variant:r.oneOf(["text","rect","circle"]),animation:r.oneOf(["pulse","wave","none"]),width:r.oneOfType([r.string,r.number]),height:r.oneOfType([r.string,r.number]),style:r.object,className:r.string};t.__docgenInfo={description:"コンテンツの読み込み中に表示するプレースホルダー。",methods:[],displayName:"Skeleton",props:{variant:{required:!1,tsType:{name:"union",raw:'"text" | "rect" | "circle"',elements:[{name:"literal",value:'"text"'},{name:"literal",value:'"rect"'},{name:"literal",value:'"circle"'}]},description:"スケルトンの形状。\r\n- `text`: テキスト行のような形状。\r\n- `rect`: 矩形。\r\n- `circle`: 円形。",defaultValue:{value:'"text"',computed:!1},type:{name:"enum",value:[{value:'"text"',computed:!1},{value:'"rect"',computed:!1},{value:'"circle"',computed:!1}]}},animation:{required:!1,tsType:{name:"union",raw:'"pulse" | "wave" | "none"',elements:[{name:"literal",value:'"pulse"'},{name:"literal",value:'"wave"'},{name:"literal",value:'"none"'}]},description:"アニメーションの種類。\r\n- `pulse`: ゆっくりとした明滅。\r\n- `wave`: 左から右への波のような動き。\r\n- `none`: アニメーションなし。",defaultValue:{value:'"pulse"',computed:!1},type:{name:"enum",value:[{value:'"pulse"',computed:!1},{value:'"wave"',computed:!1},{value:'"none"',computed:!1}]}},width:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:"幅。CSSの単位（px, %, remなど）を含めて指定します。",type:{name:"union",value:[{name:"string"},{name:"number"}]}},height:{required:!1,tsType:{name:"union",raw:"string | number",elements:[{name:"string"},{name:"number"}]},description:"高さ。CSSの単位（px, %, remなど）を含めて指定します。",type:{name:"union",value:[{name:"string"},{name:"number"}]}},className:{defaultValue:{value:'""',computed:!1},description:"追加のクラス名。",type:{name:"string"},required:!1},style:{description:"追加のスタイル。",type:{name:"object"},required:!1}}};const S={title:"Component/Feedback/Skeleton",component:t,argTypes:{variant:{control:"select",options:["text","rect","circle"]},animation:{control:"select",options:["pulse","wave","none"]},width:{control:"text"},height:{control:"text"}}},a={args:{width:"100%"}},s={render:n=>e.jsxs("div",{style:{width:"300px"},children:[e.jsx(t,{...n,variant:"text",width:"100%"}),e.jsx(t,{...n,variant:"text",width:"80%"}),e.jsx(t,{...n,variant:"text",width:"60%"})]})},l={args:{variant:"circle",width:40,height:40}},o={args:{variant:"rect",width:200,height:100}},d={args:{animation:"wave",width:"100%"}},c={render:n=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px",width:"300px",padding:"16px",border:"1px solid #eee",borderRadius:"8px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[e.jsx(t,{...n,variant:"circle",width:40,height:40}),e.jsxs("div",{style:{flex:1},children:[e.jsx(t,{...n,variant:"text",width:"60%"}),e.jsx(t,{...n,variant:"text",width:"40%"})]})]}),e.jsx(t,{...n,variant:"rect",width:"100%",height:150}),e.jsxs("div",{children:[e.jsx(t,{...n,variant:"text",width:"100%"}),e.jsx(t,{...n,variant:"text",width:"90%"}),e.jsx(t,{...n,variant:"text",width:"70%"})]})]})},p={render:n=>{const[i,x]=w.useState(!0);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:[e.jsx("button",{onClick:()=>x(!i),style:{padding:"8px 16px",borderRadius:"4px",border:"1px solid #ccc",cursor:"pointer",width:"fit-content"},children:i?"Show Content":"Show Skeleton"}),e.jsx("div",{style:{padding:"20px",border:"1px solid #eee",borderRadius:"12px",width:"350px"},children:i?e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[e.jsx(t,{...n,variant:"circle",width:48,height:48}),e.jsxs("div",{style:{flex:1},children:[e.jsx(t,{...n,variant:"text",width:"50%"}),e.jsx(t,{...n,variant:"text",width:"30%"})]})]}),e.jsx(t,{...n,variant:"rect",width:"100%",height:120}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[e.jsx(t,{...n,variant:"text"}),e.jsx(t,{...n,variant:"text"}),e.jsx(t,{...n,variant:"text",width:"60%"})]})]}):e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"12px"},children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"12px"},children:[e.jsx("div",{style:{width:48,height:48,borderRadius:"50%",backgroundColor:"#007bff",display:"flex",alignItems:"center",justifyContent:"center",color:"white",fontWeight:"bold"},children:"JD"}),e.jsxs("div",{style:{flex:1},children:[e.jsx("div",{style:{fontWeight:"bold",fontSize:"1.1rem"},children:"John Doe"}),e.jsx("div",{style:{color:"#666",fontSize:"0.9rem"},children:"Software Engineer"})]})]}),e.jsx("img",{src:"https://images.unsplash.com/photo-1498050108023-c5249f4df085?auto=format&fit=crop&w=350&q=80",alt:"Content",style:{width:"100%",height:"120px",objectFit:"cover",borderRadius:"4px"}}),e.jsx("div",{style:{lineHeight:"1.6",color:"#444"},children:"これは実際にコンテンツが読み込まれた状態のデモです。 スケルトンが提供したプレースホルダーと同じ位置に、 本来のテキストや画像が表示されます。"})]})})]})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
    width: "100%"
  }
...
}`,...p.parameters?.docs?.source}}};const j=["Default","Text","Circle","Rect","WaveAnimation","CardExample","LoadingToggle"],C=Object.freeze(Object.defineProperty({__proto__:null,CardExample:c,Circle:l,Default:a,LoadingToggle:p,Rect:o,Text:s,WaveAnimation:d,__namedExportsOrder:j,default:S},Symbol.toStringTag,{value:"Module"}));export{l as C,a as D,p as L,o as R,C as S,s as T,d as W,c as a};
