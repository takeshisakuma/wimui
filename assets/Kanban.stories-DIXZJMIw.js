import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as t,A as D}from"./iframe-CiRA90at.js";import{c as S}from"./index-CERe7Zud.js";import{u as L}from"./useTranslation-BEAd_Ta8.js";const R=t.createContext(null),$={cardMovedTo:r=>`Card moved to ${r}`,cardMovedFromTo:(r,a)=>`Card moved from ${r} to ${a}`,cards:r=>`${r} cards`,moveCard:"Move card",moveToColumn:"Move to column"},A=()=>{const r=t.useContext(R);if(!r)throw new Error("Kanban components must be used within a KanbanBoard");return r},q=t.createContext(null),N=({children:r,className:a,onCardMove:d,forceMobileUI:c=!1,labels:g,...f})=>{const[n,u]=t.useState(null),[m,l]=t.useState(null),[i,v]=t.useState([]),b=t.useRef(null),k=t.useMemo(()=>({...$,...g}),[g]),K=t.useCallback(p=>{b.current&&(b.current.textContent="",setTimeout(()=>{b.current&&(b.current.textContent=p)},50))},[]),_=t.useCallback((p,C)=>{u(p),l(C)},[]),y=t.useCallback((p,C)=>{v(h=>h.some(T=>T.id===p)?h:[...h,{id:p,title:C}])},[]),x=t.useCallback(p=>{v(C=>C.filter(h=>h.id!==p))},[]),w=t.useMemo(()=>({draggingCardId:n,draggingFromColumnId:m,setDraggingCard:_,onCardMove:d,columns:i,registerColumn:y,unregisterColumn:x,forceMobileUI:c,announce:K,labels:k}),[n,m,_,d,i,y,x,c,K,k]);return e.jsx(R.Provider,{value:w,children:e.jsxs("div",{className:S("wim-kanban",c&&"wim-kanban--touch",a),role:"region",...f,children:[e.jsx("div",{ref:b,"aria-live":"polite","aria-atomic":"true",style:{position:"absolute",width:"1px",height:"1px",padding:0,margin:"-1px",overflow:"hidden",clip:"rect(0,0,0,0)",whiteSpace:"nowrap",border:0}}),r]})})},P=({id:r,title:a,cardCount:d,children:c,className:g,...f})=>{const{draggingCardId:n,draggingFromColumnId:u,setDraggingCard:m,onCardMove:l,registerColumn:i,unregisterColumn:v,announce:b,labels:k}=A(),[K,_]=t.useState(!1);t.useEffect(()=>(i(r,a),()=>v(r)),[r,i,v]);const y=C=>{C.preventDefault(),_(!0)},x=C=>{C.currentTarget.contains(C.relatedTarget)||_(!1)},w=C=>{if(C.preventDefault(),_(!1),n&&u&&u!==r){l?.(n,u,r);const h=typeof a=="string"?a:r;b(k.cardMovedTo(h))}m(null,null)},p=!!n;return e.jsx(q.Provider,{value:{columnId:r,columnTitle:a},children:e.jsxs("div",{className:S("wim-kanban__column",K&&"wim-kanban__column--drag-over",g),onDragOver:y,onDragLeave:x,onDrop:w,"aria-label":typeof a=="string"?a:void 0,"aria-dropeffect":p?"move":void 0,...f,children:[e.jsxs("div",{className:"wim-kanban__column-header",children:[e.jsx("span",{className:"wim-kanban__column-title",children:a}),d!==void 0&&e.jsx("span",{className:"wim-kanban__column-count","aria-label":k.cards(d),children:d})]}),e.jsx("div",{className:"wim-kanban__column-body",children:c})]})})},E=({id:r,disabled:a=!1,children:d,className:c,...g})=>{const{draggingCardId:f,setDraggingCard:n,onCardMove:u,columns:m,announce:l,labels:i}=A(),v=t.useContext(q),b=v?.columnId??null,k=v?.columnTitle??null,K=f===r,[_,y]=t.useState(!1),x=t.useRef(null),w=t.useRef(null),p=m.filter(s=>s.id!==b);t.useEffect(()=>{if(!_)return;const s=B=>{x.current&&!x.current.contains(B.target)&&y(!1)};return document.addEventListener("mousedown",s),()=>document.removeEventListener("mousedown",s)},[_]),t.useEffect(()=>{_||w.current?.focus()},[_]);const C=s=>{s.dataTransfer&&(s.dataTransfer.effectAllowed="move"),n(r,b)},h=()=>{n(null,null)},T=(s,B)=>{if(b){u?.(r,b,s);const O=typeof k=="string"?k:b,U=typeof B=="string"?B:s;l(i.cardMovedFromTo(O,U))}y(!1)},F=s=>{s.key==="Escape"&&y(!1)};return e.jsxs("div",{className:S("wim-kanban__card",K&&"wim-kanban__card--dragging",a&&"wim-kanban__card--disabled",c),draggable:!a,onDragStart:a?void 0:C,onDragEnd:h,role:"listitem","aria-grabbed":a?void 0:K,...g,children:[e.jsx("div",{className:"wim-kanban__card-content",children:d}),!a&&p.length>0&&e.jsxs("div",{className:"wim-kanban__card-move",ref:x,children:[e.jsx("button",{ref:w,type:"button",className:"wim-kanban__card-move-btn",onClick:s=>{s.stopPropagation(),y(B=>!B)},onKeyDown:s=>{s.key==="Escape"&&y(!1)},"aria-label":i.moveCard,"aria-expanded":_,"aria-haspopup":"listbox",children:"⋯"}),_&&e.jsx("div",{className:"wim-kanban__card-move-menu",role:"listbox","aria-label":i.moveToColumn,tabIndex:-1,onKeyDown:F,children:p.map(s=>e.jsx("button",{type:"button",className:"wim-kanban__card-move-option",role:"option","aria-selected":!1,onClick:()=>T(s.id,s.title),children:s.title},s.id))})]})]})};N.displayName="Kanban";P.displayName="Kanban.Column";E.displayName="Kanban.Card";const o=N;o.Column=P;o.Card=E;P.__docgenInfo={description:"",methods:[],displayName:"Kanban.Column",props:{id:{required:!0,tsType:{name:"string"},description:"列を識別する一意のID。カード移動時に使用される。"},title:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"列のヘッダーに表示するタイトル。"},cardCount:{required:!1,tsType:{name:"number"},description:"ヘッダーに表示するカード枚数バッジ。"}}};E.__docgenInfo={description:"",methods:[],displayName:"Kanban.Card",props:{id:{required:!0,tsType:{name:"string"},description:"カードを識別する一意のID。"},disabled:{required:!1,tsType:{name:"boolean"},description:"trueの場合、ドラッグ・移動操作が不可になる。",defaultValue:{value:"false",computed:!1}}}};N.__docgenInfo={description:"",methods:[],displayName:"Kanban",props:{onCardMove:{required:!1,tsType:{name:"signature",type:"function",raw:`(
  cardId: string,
  fromColumnId: string,
  toColumnId: string,
