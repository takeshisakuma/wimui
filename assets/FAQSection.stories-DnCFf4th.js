import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as p}from"./index-C7Nj9VOz.js";import{A as i}from"./Accordion-wV3letQ9.js";import{H as h}from"./Heading-Ca3vaDRa.js";import{P as w}from"./Paragraph-Cz_oG8Nh.js";import{u as A}from"./useTranslation-OwuDKqc3.js";const u=({items:_,title:c,description:l,layout:q="top",accordionProps:m,className:g})=>{const{t:o}=A(),y=!!(c||l);return e.jsxs("section",{className:p("wim-faq-section",`wim-faq-section--layout-${q}`,g),children:[y&&e.jsxs("div",{className:"wim-faq-section__header",children:[c&&e.jsx(h,{tag:"h2",size:"xl",className:"wim-faq-section__title",children:o(c)}),l&&e.jsx(w,{content:o(l),color:"deepgray",className:"wim-faq-section__description"})]}),e.jsx("div",{className:"wim-faq-section__content",children:e.jsx(i,{type:"multiple",collapsible:!0,...m,className:p("wim-faq-section__accordion",m?.className),children:_.map((n,d)=>e.jsxs(i.Item,{value:`faq-item-${d}`,children:[e.jsx(i.Trigger,{children:o(n.question)}),e.jsx(i.Content,{children:typeof n.answer=="string"?o(n.answer):n.answer})]},d))})})]})};u.__docgenInfo={description:`よくある質問 (FAQ)を表示するためのセクションコンポーネント。
