import{j as a}from"./jsx-runtime-u17CrQMm.js";import{B as s}from"./BarChart-DGqTkAo6.js";import{L as i}from"./LineChart-CEYvEHQT.js";import{P as o}from"./PieChart-xuTmCy64.js";import{S as n}from"./Stack-DogPG4S6.js";import{H as l}from"./Heading-Cwc-o8zG.js";const m={title:"Components/Visualization/Charts"},t=[{name:"Jan",sales:4e3,profit:2400},{name:"Feb",sales:3e3,profit:1398},{name:"Mar",sales:2e3,profit:9800}],e={render:()=>a.jsxs(n,{gap:"lg",children:[a.jsx(l,{tag:"h3",size:"lg",children:"Visualization Suite Overview"}),a.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(300px, 1fr))",gap:"20px"},children:[a.jsx(s,{title:"Sales by Month",data:t,xAxisKey:"name",keys:["sales"]}),a.jsx(i,{title:"Profit Trend",data:t,xAxisKey:"name",keys:["profit"]}),a.jsx(o,{title:"Market Share",data:t.map(r=>({name:r.name,value:r.sales}))})]})]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  render: () => <Stack gap="lg">
