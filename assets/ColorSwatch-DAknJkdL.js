import{j as t}from"./jsx-runtime-u17CrQMm.js";import{r as m}from"./iframe-D-2TzvPc.js";import{C as u}from"./ColorPicker-BuNhrOLG.js";const h="WIM_SIGNAL_COLOR_CHANGE",g=r=>{if(!r)return"#000000";if(r.startsWith("#")){const e=r.slice(1);if(e.length===3)return`#${e[0]}${e[0]}${e[1]}${e[1]}${e[2]}${e[2]}`;if(e.length===4)return`#${e[0]}${e[0]}${e[1]}${e[1]}${e[2]}${e[2]}`;if(e.length===8)return`#${e.slice(0,6)}`;if(e.length===6)return r}if(typeof document<"u"){const e=document.createElement("div");e.style.color=r,e.style.display="none",document.body.appendChild(e);const a=getComputedStyle(e).color;document.body.removeChild(e);const s=a.match(/\d+/g);if(s&&s.length>=3){const c=parseInt(s[0]).toString(16).padStart(2,"0"),n=parseInt(s[1]).toString(16).padStart(2,"0"),i=parseInt(s[2]).toString(16).padStart(2,"0");return`#${c}${n}${i}`}}return r},f=r=>{const e=g(r),a=e.startsWith("#")?e.slice(1):e;if(a.length!==7&&a.length!==6){if(a.length===3||a.length===4&&e.startsWith("#")){const o=a.length===4?1:0,l=parseInt(a[o]+a[o],16)/255,p=parseInt(a[o+1]+a[o+1],16)/255,b=parseInt(a[o+2]+a[o+2],16)/255,x=w=>w<=.03928?w/12.92:Math.pow((w+.055)/1.055,2.4);return .2126*x(l)+.7152*x(p)+.0722*x(b)}return 0}const s=a.length===7?1:0,c=parseInt(a.substring(s,s+2),16)/255,n=parseInt(a.substring(s+2,s+4),16)/255,i=parseInt(a.substring(s+4,s+6),16)/255,d=o=>o<=.03928?o/12.92:Math.pow((o+.055)/1.055,2.4);return .2126*d(c)+.7152*d(n)+.0722*d(i)},v=(r,e)=>{const a=f(r),s=f(e),c=Math.max(a,s),n=Math.min(a,s);return(c+.05)/(n+.05)},y=()=>{const[r,e]=m.useState("var(--color-primary)"),[a,s]=m.useState("var(--color-text-on-primary)"),c=m.useMemo(()=>g(r),[r]),n=m.useMemo(()=>g(a),[a]),i=m.useMemo(()=>v(c,n),[c,n]);m.useEffect(()=>{const l=p=>{p.detail?.type==="bg"&&e(p.detail.value),p.detail?.type==="fg"&&s(p.detail.value)};return window.addEventListener(h,l),()=>window.removeEventListener(h,l)},[]);const d=i>=4.5,o=i>=3;return t.jsxs("div",{className:"wim-contrast-checker",children:[t.jsx("style",{children:`
                ...
                `}),t.jsxs("div",{className:"wim-contrast-controls",children:[t.jsxs("div",{className:"wim-contrast-control",children:[t.jsx("label",{htmlFor:"bg-input",className:"wim-contrast-label",children:"Background"}),t.jsxs("div",{className:"wim-contrast-inputs",children:[t.jsx(u,{value:c,onChange:l=>e(l.target.value),className:"wim-contrast-color-picker"}),t.jsx("input",{id:"bg-input",className:"wim-text-input",value:r,onChange:l=>e(l.target.value),placeholder:"#000000 or var(...)"})]})]}),t.jsxs("div",{className:"wim-contrast-control",children:[t.jsx("label",{htmlFor:"fg-input",className:"wim-contrast-label",children:"Foreground"}),t.jsxs("div",{className:"wim-contrast-inputs",children:[t.jsx(u,{value:n,onChange:l=>s(l.target.value),className:"wim-contrast-color-picker"}),t.jsx("input",{id:"fg-input",className:"wim-text-input",value:a,onChange:l=>s(l.target.value),placeholder:"#ffffff or var(...)"})]})]})]}),t.jsxs("div",{className:"wim-contrast-result",children:[t.jsxs("div",{className:"wim-contrast-ratio-display",children:[t.jsx("span",{className:"wim-contrast-ratio-value",children:i.toFixed(2)}),t.jsx("span",{className:"wim-contrast-ratio-unit",children:"Ratio"})]}),t.jsxs("div",{className:"wim-contrast-badges",children:[t.jsxs("div",{className:"wim-contrast-badge",children:[t.jsx("span",{children:"Normal Text"}),t.jsx("span",{className:`wim-contrast-badge-status ${d?"wim-contrast-status-pass":"wim-contrast-status-fail"}`,children:d?"PASS (AA)":"FAIL (AA)"})]}),t.jsxs("div",{className:"wim-contrast-badge",children:[t.jsx("span",{children:"Large Text"}),t.jsx("span",{className:`wim-contrast-badge-status ${o?"wim-contrast-status-pass":"wim-contrast-status-fail"}`,children:o?"PASS (AA)":"FAIL (AA)"})]})]})]}),t.jsx("div",{className:"wim-contrast-preview-container",children:t.jsxs("div",{className:"wim-contrast-preview",style:{backgroundColor:c,color:n},children:[t.jsx("span",{className:"wim-contrast-preview-text-lg",children:"Design System Contrast Test"}),t.jsx("span",{className:"wim-contrast-preview-text-sm",children:"The quick brown fox jumps over the lazy dog."})]})})]})};y.__docgenInfo={description:"",methods:[],displayName:"ContrastChecker"};const N=({name:r,value:e,color:a,children:s,variant:c="card"})=>{const n=i=>{let d=e||a;d.startsWith("--")&&(d=`var(${d})`);const o=new CustomEvent(h,{detail:{type:i,value:d}});window.dispatchEvent(o)};return t.jsxs(t.Fragment,{children:[t.jsx("style",{children:`
        .wim-swatch-card {
          border-radius: 12px;
          overflow: hidden;
