import{j as S}from"./jsx-runtime-u17CrQMm.js";import{r as d}from"./iframe-MO83bMJc.js";import{B as y}from"./Button-Bgm-CP-i.js";const{fn:L}=__STORYBOOK_MODULE_TEST__,_={title:"Component/General/Button",component:y,parameters:{layout:"centered"},argTypes:{backgroundColor:{control:"color"}},args:{onClick:L()}},r={args:{size:"large",label:"button_label",priority:"primary",state:"abled"}},t={args:{size:"medium",label:"button_label",priority:"secondary",state:"abled"}},n={args:{size:"small",label:"button_label",priority:"tertiary",state:"abled"}},o={args:{size:"small",label:"button_label",priority:"tertiary",role:"destructive",state:"abled",iconName:"CircleIcon",iconPosition:"left"}},s={args:{size:"large",priority:"primary",role:"default",state:"abled",iconName:"SquareIcon","aria-label":"Square Icon Button"}},i={args:{size:"medium",priority:"primary",label:"processing",loading:!0}},l={args:{size:"medium",priority:"secondary",label:"saving",loading:!0}},c={render:e=>{const[m,a]=d.useState(!1),[b,B]=d.useState(e.label||"button_label"),g=p=>{e.onClick&&e.onClick(p),a(!0),setTimeout(()=>{a(!1)},2e3)};return S.jsx(y,{...e,loading:m,label:b,onClick:g})},args:{size:"medium",priority:"primary",label:"button_label"}},u={render:e=>{const[m,a]=d.useState(!1),[b,B]=d.useState(e.label||"button_label"),g=p=>{e.onClick&&e.onClick(p),a(!0),setTimeout(()=>{a(!1)},2e3)};return S.jsx(y,{...e,loading:m,label:b,onClick:g})},args:{size:"medium",priority:"secondary",label:"button_label",iconName:"CircleIcon",iconPosition:"left"}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    size: "large",
    label: "button_label",
    priority: "primary",
