import{j as i}from"./jsx-runtime-u17CrQMm.js";import{c as g}from"./index-K9UxIAwh.js";import{d as h,e as y,f as b,g as f}from"./style-utils-Bzkn8Zxa.js";const x=({size:a="md",content:o,color:e,weight:l="normal",lineHeight:m,fontStyle:u="normal",decoration:n="none",className:s,style:v,children:c,...p})=>{const r=o??c,d=n!=="none"?i.jsx("span",{className:`wim-paragraph--${n}`,children:r}):r,t=typeof e=="string"&&["black","deepgray","gray","lightgray","white","error","primary","success","warning","info"].includes(e);return i.jsx("p",{className:g("wim-paragraph",`wim-paragraph--${a}`,l==="bold"&&"wim-paragraph--bold",u==="italic"&&"wim-paragraph--italic",t&&`wim-paragraph--${e}`,s),style:{color:t?void 0:f(e),fontSize:b(a),lineHeight:y(m),fontWeight:h(l),...v},...p,children:d})};x.__docgenInfo={description:"",methods:[],displayName:"Paragraph",props:{size:{required:!1,tsType:{name:"union",raw:'"xs" | "sm" | "md" | "lg" | "xl"',elements:[{name:"literal",value:'"xs"'},{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'},{name:"literal",value:'"xl"'}]},description:"",defaultValue:{value:'"md"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:"T | (string & {})",elements:[{name:"union",raw:"WimColorKey | WimColorToken",elements:[{name:"union",raw:`| "primary"
| "primary-hover"
| "primary-active"
| "primary-light"
