import{j as a}from"./jsx-runtime-u17CrQMm.js";import{c as q}from"./index-c_hinErY.js";import{I as E}from"./Icon-q4QA7_pD.js";import{u as j}from"./useTranslation-DU1rn0mm.js";const x=({size:d="medium",content:S="span",color:e="black",weight:b="normal",style:f="normal",iconName:p=void 0,iconPosition:g="left",decoration:y="none",className:_,style:z,...k})=>{const{t:I}=j(),T={"ex-small":"xs",small:"sm",medium:"md",large:"lg","ex-large":"xl"},C={"ex-small":"small",small:"small",medium:"medium",large:"large","ex-large":"large"}[d]||"medium",w=p?a.jsx(E,{name:p,size:C}):null,O=a.jsxs(a.Fragment,{children:[p&&g==="left"&&w,a.jsx("span",{children:I(S)}),p&&g==="right"&&w]}),h=e&&(e.startsWith("var(")||e.includes("#")||e.includes("rgb"));return a.jsx("span",{className:q("wim-span",`wim-span--${T[d]}`,!h&&`wim-span--${e}`,b==="bold"&&"wim-span--bold",f==="italic"&&"wim-span--italic",y!=="none"&&`wim-span--${y}`,_),style:{color:h?e:void 0,...z},...k,children:O})};x.__docgenInfo={description:"",methods:[],displayName:"Span",props:{size:{required:!1,tsType:{name:"union",raw:'"ex-small" | "small" | "medium" | "large" | "ex-large"',elements:[{name:"literal",value:'"ex-small"'},{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'},{name:"literal",value:'"ex-large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
