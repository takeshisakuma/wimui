import{j as y}from"./jsx-runtime-u17CrQMm.js";import{r as u}from"./iframe-CVYkroJl.js";import{B as p}from"./Button-CtoyR0Qr.js";const{fn:S}=__STORYBOOK_MODULE_TEST__,k={title:"Component/Buttons/Button",component:p,parameters:{layout:"centered"},argTypes:{backgroundColor:{control:"color"}},args:{onClick:S(),"aria-label":void 0}},n={args:{size:"large",label:"button_label",priority:"primary",state:"abled","aria-label":!1}},r={args:{size:"medium",label:"button_label",priority:"secondary",state:"abled","aria-label":!1}},t={args:{size:"small",label:"button_label",priority:"tertiary",state:"abled","aria-label":!1}},o={args:{size:"small",label:"button_label",priority:"tertiary",role:"destructive",state:"abled",iconName:"CircleIcon",iconPosition:"left","aria-label":!1}},s={args:{size:"medium",priority:"primary",label:"processing",loading:!0,"aria-label":!1}},l={args:{size:"medium",priority:"secondary",label:"saving",loading:!0,"aria-label":!1}},i={render:e=>{const[d,a]=u.useState(!1),[m,f]=u.useState(e.label||"button_label"),b=g=>{e.onClick&&e.onClick(g),a(!0),setTimeout(()=>{a(!1)},2e3)};return y.jsx(p,{...e,loading:d,label:m,onClick:b})},args:{size:"medium",priority:"primary",label:"button_label","aria-label":!1}},c={render:e=>{const[d,a]=u.useState(!1),[m,f]=u.useState(e.label||"button_label"),b=g=>{e.onClick&&e.onClick(g),a(!0),setTimeout(()=>{a(!1)},2e3)};return y.jsx(p,{...e,loading:d,label:m,onClick:b})},args:{size:"medium",priority:"secondary",label:"button_label",iconName:"CircleIcon",iconPosition:"left","aria-label":!1}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
  args: {
    size: "large",
    label: "button_label",
    priority: "primary",
