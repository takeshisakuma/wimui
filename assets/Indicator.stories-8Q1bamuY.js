import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as p}from"./index-K_u7tV9x.js";import{A as l}from"./Avatar-5eWQwZG5.js";import{I as f}from"./Icon-DuRhDIXo.js";import{u as b}from"./useTranslation-D80Uyf_x.js";const e=({children:a,color:o="primary",size:v="medium",position:y="top-right",pulse:g=!1,inline:d=!1,className:x,style:w})=>{const u=o&&(o.startsWith("var(")||o.includes("#")||o.includes("rgb"));return r.jsxs("span",{className:p("wim-indicator",d&&"wim-indicator--inline",x),style:w,children:[a,r.jsx("span",{className:p("wim-indicator__dot",!u&&`wim-indicator__dot--${o}`,`wim-indicator__dot--${v==="small"?"sm":v==="large"?"lg":"md"}`,!d&&`wim-indicator__dot--${y}`,g&&"wim-indicator__dot--pulse"),style:{backgroundColor:u?o:void 0}})]})};e.__docgenInfo={description:"要素の状態（オンライン、未読、エラーなど）を示す小さなドットコンポーネント。",methods:[],displayName:"Indicator",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},color:{required:!1,tsType:{name:"union",raw:'"primary" | "success" | "error" | "warning" | "neutral" | WimColor',elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"neutral"'},{name:"union",raw:"T | (string & {})",elements:[{name:"union",raw:`| "var(--color-destructive)"\r
...
}`,...m.parameters?.docs?.source}}};const _=["Default","Colors","Pulse","Inline","Sizes","WithIcons"],R=Object.freeze(Object.defineProperty({__proto__:null,Colors:i,Default:n,Inline:s,Pulse:t,Sizes:c,WithIcons:m,__namedExportsOrder:_,default:h},Symbol.toStringTag,{value:"Module"}));export{i as C,n as D,R as I,t as P,c as S,s as a};
