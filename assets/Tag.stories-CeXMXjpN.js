import{j as e}from"./jsx-runtime-u17CrQMm.js";import{I as u}from"./IndicatorBase-Bn-Wsf5I.js";import{I as _}from"./Icon-CPLASYuL.js";import{u as l}from"./useTranslation-BJQcmf5i.js";const o=({children:a,icon:s,...n})=>e.jsx(u,{prefixClass:"wim-tag",icon:s,...n,children:a});o.__docgenInfo={description:"カテゴリ分けや属性のラベルとして使用される非インタラクティブなコンポーネント。",methods:[],displayName:"Tag",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示するコンテンツ"},status:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
