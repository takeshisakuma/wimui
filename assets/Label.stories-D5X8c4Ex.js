import{j as o}from"./jsx-runtime-u17CrQMm.js";import{L as t}from"./Label-C45-EpEx.js";import{I as s}from"./Input-o7xC_xci.js";const l={title:"Component/Form Layout/Label",component:t,parameters:{layout:"centered"}},e={args:{label:"Username",children:o.jsx(s,{placeholder:"Enter your username"})}},r={args:{label:"Email Address",required:!0,children:o.jsx(s,{type:"email",placeholder:"email@example.com"})}},a={args:{label:"Phone Number",showOptional:!0,children:o.jsx(s,{type:"tel",placeholder:"000-0000-0000"})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Username",
