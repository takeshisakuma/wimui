...
関数が渡された場合は (error, errorInfo, reset) => ReactNode として呼び出されます。`},onError:{required:!1,tsType:{name:"signature",type:"function",raw:"(error: Error, errorInfo: ErrorInfo) => void",signature:{arguments:[{type:{name:"Error"},name:"error"},{type:{name:"ErrorInfo"},name:"errorInfo"}],return:{name:"void"}}},description:"エラーが発生した時に呼び出されるコールバック。"},onReset:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"エラーがリセットされた時に呼び出されるコールバック。"},labels:{required:!1,tsType:{name:"signature",type:"object",raw:`{
  ...
  showDetails?: string;
  hideDetails?: string;
}`,signature:{properties:[{key:"title",value:{name:"string",required:!1}},{key:"retry",value:{name:"string",required:!1}},{key:"showDetails",value:{name:"string",required:!1}},{key:"hideDetails",value:{name:"string",required:!1}}]}},description:"手動翻訳用のラベル。"},children:{required:!0,tsType:{name:"ReactNode"},description:"子要素。"}}};const w={title:"Components/Utilities/ErrorBoundary",component:p,parameters:{layout:"centered"},tags:[]},S=()=>{const{t:n}=y(h);throw new Error(n("story.errorboundary_throw_msg"))},i={render:function(){const[o,t]=m.useState(!1),{t:e}=y(h);return r.jsx(b,{size:"sm",py:"xl",children:r.jsxs(c,{align:"center",gap:"lg",children:[r.jsx("p",{children:e("story.errorboundary_desc")}),r.jsx(d,{onClick:()=>t(!0),variant:"filled",children:e("story.errorboundary_btn_trigger")}),r.jsx(p,{onReset:()=>t(!1),children:o?r.jsx(S,{}):r.jsx(u,{intent:"info",title:e("story.errorboundary_status_ok")})})]})})}},l={render:function(){const[o,t]=m.useState(!1),{t:e}=y(h);return r.jsx(b,{size:"sm",py:"xl",children:r.jsxs(c,{align:"center",gap:"lg",children:[r.jsx(d,{onClick:()=>t(!0),variant:"filled",children:e("story.errorboundary_btn_trigger_custom")}),r.jsx(p,{onReset:()=>t(!1),fallback:(s,a,f)=>r.jsx(u,{intent:"error",title:e("story.errorboundary_oops"),description:s.message,children:r.jsx("div",{style:{marginTop:"1rem"},children:r.jsx(d,{onClick:f,variant:"outlined",size:"sm",children:e("story.errorboundary_btn_reset")})})}),children:o?r.jsx(S,{}):r.jsx(u,{intent:"success",title:e("story.errorboundary_status_stable")})})]})})}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: function Render() {
    ...
    return <Container size="sm" py="xl">
        <Stack align="center" gap="lg">
          ...
          <Button onClick={() => setShouldThrow(true)} variant="filled">{t("story.errorboundary_btn_trigger")}</Button>
  ...
  render: function Render() {
    ...
    return <Container size="sm" py="xl">
        <Stack align="center" gap="lg">
          <Button onClick={() => setShouldThrow(true)} variant="filled">{t("story.errorboundary_btn_trigger_custom")}</Button>
          <ErrorBoundary onReset={() => setShouldThrow(false)} fallback={(error, _info, reset) => <Alert intent="error" title={t("story.errorboundary_oops")} description={error.message}>
            ...
            marginTop: "1rem"
                  ...
                  <Button onClick={reset} variant="outlined" size="sm">{t("story.errorboundary_btn_reset")}</Button>
                </div>
              </Alert>}>
