"use client";
import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{Cr as n,Sr as r,Tr as i,ur as a,xr as o}from"./iframe-CIRVVv_5.js";import{_ as s,t as c}from"./src-C35woejG.js";var l=e({AsChild:()=>_,CaseInsensitive:()=>m,CustomComponent:()=>g,CustomStyle:()=>h,Default:()=>f,MultipleHighlights:()=>p,__namedExportsOrder:()=>v,default:()=>d}),u,d,f,p,m,h,g,_,v,y=t((()=>{n(),r(),c(),u=a(),d={title:`Components/Typography & Icons/Highlight`,component:s,parameters:{layout:`centered`}},f={render:e=>{let{t}=i(o);return(0,u.jsx)(s,{...e,highlight:t(`story.highlight_default_term`),children:t(`story.highlight_default_text`)})}},p={render:e=>{let{t}=i(o);return(0,u.jsx)(s,{...e,highlight:[`React`,`Vue`,`Angular`],children:t(`story.highlight_multi_text`)})}},m={render:e=>{let{t}=i(o);return(0,u.jsx)(s,{...e,highlight:t(`story.highlight_case_term`),children:t(`story.highlight_case_text`)})}},h={render:e=>{let{t}=i(o);return(0,u.jsx)(s,{...e,highlight:t(`story.highlight_custom_term`),highlightStyles:{backgroundColor:`var(--wim-color-primary)`,color:`var(--wim-color-text-on-primary)`,borderRadius:`4px`,padding:`0 4px`},children:t(`story.highlight_custom_text`)})}},g={render:e=>{let{t}=i(o);return(0,u.jsx)(s,{...e,highlight:t(`story.highlight_para_term`),as:`p`,style:{fontSize:`20px`,color:`var(--wim-color-text-secondary)`},children:t(`story.highlight_para_text`)})}},_={render:e=>{let{t}=i(o);return(0,u.jsx)(s,{...e,highlight:t(`story.highlight_link_term`),asChild:!0,children:(0,u.jsx)(`a`,{href:`/`,style:{color:`var(--wim-color-text-accent)`,textDecoration:`underline`},children:t(`story.highlight_link_text`)})})}},v=[`Default`,`MultipleHighlights`,`CaseInsensitive`,`CustomStyle`,`CustomComponent`,`AsChild`],f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      t
...
}`,..._.parameters?.docs?.source}}}}));y();export{_ as AsChild,m as CaseInsensitive,g as CustomComponent,h as CustomStyle,f as Default,p as MultipleHighlights,v as __namedExportsOrder,d as default,y as n,l as t};