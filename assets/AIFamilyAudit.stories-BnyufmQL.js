"use client";
import{i as e}from"./preload-helper-CT_b8DTk.js";import{t}from"./react-DmCNssFd.js";import{Cr as n,br as r,cr as i,xr as a,yr as o}from"./iframe-DiXuc7DI.js";import{i as s,o as c,s as l,t as u}from"./src-BE5jBQ9L.js";import{t as d}from"./Box-Bs2Irq0X.js";import{i as f}from"./List-C4WUy_aA.js";import{t as p}from"./PromptInput-BKL8DJY2.js";import{t as m}from"./AIResponseFeedback-BYnsldbU.js";import{n as h,t as g}from"./ThoughtProcess-Cx2HqV3s.js";import{n as _,t as v}from"./SourceCitation-C8AvQ27o.js";import{t as y}from"./CodeBlock-CYgTrvx2.js";import{t as b}from"./Terminal-HtWdx5vF.js";import{t as x}from"./AgentStatus-PPkizvro.js";import{t as S}from"./VoiceVisualizer-Ciw0rG0t.js";import{t as C}from"./ModelSelector-CtdUDk-q.js";import{t as w}from"./ThreadList-IihyJYj3.js";import{t as T}from"./UsageMeter-CqAKyTqD.js";import{t as E}from"./StreamingText-DsEhBHX5.js";import{t as D}from"./streaming-text-DpEAmEn4.js";import{n as O,t as k}from"./CodeDiffViewer-C1GQCfCA.js";import{i as A,n as j,r as M,t as N}from"./AuditUtils-C0tQOUtW.js";var P=e((()=>{O()})),F,I,L,R,z,B,V,H;e((()=>{t(),a(),r(),u(),D(),P(),A(),F=i(),I={title:`Audit/AIFamily`,parameters:{layout:`fullscreen`}},L=`import { useState } from "react";
          ...
          <ComponentGroup label={\`\${t("audit:label_chat_ui")} — \${t("audit:sfx_overall_structure")}\`} align="stretch">
            ...
            flexDirection: "column"
              ...
              padding: "var(--wim-spacing-md)"
                ...
                {sampleMessages.map(msg => <ChatMessage key={msg.id} position={msg.role === "user" ? "right" : "left"} variant={msg.role === "user" ? "primary" : "default"}>
                    {msg.content}
                  </ChatMessage>)}
