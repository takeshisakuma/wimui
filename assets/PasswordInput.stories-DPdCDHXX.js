import{j as e}from"./jsx-runtime-u17CrQMm.js";import{I as n}from"./Input-CuNjcIic.js";import{L as p}from"./FieldTemplate-ayHnm8ra.js";import{A as l}from"./iframe-DD-5vQ8N.js";import{u as d}from"./useTranslation-BGm1MMYI.js";const r=o=>e.jsx(n,{...o,type:"password",showPasswordToggle:!0});r.__docgenInfo={description:`パスワード入力に特化したコンポーネント。
表示/非表示の切り替え機能を内蔵しています。`,methods:[],displayName:"PasswordInput"};const u={title:"Components/Basic Inputs/PasswordInput",component:r,tags:[],args:{disabled:!1},argTypes:{disabled:{control:"boolean"}}},s={render:function(a){const{t}=d(l);return e.jsx(p,{label:t("story_passwordinput_label"),children:e.jsx(r,{...a,placeholder:t("story_passwordinput_placeholder")})})}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
