import{j as n}from"./jsx-runtime-u17CrQMm.js";import{c as s}from"./index-B1nuKDx0.js";const o=({variant:e="default",className:a,children:t,...l})=>n.jsx("div",{className:s("wim-stats",`wim-stats--${e}`,a),...l,children:t}),i=({className:e,children:a,...t})=>n.jsx("div",{className:s("wim-stats__label",e),...t,children:a}),r=({className:e,children:a,...t})=>n.jsx("div",{className:s("wim-stats__value",e),...t,children:a}),m=({className:e,children:a,...t})=>n.jsx("div",{className:s("wim-stats__description",e),...t,children:a}),p=({direction:e="up",className:a,children:t,...l})=>n.jsxs("div",{className:s("wim-stats__trend",`wim-stats__trend--${e}`,a),...l,children:[n.jsxs("span",{className:"wim-stats__trend-icon",children:[e==="up"&&"↑",e==="down"&&"↓",e==="neutral"&&"→"]}),n.jsx("span",{className:"wim-stats__trend-value",children:t})]});o.Label=i;o.Value=r;o.Description=m;o.Trend=p;o.__docgenInfo={description:"`Stats` は統計情報やメトリクスを表示するためのコンポーネントです。",methods:[{name:"Label",docblock:null,modifiers:["static"],params:[{name:`{
  className,
  children,
  ...props
