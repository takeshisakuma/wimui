import{j as r}from"./jsx-runtime-u17CrQMm.js";import{A as s}from"./Avatar-Bqho74D0.js";const l={title:"Component/Data Display/Avatar",component:s,parameters:{layout:"centered"},argTypes:{size:{control:"select",options:["sm","md","lg"]},shape:{control:"radio",options:["circle","rounded"]},color:{control:"select",options:["primary","secondary","neutral","error","success"]}}},a={args:{src:"https://images.unsplash.com/photo-1535713875002-d1d0cf377fde?auto=format&fit=crop&w=120&h=120",alt:"User"}},e={args:{initials:"JD",color:"primary"}},o={render:()=>r.jsxs("div",{style:{display:"flex",gap:"16px",alignItems:"center"},children:[r.jsx(s,{size:"sm",initials:"SM",color:"neutral"}),r.jsx(s,{size:"md",initials:"MD",color:"neutral"}),r.jsx(s,{size:"lg",initials:"LG",color:"neutral"})]})},i={render:()=>r.jsxs("div",{style:{display:"flex",gap:"16px"},children:[r.jsx(s,{shape:"circle",initials:"C",color:"secondary"}),r.jsx(s,{shape:"rounded",initials:"R",color:"secondary"})]})},t={args:{src:"https://invalid-image-url.com",initials:"FB"}},n={render:()=>r.jsxs("div",{style:{display:"flex",gap:"16px"},children:[r.jsx(s,{initials:"P",color:"primary"}),r.jsx(s,{initials:"S",color:"secondary"}),r.jsx(s,{initials:"N",color:"neutral"}),r.jsx(s,{initials:"E",color:"error"}),r.jsx(s,{initials:"SU",color:"success"})]})};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
  args: {
