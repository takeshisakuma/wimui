import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as N}from"./iframe-CN-u-8FK.js";import{c as j}from"./index-DGzbpm6y.js";import{I as u}from"./Icon-6-evcJ-o.js";import{u as C}from"./useTranslation-gZYIT26N.js";import{B as y}from"./Button-DuIld1_4.js";const h=({title:m,description:l,variant:g="info",icon:d=!0,action:f,onClose:v,className:w,children:p,..._})=>{const{t:b}=C(),x=()=>d?N.isValidElement(d)?d:g==="success"?e.jsx(u,{name:"CheckIcon",size:"small"}):e.jsx(u,{name:"CircleIcon",size:"small"}):null;return e.jsx("div",{className:j("wim-banner",`wim-banner--${g}`,w),role:"banner",..._,children:e.jsxs("div",{className:"wim-banner__container",children:[e.jsxs("div",{className:"wim-banner__content",children:[d&&e.jsx("div",{className:"wim-banner__icon",children:x()}),e.jsxs("div",{className:"wim-banner__text",children:[m&&e.jsx("span",{className:"wim-banner__title",children:b(m)}),m&&(l||p)&&e.jsx("span",{className:"wim-banner__separator",children:" - "}),(l||p)&&e.jsx("span",{className:"wim-banner__description",children:l?b(l):p})]})]}),e.jsxs("div",{className:"wim-banner__actions",children:[f&&e.jsx("div",{className:"wim-banner__action",children:f}),v&&e.jsx("button",{type:"button",className:"wim-banner__close",onClick:v,"aria-label":"Close",children:e.jsx(u,{name:"CloseIcon",size:"small"})})]})]})})};h.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。\r
