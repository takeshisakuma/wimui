import{j as a}from"./jsx-runtime-u17CrQMm.js";import{c as O}from"./index-K_u7tV9x.js";import{I as q}from"./Icon-DuRhDIXo.js";import{u as o}from"./useTranslation-D80Uyf_x.js";const n=({size:e="medium",content:r="span",color:t="black",weight:b="normal",fontStyle:_="normal",iconName:w=void 0,iconPosition:S="left",decoration:h="none",className:z,style:T,...j})=>{const{t:I}=o(),P={"ex-small":"xs",small:"sm",medium:"md",large:"lg","ex-large":"xl"},k={"ex-small":"small",small:"small",medium:"medium",large:"large","ex-large":"large"}[e]||"medium",f=w?a.jsx(q,{name:w,size:k}):null,C=a.jsxs(a.Fragment,{children:[w&&S==="left"&&f,a.jsx("span",{children:I(r)}),w&&S==="right"&&f]}),x=t&&(t.startsWith("var(")||t.includes("#")||t.includes("rgb"));return a.jsx("span",{className:O("wim-span",`wim-span--${P[e]}`,!x&&`wim-span--${t}`,b==="bold"&&"wim-span--bold",_==="italic"&&"wim-span--italic",h!=="none"&&`wim-span--${h}`,z),style:{color:x?t:void 0,...T},...j,children:C})};n.__docgenInfo={description:"",methods:[],displayName:"Span",props:{size:{required:!1,tsType:{name:"union",raw:'"ex-small" | "small" | "medium" | "large" | "ex-large"',elements:[{name:"literal",value:'"ex-small"'},{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'},{name:"literal",value:'"ex-large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"\r
| "deepgray"\r
| "gray"\r
| "lightgray"\r
| "white"\r
...
}`,...y.parameters?.docs?.source}}};const M=["ExLargeSpan","LargeSpan","MediumSpan","SmallSpan","ExSmallSpan","SmallSpanWithIcon","LargeSpanWithIconOnRight","IconOnlySpan","BoldSpan","StrikethroughSpan","HighlightSpan"],H=Object.freeze(Object.defineProperty({__proto__:null,BoldSpan:v,ExLargeSpan:l,ExSmallSpan:c,HighlightSpan:y,IconOnlySpan:d,LargeSpan:s,LargeSpanWithIconOnRight:p,MediumSpan:m,SmallSpan:i,SmallSpanWithIcon:u,StrikethroughSpan:g,__namedExportsOrder:M,default:L},Symbol.toStringTag,{value:"Module"}));export{l as E,y as H,s as L,m as M,H as S,i as a,u as b,g as c};
