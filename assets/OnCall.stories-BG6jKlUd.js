"use client";
import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-DmCNssFd.js";import{Cr as r,Sr as i,Tr as a,ur as o,xr as s}from"./iframe-CIRVVv_5.js";import{G as c,H as l,It as u,J as d,K as f,U as p,W as m,X as h,Y as g,_t as _,i as v,o as y,q as b,qt as x,r as S,s as C,t as w}from"./src-C35woejG.js";import{t as T}from"./Box-C3basXe9.js";import{a as E}from"./SpeedDial-DMcsLzUM.js";import{t as D}from"./Stack-Dxm9t1zu.js";import{t as O}from"./Icon-CUNLvyH3.js";import{t as k}from"./Button-pR3L55SU.js";import{t as A}from"./Badge-xOpm8IA_.js";import{t as j}from"./Text-DPNZreIx.js";import{t as M}from"./IconButton-hXqfoxQV.js";import{r as N}from"./TagInput-D1RYNdao.js";import{a as P,i as F,l as I,o as L,s as R,u as z}from"./ThoughtProcess-Cuh7VgO3.js";import{t as B}from"./Title-mwlkdD5H.js";import{t as V}from"./SwipeAction-X1fVgJjZ.js";import{t as H}from"./PullToRefresh-4ftu91En.js";import{t as U}from"./Countdown-BW479NLB.js";import{t as W}from"./CodeBlock-B2SLH_C9.js";var G,K,q,J,Y;e((()=>{G=t(n(),1),r(),i(),w(),K=o(),q={title:`Patterns/OnCall`,parameters:{layout:`fullscreen`}},J={render:function(){let{t:e}=a([...s,`docs_stories_recipes`]),t=t=>e(`docs_stories_recipes:oncall.${t}`),[n,r]=(0,G.useState)(!1),[i,o]=(0,G.useState)([`queue`]),[w,q]=(0,G.useState)([]),[J,Y]=(0,G.useState)(`oncall`),X=[{id:`latency`,name:t(`a_latency`),meta:t(`a_latency_meta`)},{id:`5xx`,name:t(`a_5xx`),meta:t(`a_5xx_meta`)},{id:`redis`,name:t(`a_redis`),meta:t(`a_redis_meta`),unassigned:!0},{id:`queue`,name:t(`a_queue`),meta:t(`a_queue_meta`)}].filter(e=>!w.includes(e.id));return(0,K.jsxs)(`div`,{className:`oncall-stage`,children:[(0,K.jsx)(`style`,{children:`
          .oncall-stage {
            display: flex;
        ...
        `}),(0,K.jsxs)(`div`,{className:`oncall-frame`,children:[(0,K.jsx)(T,{pt:`2xl`,px:`2xl`,pb:`md`,children:(0,K.jsxs)(E,{align:`center`,justify:`between`,gap:`sm`,children:[(0,K.jsxs)(E,{align:`center`,gap:`2xs`,children:[(0,K.jsx)(M,{variant:`ghost`,size:`sm`,"aria-label":t(`nav_back`),iconName:`ChevronLeftIcon`}),(0,K.jsx)(j,{size:`sm`,color:`text-secondary`,children:t(`incident_ref`)})]}),(0,K.jsx)(A,{content:t(`sev`),intent:`danger`,variant:`subtle`,size:`sm`})]})}),(0,K.jsxs)(D,{gap:`lg`,px:`2xl`,pt:`sm`,pb:`2xl`,children:[(0,K.jsx)(B,{tag:`h1`,size:`lg`,children:t(`title`)}),(0,K.jsx)(j,{size:`sm`,color:`text-secondary`,children:t(`paged_at`)}),(0,K.jsx)(j,{size:`sm`,children:t(`impact`)}),(0,K.jsxs)(E,{align:`center`,gap:`sm`,wrap:`wrap`,children:[(0,K.jsx)(O,{name:`HourglassIcon`,size:`sm`,color:`danger`}),(0,K.jsx)(j,{size:`sm`,color:`text-secondary`,children:t(`escalate_prefix`)}),(0,K.jsx)(U,{target:`2026-03-14T04:02:00Z`,baseDate:`2026-03-14T03:44:19Z`,variant:`digital`,size:`md`})]}),(0,K.jsx)(k,{variant:`solid`,fullWidth:!0,children:t(`take`)})]}),(0,K.jsxs)(T,{px:`2xl`,pb:`sm`,children:[(0,K.jsxs)(E,{align:`baseline`,justify:`between`,gap:`sm`,children:[(0,K.jsx)(B,{tag:`h2`,size:`xs`,children:t(`alerts_title`)}),(0,K.jsx)(j,{size:`xs`,color:`text-secondary`,nowrap:!0,children:e(`docs_stories_recipes:oncall.alerts_count`,{n:X.length})})]}),(0,K.jsx)(j,{size:`xs`,color:`text-tertiary`,children:t(`refresh_hint`)})]}),(0,K.jsxs)(H,{onRefresh:async()=>{r(!0),await new Promise(e=>setTimeout(e,900)),r(!1)},refreshing:n,children:[X.length===0&&(0,K.jsx)(T,{px:`2xl`,py:`2xl`,children:(0,K.jsx)(_,{icon:(0,K.jsx)(O,{name:`CheckCircleIcon`,size:`lg`,color:`success`}),title:t(`empty_title`),description:t(`empty_desc`),extra:(0,K.jsx)(k,{variant:`ghost`,size:`sm`,onClick:()=>q([]),children:t(`empty_action`)})})}),X.map(e=>(0,K.jsx)(V,{leftActions:[{icon:`CheckIcon`,label:t(`act_ack`),intent:`success`,onClick:()=>o(t=>[...t,e.id])}],rightActions:[{icon:`ClockIcon`,label:t(`act_snooze`),intent:`neutral`,onClick:()=>q(t=>[...t,e.id])}],children:(0,K.jsxs)(`div`,{className:`oncall-alert-row`,children:[(0,K.jsx)(`span`,{className:`oncall-alert-dot`,"data-quiet":i.includes(e.id),"aria-hidden":`true`}),(0,K.jsxs)(D,{gap:`3xs`,style:{flex:1,minWidth:0},children:[(0,K.jsx)(j,{size:`sm`,weight:`medium`,children:e.name}),(0,K.jsxs)(E,{align:`center`,gap:`sm`,wrap:`wrap`,children:[(0,K.jsx)(j,{size:`xs`,color:`text-secondary`,children:e.meta}),e.unassigned&&(0,K.jsx)(N,{content:t(`unassigned`),intent:`neutral`,variant:`subtle`,size:`sm`}),i.includes(e.id)&&(0,K.jsx)(N,{content:t(`acked_by`),intent:`success`,variant:`subtle`,size:`sm`})]})]})]})},e.id))]}),(0,K.jsx)(T,{px:`2xl`,pt:`2xl`,pb:`sm`,children:(0,K.jsx)(B,{tag:`h2`,size:`xs`,children:t(`timeline_title`)})}),(0,K.jsx)(T,{px:`2xl`,pb:`md`,children:(0,K.jsx)(F,{children:[{time:t(`t1_time`),text:t(`t1`),intent:`neutral`},{time:t(`t2_time`),text:t(`t2`),intent:`danger`},{time:t(`t3_time`),text:t(`t3`),intent:`neutral`},{time:t(`t4_time`),text:t(`t4`),intent:`neutral`,last:!0}].map(e=>(0,K.jsxs)(R,{children:[(0,K.jsxs)(z,{children:[(0,K.jsx)(I,{intent:e.intent}),!e.last&&(0,K.jsx)(P,{})]}),(0,K.jsx)(L,{children:(0,K.jsxs)(D,{gap:`3xs`,children:[(0,K.jsx)(j,{size:`xs`,color:`text-secondary`,children:e.time}),(0,K.jsx)(j,{size:`sm`,children:e.text})]})})]},e.time))})}),(0,K.jsx)(T,{px:`2xl`,pb:`sm`,children:(0,K.jsx)(B,{tag:`h2`,size:`xs`,children:t(`warroom_title`)})}),(0,K.jsx)(T,{px:`2xl`,pb:`2xl`,children:(0,K.jsxs)(S,{children:[(0,K.jsxs)(C,{children:[(0,K.jsxs)(y,{position:`left`,senderName:t(`sender_priya`),timestamp:`03:41`,avatar:(0,K.jsx)(u,{size:`sm`,initials:`PR`,intent:`info`}),children:[(0,K.jsx)(j,{size:`sm`,children:t(`msg_priya`)}),(0,K.jsx)(T,{mt:`sm`,children:(0,K.jsx)(W,{code:`kubectl -n checkout get pods -l app=checkout-api -o wide`,language:`bash`})})]}),(0,K.jsx)(y,{position:`right`,senderName:t(`sender_you`),timestamp:`03:43`,avatar:(0,K.jsx)(u,{size:`sm`,initials:`ME`,intent:`neutral`}),children:(0,K.jsx)(j,{size:`sm`,children:t(`msg_you`)})})]}),(0,K.jsx)(v,{placeholder:t(`chat_placeholder`)})]})}),(0,K.jsx)(T,{px:`2xl`,pb:`2xl`,children:(0,K.jsxs)(m,{children:[(0,K.jsx)(h,{asChild:!0,children:(0,K.jsx)(k,{variant:`outline`,fullWidth:!0,icon:(0,K.jsx)(O,{name:`DocumentIcon`,size:`sm`}),iconPosition:`left`,children:t(`runbook_open`)})}),(0,K.jsxs)(c,{children:[(0,K.jsxs)(d,{children:[(0,K.jsx)(g,{children:t(`runbook_title`)}),(0,K.jsx)(f,{children:t(`runbook_desc`)})]}),(0,K.jsx)(l,{children:(0,K.jsxs)(D,{gap:`md`,children:[(0,K.jsx)(j,{size:`sm`,children:t(`runbook_step_1`)}),(0,K.jsx)(j,{size:`sm`,children:t(`runbook_step_2`)}),(0,K.jsx)(j,{size:`sm`,children:t(`runbook_step_3`)})]})}),(0,K.jsx)(b,{children:(0,K.jsx)(p,{asChild:!0,children:(0,K.jsx)(k,{variant:`ghost`,children:t(`runbook_close`)})})})]})]})}),(0,K.jsxs)(x,{bordered:!0,fixed:!1,children:[(0,K.jsx)(x.Item,{active:J===`oncall`,onClick:()=>Y(`oncall`),icon:(0,K.jsx)(O,{name:`BellIcon`}),label:t(`tab_oncall`)}),(0,K.jsx)(x.Item,{active:J===`alerts`,onClick:()=>Y(`alerts`),icon:(0,K.jsx)(O,{name:`AlertCircleIcon`}),label:t(`tab_alerts`),badge:X.length>0?String(X.length):void 0}),(0,K.jsx)(x.Item,{active:J===`runbooks`,onClick:()=>Y(`runbooks`),icon:(0,K.jsx)(O,{name:`DocumentIcon`}),label:t(`tab_runbooks`)}),(0,K.jsx)(x.Item,{active:J===`you`,onClick:()=>Y(`you`),icon:(0,K.jsx)(O,{name:`UserIcon`}),label:t(`tab_you`)})]})]})]})}},Y=[`IncidentTriage`],J.parameters={...J.parameters,docs:{...J.parameters?.docs,source:{originalSource:`{
        ...
        <div className="oncall-frame">
          ...
          <PullToRefresh onRefresh={handleRefresh} refreshing={refreshing}>
            ...
            {alerts.length === 0 && <Box px="2xl" py="2xl">
                <EmptyState icon={<Icon name="CheckCircleIcon" size="lg" color="success" />} title={r("empty_title")} description={r("empty_desc")} extra={<Button variant="ghost" size="sm" onClick={() => setSnoozed([])}>
                      {r("empty_action")}
                    </Button>} />
              </Box>}
...
幅を固定すると、狭幅の回帰がスナップショットに出る。`,...J.parameters?.docs?.description}}}}))();export{J as IncidentTriage,Y as __namedExportsOrder,q as default};