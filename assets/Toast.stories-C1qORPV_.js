"use client";
import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-DmCNssFd.js";import{Cr as r,br as i,cr as a,xr as o,yr as s}from"./iframe-F5Up1IQq.js";import{gn as c,mn as l,pn as u,t as d}from"./src-Ssuy8lr7.js";import{t as f}from"./Button-Dps1MPAd.js";var p=e({Danger:()=>C,Default:()=>v,Info:()=>b,Interactive:()=>T,LongContent:()=>S,Success:()=>y,Warning:()=>x,__namedExportsOrder:()=>E,default:()=>_}),m,h,g,_,v,y,b,x,S,C,w,T,E,D=t((()=>{n(),o(),i(),d(),m=a(),h=()=>typeof window<`u`&&!!window.__VRT__,g=()=>h()?{duration:0}:{},_={title:`Components/Alerts & Notifications/Toast`,component:u,tags:[`!autodocs`],args:{...g()},argTypes:{intent:{control:`select`,options:[`default`,`info`,`success`,`warning`,`danger`]}}},v={render:function(e){let{t}=r(s);return(0,m.jsx)(u,{...e,title:e.title||t(`story.toast_system_notif`),description:e.description||t(`story.toast_update_desc`)})},args:{intent:`default`}},y={render:function(e){let{t}=r(s);return(0,m.jsx)(u,{...e,title:e.title||t(`story.toast_success_title`),description:e.description||t(`story.toast_success_desc`)})},args:{intent:`success`}},b={render:function(e){let{t}=r(s);return(0,m.jsx)(u,{...e,title:e.title||t(`story.toast_update_title`),description:e.description||t(`story.toast_update_desc`)})},args:{intent:`info`}},x={render:function(e){let{t}=r(s);return(0,m.jsx)(u,{...e,title:e.title||t(`story.toast_connection_title`),description:e.description||t(`story.toast_connection_desc`)})},args:{intent:`warning`}},S={render:function(e){let{t}=r(s);return(0,m.jsx)(`div`,{style:{maxWidth:`420px`},children:(0,m.jsx)(u,{...e,title:e.title||t(`story.toast_long_title`),description:e.description||t(`story.toast_long_desc`)})})},args:{intent:`warning`}},C={render:function(e){let{t}=r(s);return(0,m.jsx)(u,{...e,title:e.title||t(`story.toast_upload_failed_title`),description:e.description||t(`story.toast_upload_failed_desc`)})},args:{intent:`danger`}},w=()=>{let{show:e}=c(),{t}=r(s);return(0,m.jsxs)(`div`,{style:{display:`flex`,gap:`10px`,flexWrap:`wrap`},children:[(0,m.jsx)(f,{variant:`solid`,onClick:()=>e({title:t(`story.toast_success_title`),description:t(`story.toast_success_desc`),intent:`success`}),children:t(`story.toast_show_success`)}),(0,m.jsx)(f,{variant:`outline`,onClick:()=>e({title:t(`story.notification_error_title`),description:t(`story.notification_error_desc`),intent:`danger`}),children:t(`story.toast_show_error`)}),(0,m.jsx)(f,{variant:`ghost`,onClick:()=>e({title:t(`story.toast_system_notif`),description:t(`story.toast_5s_desc`),intent:`info`,duration:5e3}),children:t(`story.toast_show_5s`)})]})},T={render:()=>(0,m.jsx)(l,{position:`bottom-right`,children:(0,m.jsx)(w,{})})},v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
