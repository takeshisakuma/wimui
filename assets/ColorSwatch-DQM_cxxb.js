...
import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-DmCNssFd.js";import{Cr as r,Tr as i,ur as a}from"./iframe-CIRVVv_5.js";import{ii as o,ri as s}from"./src-C35woejG.js";var c,l,u,d,f,p,m,h=e((()=>{c=t(n(),1),r(),o(),l=a(),u=`WIM_SIGNAL_COLOR_CHANGE`,d=e=>{if(!e)return`#000000`;if(e.startsWith(`#`)){let t=e.slice(1);if(t.length===3||t.length===4)return`#${t[0]}${t[0]}${t[1]}${t[1]}${t[2]}${t[2]}`;if(t.length===8)return`#${t.slice(0,6)}`;if(t.length===6)return e}if(typeof document<`u`){let t=document.createElement(`div`);t.style.color=e,t.style.display=`none`,document.body.appendChild(t);let n=getComputedStyle(t).color;document.body.removeChild(t);let r=n.match(/\d+/g);if(r&&r.length>=3)return`#${parseInt(r[0]).toString(16).padStart(2,`0`)}${parseInt(r[1]).toString(16).padStart(2,`0`)}${parseInt(r[2]).toString(16).padStart(2,`0`)}`}return e},f=e=>{let t=d(e),n=t.startsWith(`#`)?t.slice(1):t;if(n.length!==7&&n.length!==6){if(n.length===3||n.length===4&&t.startsWith(`#`)){let e=+(n.length===4),t=parseInt(n[e]+n[e],16)/255,r=parseInt(n[e+1]+n[e+1],16)/255,i=parseInt(n[e+2]+n[e+2],16)/255,a=e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4;return .2126*a(t)+.7152*a(r)+.0722*a(i)}return 0}let r=+(n.length===7),i=parseInt(n.substring(r,r+2),16)/255,a=parseInt(n.substring(r+2,r+4),16)/255,o=parseInt(n.substring(r+4,r+6),16)/255,s=e=>e<=.03928?e/12.92:((e+.055)/1.055)**2.4;return .2126*s(i)+.7152*s(a)+.0722*s(o)},p=(e,t)=>{let n=f(e),r=f(t),i=Math.max(n,r),a=Math.min(n,r);return(i+.05)/(a+.05)},m=()=>{let{t:e}=i(),[t,n]=(0,c.useState)(`var(--wim-color-primary)`),[r,a]=(0,c.useState)(`var(--wim-color-text-on-primary)`),o=(0,c.useMemo)(()=>d(t),[t]),f=(0,c.useMemo)(()=>d(r),[r]),m=(0,c.useMemo)(()=>p(o,f),[o,f]);(0,c.useEffect)(()=>{let e=e=>{let t=e.detail;t?.type===`bg`&&n(t.value),t?.type===`fg`&&a(t.value)};return window.addEventListener(u,e),()=>window.removeEventListener(u,e)},[]);let h=m>=4.5,g=m>=3;return(0,l.jsxs)(`div`,{className:`wim-contrast-checker`,children:[(0,l.jsx)(`style`,{children:`
                ...
                `}),(0,l.jsxs)(`div`,{className:`wim-contrast-controls`,children:[(0,l.jsxs)(`div`,{className:`wim-contrast-control`,children:[(0,l.jsx)(`label`,{htmlFor:`bg-input`,className:`wim-contrast-label`,children:`Background`}),(0,l.jsxs)(`div`,{className:`wim-contrast-inputs`,children:[(0,l.jsx)(s,{value:o,onChange:e=>n(e.target.value),className:`wim-contrast-color-picker`}),(0,l.jsx)(`input`,{id:`bg-input`,className:`wim-text-input`,value:t,onChange:e=>n(e.target.value),placeholder:`#000000 or var(...)`})]})]}),(0,l.jsxs)(`div`,{className:`wim-contrast-control`,children:[(0,l.jsx)(`label`,{htmlFor:`fg-input`,className:`wim-contrast-label`,children:`Foreground`}),(0,l.jsxs)(`div`,{className:`wim-contrast-inputs`,children:[(0,l.jsx)(s,{value:f,onChange:e=>a(e.target.value),className:`wim-contrast-color-picker`}),(0,l.jsx)(`input`,{id:`fg-input`,className:`wim-text-input`,value:r,onChange:e=>a(e.target.value),placeholder:`#ffffff or var(...)`})]})]})]}),(0,l.jsxs)(`div`,{className:`wim-contrast-result`,children:[(0,l.jsxs)(`div`,{className:`wim-contrast-ratio-display`,children:[(0,l.jsx)(`span`,{className:`wim-contrast-ratio-value`,children:m.toFixed(2)}),(0,l.jsx)(`span`,{className:`wim-contrast-ratio-unit`,children:`Ratio`})]}),(0,l.jsxs)(`div`,{className:`wim-contrast-badges`,children:[(0,l.jsxs)(`div`,{className:`wim-contrast-badge`,children:[(0,l.jsx)(`span`,{children:e(`doc.contrast_normal_text`)}),(0,l.jsx)(`span`,{className:`wim-contrast-badge-status ${h?`wim-contrast-status-pass`:`wim-contrast-status-fail`}`,children:h?`PASS (AA)`:`FAIL (AA)`})]}),(0,l.jsxs)(`div`,{className:`wim-contrast-badge`,children:[(0,l.jsx)(`span`,{children:e(`doc.contrast_large_text`)}),(0,l.jsx)(`span`,{className:`wim-contrast-badge-status ${g?`wim-contrast-status-pass`:`wim-contrast-status-fail`}`,children:g?`PASS (AA)`:`FAIL (AA)`})]})]})]}),(0,l.jsx)(`div`,{className:`wim-contrast-preview-container`,children:(0,l.jsxs)(`div`,{className:`wim-contrast-preview`,style:{backgroundColor:o,color:f},children:[(0,l.jsx)(`span`,{className:`wim-contrast-preview-text-lg`,children:`Design System Contrast Test`}),(0,l.jsx)(`span`,{className:`wim-contrast-preview-text-sm`,children:`The quick brown fox jumps over the lazy dog.`})]})})]})},m.__docgenInfo={description:``,methods:[],displayName:`ContrastChecker`}})),g,_,v,y=e((()=>{n(),h(),g=a(),_=({name:e,value:t,color:n,foreground:r,children:i,variant:a=`card`})=>{let o=e=>{let r=t||n;r.startsWith(`--`)&&(r=`var(${r})`);let i=new CustomEvent(u,{detail:{type:e,value:r}});window.dispatchEvent(i)};return(0,g.jsxs)(g.Fragment,{children:[(0,g.jsx)(`style`,{children:`
        .wim-swatch-card {
          border-radius: 12px;
          overflow: hidden;
