import{j as e}from"./jsx-runtime-u17CrQMm.js";import{E as l}from"./EmptyState-CCtL72H9.js";import{I as c}from"./Icon-EUIgR6rt.js";import{B as p}from"./Button-BxIHQtnc.js";const m={title:"Component/Data Indicators/EmptyState",component:l,tags:[],parameters:{layout:"centered"}},r={args:{title:"No data found",description:"We couldn't find any data matching your search. Please try again with different keywords.",icon:e.jsx(c,{name:"SearchIcon",size:"large"}),action:e.jsx(p,{label:"Clear search"})}},t={args:{title:"No messages yet",description:"When you receive messages, they will appear here.",variant:"simple"}},o={args:{title:"List is empty",icon:e.jsx(c,{name:"CircleIcon",size:"large"})}},s={args:{title:"Ready to start?",description:"Create your first project to begin tracking your progress.",icon:e.jsx("svg",{viewBox:"0 0 24 24",width:"48",height:"48",fill:"none",stroke:"currentColor",strokeWidth:"2",strokeLinecap:"round",strokeLinejoin:"round",children:e.jsx("path",{d:"M12 5v14M5 12h14"})}),action:e.jsxs("div",{style:{display:"flex",gap:"8px"},children:[e.jsx(p,{label:"Browse templates",priority:"secondary"}),e.jsx(p,{label:"Create project",priority:"primary"})]})}},a={args:{title:"メールがありません",description:"受信トレイは空です。新しいメッセージが届くとここに表示されます。",icon:e.jsx(c,{name:"EmailIcon",size:"large"})}},n={args:{title:"動画が見つかりません",description:"アップロードされた動画がまだありません。最初の動画を追加しましょう。",icon:e.jsx(c,{name:"VideoIcon",size:"large"}),action:e.jsx(p,{label:"動画をアップロード",priority:"primary"})}},i={args:{title:"ファイルがありません",description:"このフォルダにはドキュメントが含まれていません。",icon:e.jsx(c,{name:"DocumentIcon",size:"large"})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    title: "No data found",
