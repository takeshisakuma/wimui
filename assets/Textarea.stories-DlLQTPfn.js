      ...
      maxWidth: "500px"
        ...
        gap: "8px"
          ...
          <Label htmlFor="motivation" required label={t("story.textarea_label_motivation")}>
            <Textarea id="motivation" {...args} intent="error" defaultValue={t("story.textarea_value_none")} rows={3} fullWidth />
          </Label>
          <FieldError content={t("story.textarea_error_long")} />
        </div>
      </div>;
  }
}`,..._.parameters?.docs?.source}}};const b=["Basic","Ghost","ErrorStatus","Disabled","FullWidth","FieldSizingContent","FormPattern"],v=Object.freeze(Object.defineProperty({__proto__:null,Basic:i,Disabled:p,ErrorStatus:c,FieldSizingContent:u,FormPattern:_,FullWidth:x,Ghost:d,__namedExportsOrder:b,default:h},Symbol.toStringTag,{value:"Module"}));export{i as B,p as D,c as E,x as F,d as G,v as T};
