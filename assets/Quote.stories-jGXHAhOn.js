import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as _}from"./index-BbZ6eRDH.js";import{u as s}from"./useTranslation-y7Vel5kV.js";import{A as d}from"./iframe-BB8xHwtR.js";const o=({size:t="md",content:e,cite:a,color:p="black",border:g=!0,className:y,...f})=>{const{t:m}=s();return r.jsxs("blockquote",{className:_("wim-quote",`wim-quote--${t}`,`wim-quote--${p}`,g&&"wim-quote--border",y),...f,children:[r.jsx("div",{className:"wim-quote__content",children:m(e)}),a&&r.jsx("cite",{className:"wim-quote__cite",children:m(a)})]})};o.__docgenInfo={description:"",methods:[],displayName:"Quote",props:{size:{required:!1,tsType:{name:"union",raw:'"sm" | "md" | "lg"',elements:[{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'}]},description:"",defaultValue:{value:'"md"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
