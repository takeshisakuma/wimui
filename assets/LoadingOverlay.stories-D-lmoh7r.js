import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as S}from"./index-BKAe34ln.js";import{S as z}from"./Spinner-CMQWhEBy.js";import{L as E}from"./Loader-CmiyYA4u.js";import{R as L,A as s}from"./iframe-DSE3UbG8.js";import{B as k}from"./Button-Cr-B_lSk.js";import{I as j}from"./Icon-xLIHigt1.js";import{u as t}from"./useTranslation-DOQQDmnd.js";const i=({visible:a=!1,loaderType:r="spinner",loaderSize:n="lg",loaderColor:o="primary",backdropVariant:l="dark",blur:x="sm",message:_,fixed:C=!1,zIndex:h,children:b,className:T,style:w,...R})=>{if(!a)return null;const f=n?{sm:"small",md:"medium",lg:"large",xl:"large"}[n]:void 0,A=()=>b||(r==="spinner"?e.jsx(z,{size:f,color:o}):e.jsx(E,{variant:r,size:f,color:o}));return e.jsxs("div",{className:S("wim-loading-overlay",C&&"wim-loading-overlay--fixed",T),style:{...w,...h!==void 0&&{zIndex:h}},role:"status","aria-live":"polite","aria-busy":"true",...R,children:[e.jsx("div",{className:S("wim-loading-overlay__backdrop",`wim-loading-overlay__backdrop--${l}`,`wim-loading-overlay__backdrop--blur-${x}`)}),e.jsxs("div",{className:"wim-loading-overlay__content",children:[A(),_&&e.jsx("div",{className:"wim-loading-overlay__message",children:_})]})]})};i.__docgenInfo={description:"画面全体または特定の要素をオーバーレイし、ローディング状態を表示するコンポーネント。",methods:[],displayName:"LoadingOverlay",props:{visible:{required:!1,tsType:{name:"boolean"},description:"オーバーレイの表示/非表示を制御します。",defaultValue:{value:"false",computed:!1}},loaderType:{required:!1,tsType:{name:"union",raw:'"spinner" | "bars" | "dots" | "pulse"',elements:[{name:"literal",value:'"spinner"'},{name:"literal",value:'"bars"'},{name:"literal",value:'"dots"'},{name:"literal",value:'"pulse"'}]},description:"ローディングインジケーターのタイプ。",defaultValue:{value:'"spinner"',computed:!1}},loaderSize:{required:!1,tsType:{name:"union",raw:'"sm" | "md" | "lg" | "xl"',elements:[{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'},{name:"literal",value:'"xl"'}]},description:"ローディングインジケーターのサイズ。",defaultValue:{value:'"lg"',computed:!1}},loaderColor:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
