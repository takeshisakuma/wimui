...
| "evenly"\r
| "stretch"\r
| React.CSSProperties["justifyContent"]`,elements:[{name:"literal",value:'"start"'},{name:"literal",value:'"center"'},{name:"literal",value:'"end"'},{name:"literal",value:'"between"'},{name:"literal",value:'"around"'},{name:"literal",value:'"evenly"'},{name:"literal",value:'"stretch"'},{name:'ReactCSSProperties["justifyContent"]',raw:'React.CSSProperties["justifyContent"]'}]},description:"Justify-content"}}};const h={title:"Layout/Stack",component:a,tags:[],argTypes:{direction:{control:"radio",options:["row","column"]},gap:{control:"select",options:["xs","sm","md","lg","xl",10,20,40]}}},s={args:{direction:"column",gap:"md",children:[e.jsx(n,{bg:"#eff6ff",p:20,radius:8,style:{border:"1px solid #3b82f6"},children:"Item 1"},"1"),e.jsx(n,{bg:"#f0fdf4",p:20,radius:8,style:{border:"1px solid #22c55e"},children:"Item 2"},"2"),e.jsx(n,{bg:"#fff7ed",p:20,radius:8,style:{border:"1px solid #f97316"},children:"Item 3"},"3")]}},i={args:{direction:"row",gap:"lg",children:[e.jsx(n,{bg:"#eff6ff",p:20,radius:8,style:{border:"1px solid #3b82f6"},children:"Item 1"},"1"),e.jsx(n,{bg:"#f0fdf4",p:20,radius:8,style:{border:"1px solid #22c55e"},children:"Item 2"},"2"),e.jsx(n,{bg:"#fff7ed",p:20,radius:8,style:{border:"1px solid #f97316"},children:"Item 3"},"3")]}},o={render:()=>e.jsxs(a,{gap:"xl",children:[e.jsx(n,{bg:"#f8fafc",p:10,children:"Gap: xl"}),e.jsxs(a,{direction:"row",gap:"xs",children:[e.jsx(n,{bg:"#eff6ff",p:10,children:"Gap: xs"}),e.jsx(n,{bg:"#eff6ff",p:10,children:"Gap: xs"}),e.jsx(n,{bg:"#eff6ff",p:10,children:"Gap: xs"})]}),e.jsxs(a,{direction:"row",gap:"lg",children:[e.jsx(n,{bg:"#f0fdf4",p:10,children:"Gap: lg"}),e.jsx(n,{bg:"#f0fdf4",p:10,children:"Gap: lg"}),e.jsx(n,{bg:"#f0fdf4",p:10,children:"Gap: lg"})]})]})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    direction: "column",
    gap: "md",
...
}`,...o.parameters?.docs?.source}}};const T=["Default","Row","SpacingTokens"],I=Object.freeze(Object.defineProperty({__proto__:null,Default:s,Row:i,SpacingTokens:o,__namedExportsOrder:T,default:h},Symbol.toStringTag,{value:"Module"}));export{s as D,i as R,I as S,o as a};
