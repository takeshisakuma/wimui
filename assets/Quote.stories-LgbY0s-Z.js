import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as y}from"./index-CToQi8_n.js";import{u as h}from"./useTranslation-D3GemlCY.js";const r=({size:a="medium",content:u,cite:i,color:m="black",border:d=!0,className:p,...g})=>{const{t:c}=h();return e.jsxs("blockquote",{className:y("wim-quote",`wim-quote--${a==="small"?"sm":a==="large"?"lg":"md"}`,`wim-quote--${m}`,d&&"wim-quote--border",p),...g,children:[e.jsx("div",{className:"wim-quote__content",children:c(u)}),i&&e.jsx("cite",{className:"wim-quote__cite",children:c(i)})]})};r.__docgenInfo={description:"",methods:[],displayName:"Quote",props:{size:{required:!1,tsType:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
