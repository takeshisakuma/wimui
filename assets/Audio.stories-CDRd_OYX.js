"use client";
import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{t as r}from"./react-DmCNssFd.js";import{Cr as i,br as a,cr as o,xr as s,yr as c}from"./iframe-DiXuc7DI.js";import{d as l,t as u}from"./src-BE5jBQ9L.js";import{t as d}from"./Button-d-SlSJ4S.js";var f,p=t((()=>{f=``+new URL(`audiosample-CblkpeR1.mp3`,import.meta.url).href})),m=e({AutoPlay:()=>x,CustomControls:()=>C,Default:()=>y,FullFeatured:()=>w,PremiumFeatures:()=>T,Rounded:()=>S,WithCaption:()=>b,__namedExportsOrder:()=>E,default:()=>v}),h,g,_,v,y,b,x,S,C,w,T,E,D=t((()=>{h=n(r(),1),p(),s(),a(),u(),g=o(),_=n(r(),1),v={title:`Components/Media/Audio`,component:l,parameters:{layout:`centered`},argTypes:{radius:{control:`select`,options:[`none`,`sm`,`md`,`lg`,`full`]}}},y={args:{src:f,controls:!0,radius:`none`}},b={render:function(e){let{t}=i(c);return(0,g.jsx)(l,{...e,caption:t(`story.audio_caption`)})},args:{src:f,controls:!0,radius:`none`}},x={args:{src:f,controls:!0,autoPlay:!0,muted:!0}},S={args:{src:f,customControls:!0,controls:!1,radius:`full`,shadow:!0,border:!0}},C={name:`Custom Design`,args:{customControls:!0,showMetadata:!0,radius:`md`,shadow:!0,border:!0},render:function(e){let{t}=i(c);return(0,g.jsx)(l,{...e,src:{src:f,title:t(`story.audio_custom_player`),artist:`Wim UI`}})}},w={args:{customControls:!0,radius:`md`,shadow:!0,border:!0,visualizer:!0,showMetadata:!0,fadeIn:1500,fadeOut:1500,crossfade:2e3,playbackRate:!0,hotkeys:!0,presets:!0,sleepTimer:!0},render:function(e){let{t}=i(c);return(0,g.jsx)(l,{...e,src:[{src:f,title:t(`story.audio_sample_web_api`),artist:`Wim UI`},{src:f,title:t(`story.audio_track_2`),artist:`Wim UI`}]})}},T={render:function(e){let{t}=i(c),[n,r]=h.useState(0);return(0,g.jsx)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`2rem`},children:(0,g.jsxs)(`div`,{children:[(0,g.jsx)(`p`,{style:{marginBottom:`1rem`,fontWeight:`bold`},children:t(`story.audio_premium_features_lazy_load`)}),(0,g.jsx)(`div`,{style:{marginBottom:`1rem`},children:(0,g.jsx)(d,{variant:`solid`,onClick:()=>r(e=>e+1),icon:`RefreshIcon`,children:t(`story.audio_premium_features_reload`)})}),(0,_.createElement)(l,{...e,key:n,src:f,customControls:!0,showMetadata:!0,demoDelay:2e3,radius:`md`,shadow:!0,caption:t(`story.audio_premium_features_caption`)})]})})}},y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
  args: {
    src: audioSample,
    controls: true,
    radius: "none"
