          ...
          <Grid cols="repeat(auto-fit, minmax(280px, 1fr))" gap={24} justify="center">\r
            ...
            border: "1px solid var(--wim-color-border-secondary)"
                ...
                <Stack justify="space-between" align="center" direction="row">\r
                  ...
                  <Badge status="neutral" content="+12.5%" size="small" />\r
                </Stack>\r
                <Stats.Value>\r
  ...
  render: () => <Container style={{
    ...
    background: "#fff"
      ...
      marginBottom: "64px"
        ...
        <Badge status="primary" content="PRICING PLANS" />\r
        <Stack align="center" gap="3xl">\r
          <Heading tag="h2" size="xl" align="center">\r
            Choose the right plan for you\r
          </Heading>\r
          <Container size="sm">\r
...
\r
        ...
        position: "relative"
          ...
          transform: "translateX(-50%)"
            ...
            <Badge status="primary" content="MOST POPULAR" size="small" />\r
          </div>\r
          <Stack gap="lg" style={{
          height: "100%"
        }}>\r
    ...
    padding: "24px"
      ...
      textAlign: "center"
        ...
        <Stack gap="2xl" align="center">\r
          <Heading tag="h1" size="xl" align="center">\r
            Something&apos;s missing.\r
          </Heading>\r
