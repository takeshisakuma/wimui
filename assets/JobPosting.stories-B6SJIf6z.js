"use client";
import{i as e,s as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-DmCNssFd.js";import{Cr as r,Sr as i,Tr as a,ur as o,xr as s}from"./iframe-wf1-Tomv.js";import{$r as c,Er as l,Gr as u,Ji as d,Li as ee,Ni as f,Rr as p,Sr as m,Wr as h,Yn as g,ai as _,fr as v,gr as y,ir as b,ji as x,ki as S,mr as te,or as ne,ri as re,t as ie,ti as C,wr as w,zi as T}from"./src--JUR9phw.js";import{t as E}from"./Box-BmTu6FNd.js";import{t as D}from"./Stack-CSVZoS0F.js";import{t as O}from"./Button-BgC4JuQN.js";import{t as k}from"./ToggleGroup-DwWGYvm8.js";import{t as A}from"./FieldTemplate-BlJuZxyc.js";import{t as j}from"./Text-BWjUyV9U.js";import{t as M}from"./Checkbox-DG0Azh-y.js";import{t as N}from"./Input-Dl7Tj7nN.js";import{s as P,t as F}from"./QueryBuilder-Mq01G8OB.js";import{r as I,t as L}from"./ImageCropper-Df5xNWKz.js";import{t as R}from"./TagInput-DTpY3cvz.js";import{t as z}from"./ThemeToggle-D4OQahiC.js";import{t as B}from"./Title-BnkT46o_.js";var V,H,U,W,G,K,q,J,Y,X,Z,Q,$;e((()=>{V=t(n(),1),r(),i(),ie(),H=o(),U={title:`Patterns/Hiring`,parameters:{layout:`fullscreen`,docs:{description:{component:"8 枚目の合成画面（T32 / T109）。**狙いは「重い入力」の層**で、\n単体では成立していても隣り合わせると崩れやすい部品\n（`RichTextEditor` / `ImageCropper` / `QueryBuilder` / `SignaturePad` /\n`CreditCardInput` / `ColorPicker`）を、無理なく同居する題材に載せる。\n\n題材は `Patterns/Admin` `Patterns/Form` と同じ Kiyosumi Roasters の採用側。\n**1 画面に全部は載せない** ── 求人票を書く / 掲載先と支払い / 採用ページの体裁 /\n応募者の抽出 / 内定の署名、と**作業ごとにストーリーを分ける**。\n\n**主役はストーリーごとに 1 つ**（Default = 本文のエディタ、PageStyle = 写真、\nTalentPool = 条件式）。primary の面もそれぞれ 1 箇所に絞る。\n\n**載せなかったもの**: `FloatButton`（この 5 画面はどれもデスクトップの編集作業で、\n画面に浮かせる操作が無い＝置くと「スロットを埋める」ことになる）／`InputBase`\n（入力の殻そのもので、`Input` / `Combobox` 等の内側で必ず通る）／\n**`ButtonGroup`**（joined は「1 つの操作面」を作るもので、境目を共有して\n見える。この画面に出てくる操作はどれも独立していて束ねる理由が無い。\n合成のためだけに置くのは「スロットを埋める」側）。"}}}},W=e=>`docs_stories_recipes:hiring.${e}`,G=new Date(`2026-08-17T00:00:00+09:00`),K=new Date(`2026-09-14T00:00:00+09:00`),q={render:function(){let{t:e}=a(s);return(0,H.jsxs)(d,{children:[(0,H.jsx)(d.Header,{children:(0,H.jsxs)(S,{children:[(0,H.jsx)(S.Section,{children:(0,H.jsx)(j,{size:`sm`,color:`text-secondary`,children:e(W(`org`))})}),(0,H.jsx)(S.Section,{align:`end`,children:(0,H.jsxs)(x,{gap:`sm`,align:`center`,children:[(0,H.jsx)(g,{size:`sm`,toggleLabel:e(W(`publish_more`)),actions:[{label:e(W(`publish_schedule`))},{label:e(W(`publish_share`))},{label:e(W(`publish_withdraw`)),disabled:!0}],children:e(W(`publish`))}),(0,H.jsx)(z,{size:`sm`,applyToDocument:!1,storageKey:null,labels:{light:e(W(`theme_light`)),dark:e(W(`theme_dark`)),toggle:e(W(`theme_toggle`))}})]})})]})}),(0,H.jsx)(d.Body,{children:(0,H.jsx)(d.Main,{children:(0,H.jsxs)(D,{gap:`xl`,children:[(0,H.jsxs)(D,{gap:`2xs`,children:[(0,H.jsx)(B,{tag:`h1`,size:`md`,children:e(W(`role`))}),(0,H.jsxs)(x,{gap:`sm`,align:`center`,children:[(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`autosaved`))}),(0,H.jsx)(ne,{href:`#`,variant:`ghost`,size:`sm`,children:e(W(`preview`))})]})]}),(0,H.jsxs)(f,{cols:{base:1,lg:`minmax(0, 1fr) minmax(0, 21rem)`},gap:`2xl`,children:[(0,H.jsxs)(D,{gap:`md`,children:[(0,H.jsxs)(D,{gap:`3xs`,children:[(0,H.jsx)(B,{tag:`h2`,size:`sm`,children:e(W(`body_heading`))}),(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`body_hint`))})]}),(0,H.jsx)(w,{fullWidth:!0,defaultValue:e(W(`body_html`)),minHeight:320,labels:{toolbar:e(W(`editor_toolbar`)),bold:e(W(`editor_bold`)),italic:e(W(`editor_italic`)),underline:e(W(`editor_underline`)),strikethrough:e(W(`editor_strike`)),ul:e(W(`editor_ul`)),ol:e(W(`editor_ol`)),link:e(W(`editor_link`)),unlink:e(W(`editor_unlink`)),removeFormat:e(W(`editor_clear`))},"aria-label":e(W(`body_heading`))}),(0,H.jsx)(R,{fullWidth:!0,label:e(W(`skills_label`)),defaultValue:[e(W(`skill_roasting`)),e(W(`skill_cupping`)),e(W(`skill_early`))],placeholder:e(W(`skills_placeholder`))})]}),(0,H.jsxs)(D,{gap:`xl`,children:[(0,H.jsxs)(D,{gap:`md`,children:[(0,H.jsx)(C,{label:e(W(`family_label`)),defaultValue:e(W(`family_roasting`)),fullWidth:!0,options:[{label:e(W(`family_roasting`)),value:`roasting`},{label:e(W(`family_floor`)),value:`floor`},{label:e(W(`family_delivery`)),value:`delivery`},{label:e(W(`family_qc`)),value:`qc`}],placeholder:e(W(`family_placeholder`))}),(0,H.jsx)(l,{label:e(W(`contract_label`)),defaultValue:`fixed`,options:[{label:e(W(`contract_permanent`)),value:`permanent`},{label:e(W(`contract_fixed`)),value:`fixed`},{label:e(W(`contract_part`)),value:`part`}]})]}),(0,H.jsxs)(D,{gap:`md`,children:[(0,H.jsx)(A,{label:e(W(`pay_label`)),error:e(W(`pay_error`)),htmlFor:`hiring-pay`,children:(0,H.jsxs)(h,{fullWidth:!0,children:[(0,H.jsx)(u,{children:e(W(`pay_currency`))}),(0,H.jsx)(N,{id:`hiring-pay`,defaultValue:`1,150`,intent:`danger`,inputMode:`numeric`,fullWidth:!0}),(0,H.jsx)(u,{children:e(W(`pay_unit`))})]})}),(0,H.jsx)(m,{label:e(W(`hours_label`)),min:8,max:40,step:2,defaultValue:[24,36]})]}),(0,H.jsx)(c,{label:e(W(`window_label`)),startProps:{defaultValue:G},endProps:{defaultValue:K}}),(0,H.jsx)(p,{label:e(W(`memo_label`)),options:[{id:`u-tsuzuki`,display:`都築 和真`},{id:`u-kowalczyk`,display:`Marta Kowalczyk`},{id:`u-tokano`,display:`戸叶 ひかる`},{id:`u-adeyemi`,display:`Samuel Adeyemi`}],defaultValue:e(W(`memo_value`)),placeholder:e(W(`memo_placeholder`)),rows:3,fullWidth:!0})]})]})]})})})]})}},J={render:function(){let{t:e}=a(s),[t,n]=(0,V.useState)([`own`,`minna`]);return(0,H.jsx)(E,{p:`2xl`,children:(0,H.jsx)(T,{size:`sm`,fluid:!1,children:(0,H.jsxs)(D,{gap:`2xl`,children:[(0,H.jsxs)(D,{gap:`3xs`,children:[(0,H.jsx)(B,{tag:`h2`,size:`sm`,children:e(W(`dist_title`))}),(0,H.jsx)(j,{size:`sm`,color:`text-secondary`,children:e(W(`dist_lead`))})]}),(0,H.jsx)(v,{value:t,onChange:n,label:e(W(`dist_boards_label`)),options:[{label:e(W(`board_own`)),value:`own`},{label:e(W(`board_minna`)),value:`minna`},{label:e(W(`board_baristas`)),value:`baristas`},{label:e(W(`board_hw`)),value:`hw`,disabled:!0}]}),(0,H.jsx)(ee,{}),(0,H.jsxs)(D,{gap:`md`,children:[(0,H.jsx)(j,{size:`sm`,color:`text-secondary`,children:e(W(`dist_charge`),{amount:`12,800`})}),(0,H.jsx)(b,{label:e(W(`card_label`)),defaultValue:`4111111111111111`,width:`md`}),(0,H.jsx)(l,{label:e(W(`bill_label`)),defaultValue:`company`,direction:`horizontal`,options:[{label:e(W(`bill_company`)),value:`company`},{label:e(W(`bill_reimburse`)),value:`reimburse`}]})]}),(0,H.jsxs)(x,{gap:`sm`,align:`center`,children:[(0,H.jsx)(O,{variant:`solid`,children:e(W(`dist_submit`))}),(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`dist_footnote`))})]})]})})})}},Y={render:function(){let{t:e}=a(s),[t,n]=(0,V.useState)(16/9),[r,i]=(0,V.useState)(`#123f35`),[o,c]=(0,V.useState)(68),[l,u]=(0,V.useState)(`#f3ece1`),d=(()=>{let e=parseInt(r.slice(1),16),[t,n,i]=[e>>16&255,e>>8&255,e&255];return`rgba(${t}, ${n}, ${i}, ${o/100})`})();return(0,H.jsx)(E,{p:`2xl`,children:(0,H.jsxs)(f,{cols:{base:1,lg:`minmax(0, 1fr) minmax(0, 18rem)`},gap:`2xl`,children:[(0,H.jsxs)(D,{gap:`md`,children:[(0,H.jsxs)(D,{gap:`3xs`,children:[(0,H.jsx)(B,{tag:`h2`,size:`sm`,children:e(W(`style_title`))}),(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`style_hint`))})]}),(0,H.jsx)(L,{src:`./images/sample-landscape.png`,aspectRatio:t,applyLabel:e(W(`style_apply`))}),(0,H.jsxs)(D,{gap:`2xs`,children:[(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`style_preview_label`))}),(0,H.jsx)(E,{style:{backgroundImage:`url(./images/sample-landscape.png)`,backgroundSize:`cover`,backgroundPosition:`center`,aspectRatio:`16 / 5`,display:`flex`,alignItems:`flex-end`},children:(0,H.jsx)(E,{p:`lg`,style:{backgroundColor:d,width:`100%`},children:(0,H.jsx)(j,{size:`lg`,weight:`bold`,style:{color:l},children:e(W(`style_preview_headline`))})})})]})]}),(0,H.jsxs)(D,{gap:`xl`,children:[(0,H.jsx)(k,{label:e(W(`ratio_label`)),defaultValue:`wide`,size:`sm`,onChange:e=>n(e===`square`?1:e===`classic`?4/3:16/9),options:[{label:e(W(`ratio_wide`)),value:`wide`},{label:e(W(`ratio_classic`)),value:`classic`},{label:e(W(`ratio_square`)),value:`square`}]}),(0,H.jsxs)(D,{gap:`md`,children:[(0,H.jsx)(re,{label:e(W(`band_color_label`)),value:r,onChange:e=>i(e.target.value),fullWidth:!0}),(0,H.jsx)(I,{label:e(W(`band_opacity_label`)),min:0,max:100,step:4,value:o,onChange:c}),(0,H.jsx)(_,{label:e(W(`headline_color_label`)),value:l,onChange:e=>u(e.target.value),fullWidth:!0})]}),(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`style_contrast_note`))})]})]})})}},X={applied:{id:`root`,combinator:`and`,not:!1,rules:[{id:`a-1`,field:`years`,operator:`>=`,value:1},{id:`a-2`,field:`shift`,operator:`contains`,value:`early`}]},screening:{id:`root`,combinator:`and`,not:!1,rules:[{id:`s-1`,field:`years`,operator:`>=`,value:2},{id:`s-2`,field:`shift`,operator:`contains`,value:`early`},{id:`s-g1`,combinator:`or`,not:!1,rules:[{id:`s-3`,field:`commute`,operator:`<=`,value:45},{id:`s-4`,field:`licence`,operator:`=`,value:!0}]}]},interview:{id:`root`,combinator:`and`,not:!1,rules:[{id:`i-1`,field:`licence`,operator:`=`,value:!0},{id:`i-2`,field:`commute`,operator:`<=`,value:30}]}},Z={render:function(){let{t:e}=a(s),[t,n]=(0,V.useState)(`screening`),{matched:r,total:i}={applied:{matched:62,total:184},screening:{matched:27,total:41},interview:{matched:9,total:12}}[t];return(0,H.jsx)(E,{p:`2xl`,children:(0,H.jsxs)(D,{gap:`xl`,children:[(0,H.jsxs)(D,{gap:`3xs`,children:[(0,H.jsx)(B,{tag:`h2`,size:`sm`,children:e(W(`pool_title`))}),(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`pool_hint`))})]}),(0,H.jsxs)(f,{cols:{base:1,sm:`minmax(0, 22rem) auto`},gap:`md`,align:`end`,children:[(0,H.jsx)(y,{fullWidth:!0,placeholder:e(W(`pool_search_placeholder`))}),(0,H.jsx)(P,{value:t,onChange:n,options:[{label:e(W(`stage_applied`)),value:`applied`},{label:e(W(`stage_screening`)),value:`screening`},{label:e(W(`stage_interview`)),value:`interview`}],size:`sm`})]}),(0,H.jsx)(F,{fields:[{name:`applied_on`,label:e(W(`field_applied`)),type:`date`},{name:`years`,label:e(W(`field_years`)),type:`number`},{name:`shift`,label:e(W(`field_shift`)),type:`string`},{name:`commute`,label:e(W(`field_commute`)),type:`number`},{name:`licence`,label:e(W(`field_licence`)),type:`boolean`}],defaultQuery:X[t]},t),(0,H.jsxs)(f,{cols:{base:1,sm:`auto minmax(0, 20rem)`},gap:`md`,align:`center`,children:[(0,H.jsx)(j,{size:`sm`,color:`text-secondary`,children:e(W(`pool_count`),{matched:r,total:i})}),(0,H.jsxs)(x,{gap:`sm`,justify:`end`,children:[(0,H.jsx)(O,{size:`sm`,variant:`ghost`,children:e(W(`pool_export`))}),(0,H.jsx)(O,{size:`sm`,variant:`outline`,children:e(W(`pool_save`))})]})]})]})})}},Q={render:function(){let{t:e}=a(s);return(0,H.jsx)(E,{p:`2xl`,children:(0,H.jsxs)(D,{gap:`xl`,children:[(0,H.jsxs)(D,{gap:`3xs`,children:[(0,H.jsx)(B,{tag:`h2`,size:`sm`,children:e(W(`offer_title`))}),(0,H.jsx)(j,{size:`sm`,color:`text-secondary`,children:e(W(`offer_terms`))})]}),(0,H.jsx)(f,{cols:{base:`minmax(0, 1fr)`,sm:`20rem`},children:(0,H.jsx)(te,{label:e(W(`offer_sign_label`)),width:320,height:160,canvasAriaLabel:e(W(`offer_sign_aria`)),clearLabel:e(W(`offer_sign_clear`))})}),(0,H.jsx)(M,{defaultChecked:!1,children:e(W(`offer_confirm`))}),(0,H.jsxs)(x,{gap:`sm`,align:`center`,children:[(0,H.jsx)(O,{variant:`solid`,children:e(W(`offer_submit`))}),(0,H.jsx)(j,{size:`xs`,color:`text-tertiary`,children:e(W(`offer_footnote`))})]})]})})}},$=[`Default`,`Distribution`,`PageStyle`,`TalentPool`,`Offer`],q.parameters={...q.parameters,docs:{...q.parameters?.docs,source:{originalSource:`{
...
}`,...Q.parameters?.docs?.source},description:{story:`内定通知の返送。**主役は署名**なので、条件は上に短く置いて読ませる。`,...Q.parameters?.docs?.description}}}}))();export{q as Default,J as Distribution,Q as Offer,Y as PageStyle,Z as TalentPool,$ as __namedExportsOrder,U as default};