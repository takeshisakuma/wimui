import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as h}from"./iframe-DYlShzji.js";import{c as C}from"./index-Cm_IZiCA.js";import{I as L}from"./Icon-B_fKZ-SS.js";import{u as c}from"./useTranslation-DygSvNPf.js";const s=({iconName:o="CircleIcon",variant:t="default",shape:n="circle",size:i="medium",label:r,shrink:S=!1,position:j="bottom-right",description:b,badge:x,backTop:a=!1,visibilityHeight:N=400,className:T,style:k,onClick:q,"aria-label":B,...F})=>{const{t:I}=c(),[E,A]=h.useState(()=>a?typeof window<"u"?(window.pageYOffset||document.documentElement.scrollTop)>N:!1:!0),z=h.useCallback(()=>{if(a){const w=window.pageYOffset||document.documentElement.scrollTop;A(w>N)}},[a,N]);h.useEffect(()=>{if(a)return window.addEventListener("scroll",z),()=>window.removeEventListener("scroll",z)},[a,z]);const V=w=>{a&&window.scrollTo({top:0,behavior:"smooth"}),q?.(w)};return!E&&a?null:e.jsxs("button",{type:"button",className:C("wim-float-button",`wim-float-button--${t}`,`wim-float-button--${n}`,`wim-float-button--${i==="small"?"sm":i==="large"?"lg":"md"}`,`wim-float-button--${j}`,r&&"wim-float-button--extended",S&&"wim-float-button--shrink",T),style:k,onClick:V,title:b?I(b):void 0,"aria-label":B||(r?I(r):o),...F,children:[e.jsxs("span",{className:"wim-float-button__inner",children:[e.jsx(L,{name:a?"ChevronDownIcon":o,size:i,className:C(a&&"wim-float-button__icon--backtop")}),r&&e.jsx("span",{className:"wim-float-button__label-wrapper",children:e.jsx("span",{className:"wim-float-button__label",children:I(r)})}),x&&e.jsx("span",{className:C(x===!0?"wim-float-button__badge--dot":"wim-float-button__badge"),children:typeof x=="number"?x:""})]}),b&&e.jsx("span",{className:"wim-float-button__description",children:I(b)})]})};s.__docgenInfo={description:"",methods:[],displayName:"FloatButton",props:{iconName:{required:!1,tsType:{name:"union",raw:`| "CircleIcon"
| "SquareIcon"
| "LoadingIcon"
| "ExternalLinkIcon"
| "ArrowUpIcon"
