import{j as e}from"./jsx-runtime-u17CrQMm.js";import{S as a}from"./Stack--QzwSmXp.js";import{B as r}from"./Box-ztsL3uyR.js";const d={title:"Components/Layout/Stack",component:a,tags:[],argTypes:{direction:{control:"radio",options:["row","column"]},gap:{control:"select",options:["xs","sm","md","lg","xl",10,20,40]}}},o={args:{direction:"column",gap:"md",children:[e.jsx(r,{bg:"#eff6ff",p:20,radius:8,style:{border:"1px solid #3b82f6"},children:"Item 1"},"1"),e.jsx(r,{bg:"#f0fdf4",p:20,radius:8,style:{border:"1px solid #22c55e"},children:"Item 2"},"2"),e.jsx(r,{bg:"#fff7ed",p:20,radius:8,style:{border:"1px solid #f97316"},children:"Item 3"},"3")]}},s={args:{direction:"row",gap:"lg",children:[e.jsx(r,{bg:"#eff6ff",p:20,radius:8,style:{border:"1px solid #3b82f6"},children:"Item 1"},"1"),e.jsx(r,{bg:"#f0fdf4",p:20,radius:8,style:{border:"1px solid #22c55e"},children:"Item 2"},"2"),e.jsx(r,{bg:"#fff7ed",p:20,radius:8,style:{border:"1px solid #f97316"},children:"Item 3"},"3")]}},f={render:()=>e.jsxs(a,{gap:"xl",children:[e.jsx(r,{bg:"#f8fafc",p:10,children:"Gap: xl"}),e.jsxs(a,{direction:"row",gap:"xs",children:[e.jsx(r,{bg:"#eff6ff",p:10,children:"Gap: xs"}),e.jsx(r,{bg:"#eff6ff",p:10,children:"Gap: xs"}),e.jsx(r,{bg:"#eff6ff",p:10,children:"Gap: xs"})]}),e.jsxs(a,{direction:"row",gap:"lg",children:[e.jsx(r,{bg:"#f0fdf4",p:10,children:"Gap: lg"}),e.jsx(r,{bg:"#f0fdf4",p:10,children:"Gap: lg"}),e.jsx(r,{bg:"#f0fdf4",p:10,children:"Gap: lg"})]})]})};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
    direction: "column",
    gap: "md",
