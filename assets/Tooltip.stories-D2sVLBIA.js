...
}`,...y.parameters?.docs?.source}}};const R=["Default","Top","Bottom","Left","Right","WithDelay"],L=Object.freeze(Object.defineProperty({__proto__:null,Bottom:f,Default:g,Left:x,Right:v,Top:h,WithDelay:y,__namedExportsOrder:R,default:q},Symbol.toStringTag,{value:"Module"}));export{f as B,g as D,x as L,v as R,L as T,y as W,h as a};
