      ...
      padding: "80px 24px"
        ...
        <Container>
          ...
          md: "1fr 1fr"
            ...
            <Stack gap="3xl">
              <Stack gap="3xl">
                <Badge status="primary" content={t("hero.badge")} style={{
                width: "fit-content"
              }} />
                <Stack gap="2xl">
    ...
    return <Center style={{
      ...
      padding: "24px"
        ...
        textAlign: "center"
          ...
          <Alert status="info" title={t("error.help_title")} style={{
          textAlign: "left"
        }}>
            {t("error.help_desc")}
          </Alert>
