import{j as r}from"./jsx-runtime-u17CrQMm.js";import{r as p}from"./iframe-DaIVb5M8.js";import{B as c}from"./Button-C1qLIhqZ.js";class a extends p.Component{state={hasError:!1,error:null,errorInfo:null};static getDerivedStateFromError(e){return{hasError:!0,error:e}}componentDidCatch(e,o){this.setState({errorInfo:o}),this.props.onError?.(e,o),console.error("ErrorBoundary caught an error:",e,o)}reset=()=>{this.setState({hasError:!1,error:null,errorInfo:null}),this.props.onReset?.()};render(){const{hasError:e,error:o,errorInfo:i}=this.state,{children:d,fallback:l}=this.props;return e&&o?typeof l=="function"?l(o,i,this.reset):l||r.jsxs("div",{role:"alert",style:{padding:"20px",border:"1px solid red",borderRadius:"8px",background:"#fff5f5"},children:[r.jsx("h2",{style:{color:"red",marginTop:0},children:"Something went wrong."}),r.jsxs("details",{style:{whiteSpace:"pre-wrap",marginTop:"10px"},children:[o.toString(),r.jsx("br",{}),i?.componentStack]}),r.jsx("button",{onClick:this.reset,style:{marginTop:"15px",padding:"8px 16px",background:"red",color:"white",border:"none",borderRadius:"4px",cursor:"pointer"},children:"Try again"})]}):d}}a.__docgenInfo={description:`A standard React Error Boundary component that catches JavaScript errors \r
