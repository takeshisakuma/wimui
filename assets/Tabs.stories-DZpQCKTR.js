import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as d,R as j}from"./iframe-Dzm9idsv.js";import{c as w}from"./index-BpsP6pOz.js";import{u as P}from"./useIndicator-gPPASCdg.js";import{A as N}from"./i18nConstants-fBKvcUJT.js";import{u as M}from"./useTranslation-BfYXAya8.js";const D=d.createContext(null),R=()=>{const n=d.useContext(D);if(!n)throw new Error("Tabs components must be used within a Tabs");return n},k=({defaultValue:n,value:s,onValueChange:_,orientation:a="horizontal",className:c,children:r,...p})=>{const[g,T]=d.useState(n),[y,b]=d.useState([]),L=d.useId(),m=s!==void 0,u=m?s:g,S=d.useCallback(i=>{m||T(i),_?.(i)},[m,_]),V=d.useCallback(i=>{b(v=>v.includes(i)?v:[...v,i])},[]),A=d.useCallback(i=>{b(v=>v.filter(I=>I!==i))},[]);return e.jsx(D.Provider,{value:{value:u,onValueChange:S,orientation:a,id:L,items:y,registerItem:V,unregisterItem:A},children:e.jsx("div",{className:w("wim-tabs",`wim-tabs--${a}`,c),...p,children:r})})},$=({className:n,children:s,..._})=>{const{orientation:a,value:c,items:r,onValueChange:p}=R(),[g,T]=j.useState(!1),[y,b]=j.useState(0),[L,m]=j.useState(0),{containerRef:u,sliderStyle:S,isReady:V}=P({activeSelector:".wim-tabs__trigger--active",orientation:a,dependence:c}),A=o=>{a!=="vertical"&&(T(!0),b(o.pageX-(u.current?.offsetLeft||0)),m(u.current?.scrollLeft||0))},i=()=>{T(!1)},v=o=>{if(!g||a==="vertical")return;o.preventDefault();const l=(o.pageX-(u.current?.offsetLeft||0)-y)*1.5;u.current&&(u.current.scrollLeft=L-l)},I=o=>{const h=c?r.indexOf(c):-1;let l=-1;if(a==="horizontal"?(o.key==="ArrowRight"&&(l=(h+1)%r.length),o.key==="ArrowLeft"&&(l=(h-1+r.length)%r.length)):(o.key==="ArrowDown"&&(l=(h+1)%r.length),o.key==="ArrowUp"&&(l=(h-1+r.length)%r.length)),o.key==="Home"&&(l=0),o.key==="End"&&(l=r.length-1),l!==-1){o.preventDefault();const E=r[l];E&&(p(E),u.current?.querySelector(`[data-value="${E}"]`)?.focus())}};return e.jsxs("div",{ref:u,role:"tablist","aria-orientation":a,tabIndex:0,className:w("wim-tabs__list",g&&"wim-tabs__list--dragging",V&&"wim-tabs__list--ready",n),onMouseDown:A,onMouseUp:i,onMouseLeave:i,onMouseMove:v,onKeyDown:I,..._,children:[e.jsx("div",{className:"wim-tabs__slider",style:S,"aria-hidden":"true"}),s]})},q=({value:n,disabled:s=!1,className:_,children:a,...c})=>{const{value:r,onValueChange:p,id:g,registerItem:T,unregisterItem:y}=R(),b=r===n;return j.useEffect(()=>(T(n),()=>y(n)),[n,T,y]),e.jsx("button",{type:"button",role:"tab","aria-selected":b,"aria-controls":`wim-tabs-${g}-panel-${n}`,id:`wim-tabs-${g}-tab-${n}`,"data-value":n,disabled:s,tabIndex:b?0:-1,className:w("wim-tabs__trigger",b&&"wim-tabs__trigger--active",_),onClick:()=>p(n),...c,children:a})},z=({value:n,className:s,children:_,...a})=>{const{value:c,id:r}=R();return c===n?e.jsx("div",{role:"tabpanel",id:`wim-tabs-${r}-panel-${n}`,"aria-labelledby":`wim-tabs-${r}-tab-${n}`,tabIndex:0,className:w("wim-tabs__content",s),...a,children:_}):null},t=k;t.List=$;t.Trigger=q;t.Content=z;$.__docgenInfo={description:"",methods:[],displayName:"TabsList"};q.__docgenInfo={description:"",methods:[],displayName:"TabsTrigger",props:{value:{required:!0,tsType:{name:"string"},description:""},disabled:{defaultValue:{value:"false",computed:!1},required:!1}}};z.__docgenInfo={description:"",methods:[],displayName:"TabsContent",props:{value:{required:!0,tsType:{name:"string"},description:""}}};k.__docgenInfo={description:"",methods:[],displayName:"Tabs",props:{defaultValue:{required:!1,tsType:{name:"string"},description:""},value:{required:!1,tsType:{name:"string"},description:""},onValueChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},orientation:{required:!1,tsType:{name:"union",raw:'"horizontal" | "vertical"',elements:[{name:"literal",value:'"horizontal"'},{name:"literal",value:'"vertical"'}]},description:"",defaultValue:{value:'"horizontal"',computed:!1}}}};const O={title:"Components/Navigation Elements/Tabs",component:t},f={render:function(){const{t:s}=M(N);return e.jsxs(t,{defaultValue:"1",children:[e.jsxs(t.List,{children:[e.jsx(t.Trigger,{value:"1",children:s("story_tabs_gen_settings")}),e.jsx(t.Trigger,{value:"2",children:s("story_tabs_user_profile")}),e.jsx(t.Trigger,{value:"3",children:s("story_tabs_notif_center")}),e.jsx(t.Trigger,{value:"4",children:s("story_tabs_sec_privacy")}),e.jsx(t.Trigger,{value:"5",children:s("story_tabs_app_integ")})]}),e.jsx(t.Content,{value:"1",children:s("story_tabs_gen_desc")}),e.jsx(t.Content,{value:"2",children:s("story_tabs_user_desc")}),e.jsx(t.Content,{value:"3",children:s("story_tabs_notif_desc")}),e.jsx(t.Content,{value:"4",children:s("story_tabs_sec_desc")}),e.jsx(t.Content,{value:"5",children:s("story_tabs_app_desc")})]})}},C={render:function(){const{t:s}=M(N);return e.jsxs(t,{defaultValue:"1",orientation:"vertical",style:{minHeight:"200px"},children:[e.jsxs(t.List,{children:[e.jsx(t.Trigger,{value:"1",children:s("story_tabs_dash_v")}),e.jsx(t.Trigger,{value:"2",children:s("story_tabs_ana_v")}),e.jsx(t.Trigger,{value:"3",children:s("story_tabs_sys_logs")}),e.jsx(t.Trigger,{value:"4",children:s("story_tabs_help_doc")})]}),e.jsxs(t.Content,{value:"1",children:[e.jsx("h3",{style:{marginTop:0},children:s("story_tabs_dash_title")}),e.jsx("p",{children:s("story_tabs_dash_desc")})]}),e.jsx(t.Content,{value:"2",children:s("story_tabs_ana_desc")}),e.jsx(t.Content,{value:"3",children:s("story_tabs_sys_desc")}),e.jsx(t.Content,{value:"4",children:s("story_tabs_help_desc")})]})}},x={render:function(){const{t:s}=M(N);return e.jsxs(t,{defaultValue:"1",style:{width:"800px"},children:[e.jsxs(t.List,{children:[e.jsxs(t.Trigger,{value:"1",children:[s("story_tabs_long_tab")," 1"]}),e.jsxs(t.Trigger,{value:"2",children:[s("story_tabs_long_tab")," 2"]}),e.jsxs(t.Trigger,{value:"3",children:[s("story_tabs_long_tab")," 3"]}),e.jsxs(t.Trigger,{value:"4",children:[s("story_tabs_long_tab")," 4"]}),e.jsxs(t.Trigger,{value:"5",children:[s("story_tabs_long_tab")," 5"]})]}),e.jsx(t.Content,{value:"1",children:"Content 1"}),e.jsx(t.Content,{value:"2",children:"Content 2"}),e.jsx(t.Content,{value:"3",children:"Content 3"}),e.jsx(t.Content,{value:"4",children:"Content 4"}),e.jsx(t.Content,{value:"5",children:"Content 5"})]})}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
...
}`,...x.parameters?.docs?.source}}};const X=["Default","Vertical","Scrolling"],Q=Object.freeze(Object.defineProperty({__proto__:null,Default:f,Scrolling:x,Vertical:C,__namedExportsOrder:X,default:O},Symbol.toStringTag,{value:"Module"}));export{f as D,x as S,Q as T,C as V};
