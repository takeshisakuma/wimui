import{j as n}from"./jsx-runtime-u17CrQMm.js";import{c as o}from"./index-CGUrc0iP.js";import{C as d}from"./Card-mnsu_YpS.js";const s=({variant:e="elevated",className:a,children:t,...i})=>n.jsx(d,{variant:e,className:o("wim-stats",a),padding:"none",...i,children:n.jsx("div",{className:"wim-stats__inner",children:t})}),l=({className:e,children:a,...t})=>n.jsx("div",{className:o("wim-stats__label",e),...t,children:a}),r=({className:e,children:a,...t})=>n.jsx("div",{className:o("wim-stats__value",e),...t,children:a}),m=({className:e,children:a,...t})=>n.jsx("div",{className:o("wim-stats__description",e),...t,children:a}),p=({direction:e="up",className:a,children:t,...i})=>n.jsxs("div",{className:o("wim-stats__trend",`wim-stats__trend--${e}`,a),...i,children:[n.jsxs("span",{className:"wim-stats__trend-icon",children:[e==="up"&&"↑",e==="down"&&"↓",e==="neutral"&&"→"]}),n.jsx("span",{className:"wim-stats__trend-value",children:t})]});s.displayName="Stats";l.displayName="Stats.Label";r.displayName="Stats.Value";m.displayName="Stats.Description";p.displayName="Stats.Trend";s.Label=l;s.Value=r;s.Description=m;s.Trend=p;s.__docgenInfo={description:"`Stats` は統計情報やメトリクスを表示するためのコンポーネントです。",methods:[{name:"Label",docblock:null,modifiers:["static"],params:[{name:`{
  className,
  children,
  ...props
