import{j as s}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as i}from"./index-ASF-mazP.js";import{M as l,C as r,a as h}from"./index-B25bep_z.js";import{C as c,B as x,M as j,R as t,A as o,N as a,W as p,a as u}from"./Carousel.stories-CzJsWapH.js";import{T as m}from"./T-Dv52hiQU.js";import"./iframe-DLp3Jz1D.js";import"./preload-helper-PPVm8Dsz.js";import"./index-BSdy6QgF.js";import"./index-DBODvmcM.js";import"./index-CSblWT8I.js";import"./index-B17ZCLRR.js";import"./index-CW_-86og.js";import"./index-DUAuVduf.js";import"./Icon-DfmmhfZE.js";import"./imagesanple-VDI2Kzk_.js";import"./useTranslation-BDUJJ6MV.js";function e(d){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...d.components};return s.jsxs(s.Fragment,{children:[s.jsx(l,{of:c}),`
...
`,s.jsxs(n.p,{children:["Carousel（カルーセル）は、複数のコンテンツをスライドさせて表示するためのコンポーネント",s.jsx("br",{}),`
...
`,s.jsx(n.pre,{children:s.jsx(n.code,{className:"language-tsx",children:`<Carousel
  slidesToShow={{
    base: 1, // スマホ
    sm: 2, // タブレット
    md: 3, // PC
...
`,s.jsxs(n.p,{children:[s.jsx(n.code,{children:"aspectRatio"})," を指定することで、画像の高さを統一し、アスペクト比を維持したまま切り抜いて表示（",s.jsx(n.code,{children:'objectFit="cover"'}),`）させることができます。
...
`,s.jsx(n.p,{children:`カルーセルUI (Carousel UI) は、限られたスペースで複数の画像やコンテンツをスライドショーのように切り替えて表示する手法です。
...
`,s.jsxs("table",{children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{children:"要件"}),s.jsx("th",{children:"詳細"})]})}),s.jsxs("tbody",{children:[s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"移動ボタン"})}),s.jsx("td",{children:"左右の矢印ボタンやスワイプ操作で前後に移動できること。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"タッチ操作（スワイプ）"})}),s.jsx("td",{children:s.jsx(n.p,{children:"モバイル環境では、「横にスワイプしてスライドさせる」直感的なタッチドラッグ操作に対応しています。一方で、PC（マウス操作）環境では、無意識な画像・テキストのブラウザ標準選択（ドラッグ保存など）を防ぐため、敢えてマウスドラッグによるスライド操作は実装せず、矢印ボタンやインジケーターのみでの操作としています。"})})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"インジケーター"})}),s.jsx("td",{children:s.jsx(n.p,{children:"現在位置を示し、特定のスライドへ直接ジャンプできること（ドットなど）。"})})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"自動回転の制御"})}),s.jsx("td",{children:"ユーザーが操作中は一時停止する、または停止ボタンを提供する。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"ループ機能"})}),s.jsx("td",{children:"最後のスライドから最初に戻るシームレスなループ。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"キーボード操作"})}),s.jsx("td",{children:"矢印キーで移動できるなど、アクセシビリティへの配慮。"})]})]})]}),`
`,s.jsx(n.h2,{id:"実装採用時のポイント",children:"実装・採用時のポイント"}),`
`,s.jsxs("table",{children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{children:"ポイント"}),s.jsx("th",{children:"詳細"})]})}),s.jsxs("tbody",{children:[s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"コンテンツの吟味"})}),s.jsx("td",{children:s.jsx(n.p,{children:"テーマを統一し、スライド枚数は3〜5枚程度に抑える。重要な情報は1枚目に。"})})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"レスポンシブ対応"})}),s.jsx("td",{children:"PCでは複数カラム、SPでは1カラムなど、デバイスに応じた表示。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"直感的な操作性"})}),s.jsx("td",{children:s.jsx(n.p,{children:"「スワイプできそう」「クリックできそう」な視覚的アフォーダンスを提供する。"})})]})]})]})]})}function D(d={}){const{wrapper:n}={...i(),...d.components};return n?s.jsx(n,{...d,children:s.jsx(e,{...d})}):e(d)}export{D as default};
