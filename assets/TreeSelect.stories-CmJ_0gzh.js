import{j as s}from"./jsx-runtime-u17CrQMm.js";import{r as l}from"./iframe-BIyQwIaN.js";import{c as j}from"./index-6KFIEf95.js";import{T as de}from"./Transition-CCD-P_Hz.js";import{T as ue}from"./TreeView-DGoI0nF0.js";import{I as pe}from"./InputBase-CGzG77Kv.js";import{F as me}from"./FieldTemplate-D-5Jhqy1.js";import{u as p}from"./useTranslation-C6_B5Ynz.js";import{I as L}from"./Icon-BQyMRfQe.js";function $(t,a){return t.map(r=>({value:r.value,label:a(r.label),disabled:r.disabled,icon:r.icon,children:r.children?$(r.children,a):void 0}))}const u=({treeData:t=[],value:a,onChange:r,placeholder:C="Select",label:k,error:w,required:F,layout:P,className:B,disabled:i=!1,multiple:o=!1,searchable:W=!1,defaultExpandedKeys:G=[],allowClear:H=!1,checkStrategy:J="cascade",id:Q,...U})=>{const{t:f}=p("common"),X=l.useId(),S=Q||`wim-tree-select-${X}`,A=k?`${S}-label`:void 0,R=w?`${S}-error`:void 0,Y=`${S}-trigger`,K=`${S}-dropdown`,[c,y]=l.useState(!1),[Z,M]=l.useState(o?[]:""),_=l.useRef(null),V=l.useRef(null),I=a!==void 0,d=I?a:Z;l.useEffect(()=>{const e=n=>{_.current&&!_.current.contains(n.target)&&y(!1)};return document.addEventListener("mousedown",e),()=>document.removeEventListener("mousedown",e)},[]),l.useEffect(()=>{if(c){const e=setTimeout(()=>{_.current?.querySelector(".wim-tree-view")?.focus()},100);return()=>clearTimeout(e)}},[c]);const ee=()=>{if(!i){const e=!c;y(e),e||V.current?.focus()}},re=e=>{if(!i){if(!c){(e.key==="Enter"||e.key===" "||e.key==="ArrowDown")&&(e.preventDefault(),y(!0));return}e.key==="Escape"?(e.preventDefault(),y(!1),V.current?.focus()):e.key==="Tab"&&y(!1)}},q=l.useMemo(()=>{const e={},n=ie=>{ie.forEach(E=>{e[E.value]=E,E.children&&n(E.children)})};return n(t),e},[t]),ae=()=>{if(o){const e=Array.isArray(d)?d:[];return e.length===0?null:e.map(n=>q[n]?f(q[n].label):n).join(", ")}else{const e=d;return e?q[e]?f(q[e].label):e:null}},O=e=>{let n;o?n=e:(n=e[0]||"",y(!1)),I||M(n),r&&r(n)},te=()=>{if(i)return;const e=o?[]:"";I||M(e),r&&r(e)},se=l.useMemo(()=>$(t,f),[t,f]),z=l.useMemo(()=>o?Array.isArray(d)?d:[]:d?[d]:[],[d,o]),N=ae(),{"aria-label":ne,"aria-labelledby":le,"aria-describedby":oe,...ce}=U;return s.jsx(me,{label:k,error:w,required:F,layout:P,labelId:A,errorId:R,className:j("wim-tree-select-container",B),children:s.jsxs("div",{className:"wim-tree-select",ref:_,...ce,children:[s.jsx(pe,{disabled:i,allowClear:H,hasValue:!!N,onClear:te,status:w?"error":"default",rightIcons:[{name:"ChevronDownIcon",rotated:c}],className:j(c&&"wim-tree-select__trigger--open"),children:s.jsx("div",{id:Y,className:j("wim-tree-select__trigger",i&&"wim-tree-select__trigger--disabled"),onClick:ee,onKeyDown:re,tabIndex:i?-1:0,role:"combobox","aria-expanded":c,"aria-haspopup":"tree","aria-controls":c?K:void 0,"aria-disabled":i,"aria-labelledby":A||le,"aria-label":k?void 0:ne||f(C),"aria-describedby":R||oe,"aria-invalid":!!w,ref:V,children:s.jsx("div",{className:j("wim-tree-select__value",!N&&"wim-tree-select__value--placeholder"),children:N||f(C)})})}),s.jsx(de,{show:c&&!i,enter:"fade-enter",enterFrom:"fade-enter-from",enterTo:"fade-enter-to",leave:"fade-leave",leaveFrom:"fade-leave-from",leaveTo:"fade-leave-to",className:"wim-tree-select__dropdown",children:s.jsx("div",{id:K,children:s.jsx(ue,{multiSelect:o,defaultSelectedValues:z,defaultCheckedValues:o?z:[],nodes:se,onCheckedChange:O,onSelectedChange:O,checkable:o,checkStrategy:J,searchable:W,defaultExpandedValues:G})})})]})})};u.__docgenInfo={description:"ツリー形式の選択肢から1つまたは複数を選択するためのコンポーネント。",methods:[],displayName:"TreeSelect",props:{treeData:{required:!1,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  value: string;
...
- exclusive: 親子排他（親選択→子解除、子選択→親解除）`,defaultValue:{value:'"cascade"',computed:!1}},id:{required:!1,tsType:{name:"string"},description:""},"aria-label":{required:!1,tsType:{name:"string"},description:""},"aria-labelledby":{required:!1,tsType:{name:"string"},description:""},"aria-describedby":{required:!1,tsType:{name:"string"},description:""}}};const fe={title:"Components/Advanced Inputs/TreeSelect",component:u},v=[{label:"story.treeselect_design",value:"design",icon:s.jsx(L,{name:"EditIcon",size:"sm"}),children:[{label:"story.treeselect_colors",value:"colors",children:[{label:"story.treeselect_primary",value:"primary"},{label:"story.treeselect_secondary",value:"secondary"}]},{label:"story.treeselect_typography",value:"typography"}]},{label:"story.treeselect_components",value:"components",icon:s.jsx(L,{name:"ProjectIcon",size:"sm"}),children:[{label:"story.treeselect_button",value:"button"},{label:"story.treeselect_input",value:"input"}]}],m=(t,a)=>t.map(r=>({...r,label:a(r.label),children:r.children?m(r.children,a):void 0})),T={render:t=>{const{t:a}=p("docs"),r=m(v,a);return s.jsx(u,{...t,treeData:r,placeholder:a("story.treeselect_placeholder")})}},g={render:t=>{const{t:a}=p("docs"),r=m(v,a);return s.jsx(u,{...t,treeData:r,multiple:!0,checkStrategy:"cascade",defaultExpandedKeys:["design"],placeholder:a("story.treeselect_placeholder")})}},h={render:t=>{const{t:a}=p("docs"),r=m(v,a);return s.jsx(u,{...t,treeData:r,multiple:!0,checkStrategy:"exclusive",defaultExpandedKeys:["design"],placeholder:a("story.treeselect_placeholder")})}},b={render:t=>{const{t:a}=p("docs"),r=m(v,a);return s.jsx(u,{...t,treeData:r,searchable:!0,placeholder:a("story.treeselect_placeholder")})}},D={render:t=>{const{t:a}=p("docs"),r=m(v,a);return s.jsx(u,{...t,treeData:r,defaultExpandedKeys:["design","colors"],placeholder:a("story.treeselect_placeholder")})}},x={render:t=>{const{t:a}=p("docs"),r=m(v,a);return s.jsx(u,{...t,treeData:r,disabled:!0,placeholder:a("story.treeselect_placeholder")})}};T.parameters={...T.parameters,docs:{...T.parameters?.docs,source:{originalSource:`{
  render: (args: any) => {
    const {
      t
    } = useTranslation("docs");
...
}`,...x.parameters?.docs?.source}}};const ye=["Default","CascadeMultiple","ExclusiveMultiple","Searchable","DefaultExpanded","Disabled"],_e=Object.freeze(Object.defineProperty({__proto__:null,CascadeMultiple:g,Default:T,DefaultExpanded:D,Disabled:x,ExclusiveMultiple:h,Searchable:b,__namedExportsOrder:ye,default:fe},Symbol.toStringTag,{value:"Module"}));export{g as C,T as D,h as E,b as S,_e as T,D as a,x as b};
