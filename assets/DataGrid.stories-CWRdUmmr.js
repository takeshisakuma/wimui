      ...
      render: (_: unknown, row: Record<string, unknown>) => <div style={{
        ...
        gap: "8px"
          ...
          name: row.name
            ...
            {}
            <Button size="small" priority="tertiary" intent="destructive" onClick={() => alert(t("story_datagrid_action_delete", {
          name: row.name
        }))}>
