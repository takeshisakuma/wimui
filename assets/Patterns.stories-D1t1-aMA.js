import{j as e}from"./jsx-runtime-u17CrQMm.js";import{I as c}from"./Input-FHRf1Lv7.js";import{B as a}from"./Button-BcXfR-le.js";import{C as p}from"./Card-BPYpyAPg.js";import{C as W}from"./Checkbox-BgKHdPCJ.js";import{L as d}from"./Link-CGVFsbey.js";import{H as i}from"./Heading-DeRA2hsS.js";import{S as t}from"./Stack-BElb26_m.js";import{C as H}from"./Center-C1nHgGVQ.js";import{C}from"./Container-CDuTC_mm.js";import{H as I}from"./Header-CbQtFMhR.js";import{A}from"./Avatar-ecppgq_4.js";import{A as P}from"./AvatarGroup-Dzd0NrMw.js";import{B as L}from"./Badge-LkfCcImR.js";import{D as f}from"./Divider-lKDi9efD.js";import{S as N}from"./Selectbox-agD6q7Pp.js";import{R}from"./RadioGroup-Bjx_SDab.js";import{T as D}from"./Textarea-D9axOHkF.js";import{S as B}from"./Switch-T9xakGc2.js";import{G as _}from"./Grid-DwAawUdx.js";import{P as r}from"./Paragraph-CPi7H-r6.js";import{A as E}from"./Alert-Du2R_Opq.js";import{I as G}from"./Icon-DiBq7mcg.js";import{L as o}from"./FieldTemplate-KgnmoKAJ.js";import{S as k}from"./Stats-BqGtCDVB.js";import{L as z,a as l}from"./List-TFAumGqc.js";import{S as w}from"./Sidebar-C8MeSmu5.js";import{S as m}from"./Skeleton-DFlmRna4.js";import{G as T}from"./Group-zFN4KPdV.js";import{A as g}from"./iframe-DhloUwSC.js";import{u as h}from"./useTranslation-D-X6QKZu.js";const F={title:"Patterns/Recipes",parameters:{layout:"fullscreen"}},y={render:function(){const{t:n}=h(g);return e.jsx(H,{style:{height:"100vh",backgroundColor:"var(--wim-color-surface)"},children:e.jsx(p,{style:{width:"400px",padding:"32px",border:"1px solid",borderColor:"var(--wim-color-border-secondary)"},children:e.jsxs(t,{gap:"xl",children:[e.jsxs(t,{align:"center",gap:"md",children:[e.jsx(i,{tag:"h2",size:"xl",align:"center",style:{lineHeight:1},children:n("login.title")}),e.jsx(r,{content:n("login.subtitle"),color:"deepgray",size:"sm"})]}),e.jsx("form",{onSubmit:s=>s.preventDefault(),children:e.jsxs(t,{gap:"lg",children:[e.jsx(o,{label:n("login.email"),htmlFor:"login-email",children:e.jsx(c,{id:"login-email",placeholder:n("login.email_placeholder"),fullWidth:!0})}),e.jsx(o,{label:n("login.password"),htmlFor:"login-password",children:e.jsx(c,{id:"login-password",type:"password",placeholder:"••••••••",fullWidth:!0})}),e.jsxs(t,{direction:"column",gap:"sm",align:"start",children:[e.jsxs("label",{htmlFor:"remember-me",style:{display:"flex",alignItems:"center",gap:"8px",fontSize:"0.875rem",cursor:"pointer",color:"var(--wim-color-text-secondary)"},children:[e.jsx(W,{id:"remember-me"}),n("login.remember_me")]}),e.jsx(d,{href:"#",style:{fontSize:"0.875rem"},children:n("login.forgot_password")})]}),e.jsxs(t,{gap:"sm",children:[e.jsx(a,{variant:"filled",style:{width:"100%"},children:n("login.sign_in")}),e.jsx(a,{variant:"outline",style:{width:"100%"},onClick:()=>{},children:n("login.sign_in_google")})]})]})}),e.jsxs(t,{direction:"row",justify:"center",gap:"2xs",children:[e.jsx(r,{content:n("login.no_account"),size:"sm",color:"gray"}),e.jsx(d,{href:"#",style:{fontSize:"0.875rem"},children:n("login.sign_up")})]})]})})})}},u={render:function(){const{t:n}=h(g);return e.jsxs("div",{style:{minHeight:"400px",backgroundColor:"var(--wim-color-surface)"},children:[e.jsx("style",{children:`
              ...
              `}),e.jsxs(I,{bordered:!0,sticky:!0,background:"primary",style:{padding:"0 24px"},children:[e.jsxs(I.Section,{align:"start",style:{gap:"16px",flex:1,overflow:"hidden"},children:[e.jsx("button",{"aria-label":"Toggle Menu",className:"mobile-only",style:{background:"none",border:"none",fontSize:"20px",cursor:"pointer",padding:"8px"},children:"☰"}),e.jsxs(t,{direction:"row",align:"center",gap:"sm",style:{flexShrink:0},children:[e.jsx("div",{style:{width:"32px",height:"32px",backgroundColor:"var(--wim-color-primary)",borderRadius:"6px",display:"flex",alignItems:"center",justifyContent:"center",color:"var(--wim-color-text-on-primary)",fontWeight:"bold"},children:"W"}),e.jsx("span",{style:{fontSize:"0.9rem",fontWeight:"bold",color:"var(--wim-color-text-primary)"},children:"WIM UI"})]}),e.jsxs(t,{as:"nav",direction:"row",gap:"lg",className:"desktop-only",style:{marginLeft:"32px"},children:[e.jsx(d,{href:"#",priority:"secondary",style:{color:"inherit",textDecoration:"none"},children:n("dashboard.header_dashboard")}),e.jsx(d,{href:"#",priority:"secondary",style:{color:"inherit",textDecoration:"none"},children:n("dashboard.header_projects")}),e.jsx(d,{href:"#",priority:"secondary",style:{color:"inherit",textDecoration:"none"},children:n("dashboard.header_team")}),e.jsx(d,{href:"#",priority:"secondary",style:{color:"inherit",textDecoration:"none"},children:n("dashboard.header_settings")})]})]}),e.jsxs(I.Section,{align:"end",style:{gap:"16px",flexShrink:0},children:[e.jsx("div",{className:"header-search",children:e.jsx(c,{placeholder:n("dashboard.header_search_placeholder"),fullWidth:!0,leftIcon:"SearchIcon"})}),e.jsx(f,{orientation:"vertical",style:{height:"24px"}}),e.jsxs("div",{style:{position:"relative",cursor:"pointer",display:"flex",alignItems:"center"},children:[e.jsx(G,{name:"BellIcon",size:"md",color:"secondary","aria-label":"Notifications"}),e.jsx(L,{intent:"secondary",size:"sm",content:"3",style:{position:"absolute",top:"-4px",right:"-4px",minWidth:"16px",height:"16px",padding:0}})]}),e.jsxs(t,{direction:"row",align:"center",gap:"sm",style:{cursor:"pointer"},children:[e.jsx(A,{size:"md"}),e.jsxs(t,{gap:"none",className:"desktop-only",children:[e.jsx("span",{style:{fontSize:"0.875rem",fontWeight:600,color:"var(--wim-color-text-primary)"},children:"John Doe"}),e.jsx("span",{style:{fontSize:"0.75rem",color:"var(--wim-color-text-secondary)"},children:n("dashboard.header_admin")})]})]})]})]}),e.jsx(C,{style:{padding:"32px"},children:e.jsxs(t,{gap:"xl",children:[e.jsx(i,{tag:"h2",size:"xl",children:n("dashboard.overview_title")}),e.jsx(_,{cols:"repeat(auto-fit, minmax(280px, 1fr))",gap:24,justify:"center",children:[1,2,3].map(s=>e.jsxs(k,{style:{border:"1px solid",borderColor:"var(--wim-color-border-secondary)"},children:[e.jsxs(t,{justify:"space-between",align:"center",direction:"row",children:[e.jsx(k.Label,{children:n("dashboard.stats_revenue")}),e.jsx(L,{intent:"neutral",content:"+12.5%",size:"sm"})]}),e.jsx(k.Value,{children:e.jsx(i,{tag:"h3",size:"xl",style:{whiteSpace:"nowrap"},children:"$45,231.89"})}),e.jsx(k.Description,{children:n("dashboard.stats_last_month")})]},s))})]})})]})}},b={render:function(){const{t:n}=h(g);return e.jsx(H,{style:{backgroundColor:"var(--wim-color-surface)",padding:"20px"},children:e.jsxs(p,{style:{maxWidth:"1000px",width:"100%",padding:"0",overflow:"hidden",border:"1px solid",borderColor:"var(--wim-color-border-secondary)"},children:[e.jsxs("div",{style:{padding:"24px",borderBottom:"1px solid var(--wim-color-border-secondary)"},children:[e.jsx(i,{tag:"h2",size:"lg",children:n("profile.title")}),e.jsx(r,{content:n("profile.subtitle"),color:"deepgray",style:{marginTop:"4px"}})]}),e.jsxs(_,{cols:{base:1,md:"250px 1fr"},gap:0,style:{minHeight:"600px"},children:[e.jsx("div",{style:{borderRight:"1px solid var(--wim-color-border-secondary)",backgroundColor:"var(--wim-color-surface)"},children:e.jsx("div",{style:{padding:"24px"},children:e.jsxs(t,{gap:"sm",align:"stretch",children:[e.jsx(w.Item,{active:!0,children:n("profile.nav_general")}),e.jsx(w.Item,{children:n("profile.nav_security")}),e.jsx(w.Item,{children:n("profile.nav_notifications")}),e.jsx(w.Item,{children:n("profile.nav_billing")})]})})}),e.jsx("div",{style:{padding:"32px",overflowX:"hidden"},children:e.jsx("form",{onSubmit:s=>s.preventDefault(),children:e.jsxs(t,{gap:"xl",children:[e.jsxs("div",{style:{display:"flex",alignItems:"center",gap:"24px",flexWrap:"wrap"},children:[e.jsx(A,{size:"lg",style:{width:"80px",height:"80px",fontSize:"2rem"}}),e.jsxs(t,{gap:"xs",children:[e.jsx(i,{tag:"h3",size:"sm",children:n("profile.pic_title")}),e.jsxs("div",{style:{display:"flex",gap:"12px"},children:[e.jsx(a,{size:"sm",variant:"outline",children:n("profile.btn_change")}),e.jsx(a,{size:"sm",variant:"ghost",children:n("profile.btn_remove")})]})]})]}),e.jsx(f,{}),e.jsxs(t,{gap:"2xl",children:[e.jsx(i,{tag:"h3",size:"md",children:n("profile.info_title")}),e.jsxs(t,{gap:"lg",children:[e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))",gap:"24px"},children:[e.jsx(o,{label:n("profile.first_name"),htmlFor:"profile-first-name",children:e.jsx(c,{id:"profile-first-name",defaultValue:"John",fullWidth:!0})}),e.jsx(o,{label:n("profile.last_name"),htmlFor:"profile-last-name",children:e.jsx(c,{id:"profile-last-name",defaultValue:"Doe",fullWidth:!0})})]}),e.jsx(o,{label:n("profile.email"),htmlFor:"profile-email",children:e.jsx(c,{id:"profile-email",type:"email",defaultValue:"john.doe@example.com",fullWidth:!0})}),e.jsxs(o,{label:n("profile.bio"),htmlFor:"profile-bio",children:[e.jsx(D,{id:"profile-bio",placeholder:n("profile.bio_placeholder"),rows:4,fullWidth:!0,defaultValue:"I am a software engineer based in Tokyo."}),e.jsx(r,{content:n("profile.bio_char_count"),size:"xs",color:"gray",style:{textAlign:"right"}})]})]})]}),e.jsx(f,{}),e.jsxs(t,{gap:"2xl",children:[e.jsx(i,{tag:"h3",size:"md",children:n("profile.reg_title")}),e.jsxs("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit, minmax(200px, 1fr))",gap:"24px"},children:[e.jsx(N,{label:n("profile.lang_label"),options:[{label:n("profile.lang_en"),value:"en"},{label:n("profile.lang_ja"),value:"ja"},{label:n("profile.lang_es"),value:"es"}],defaultValue:"en"}),e.jsx(N,{label:n("profile.tz_label"),options:[{label:"UTC",value:"utc"},{label:"JST (Japan Standard Time)",value:"jst"},{label:"EST (Eastern Standard Time)",value:"est"}],defaultValue:"jst"})]})]}),e.jsx(f,{}),e.jsxs(t,{gap:"2xl",children:[e.jsx(i,{tag:"h3",size:"md",children:n("profile.pref_title")}),e.jsxs(t,{gap:"lg",children:[e.jsx(o,{label:n("profile.visibility"),children:e.jsx(R,{name:"visibility",defaultValue:"public",options:[{label:n("profile.visibility_public"),value:"public"},{label:n("profile.visibility_private"),value:"private"},{label:n("profile.visibility_friends"),value:"friends"}]})}),e.jsx(o,{label:n("profile.notif_label"),children:e.jsxs(t,{gap:"sm",children:[e.jsx(B,{defaultChecked:!0,children:n("profile.notif_email")}),e.jsx(B,{children:n("profile.notif_push")})]})})]})]}),e.jsx(f,{}),e.jsxs(T,{justify:"end",gap:"md",children:[e.jsx(a,{variant:"ghost",children:n("profile.btn_cancel")}),e.jsx(a,{variant:"filled",children:n("profile.btn_save")})]})]})})})]})]})})}},v={render:function(){const{t:n}=h(g);return e.jsxs(C,{style:{padding:"80px 24px",background:"#fff"},children:[e.jsxs(t,{align:"center",gap:"3xl",style:{marginBottom:"64px"},children:[e.jsx(i,{tag:"h2",size:"xl",align:"center",children:n("pricing.title")}),e.jsx(C,{size:"sm",children:e.jsx(r,{content:n("pricing.subtitle"),color:"deepgray",style:{textAlign:"center"}})})]}),e.jsxs(_,{cols:{base:1,md:3},gap:{base:32,lg:48,xl:64},style:{maxWidth:"1100px",margin:"0 auto"},children:[e.jsx(p,{style:{padding:"32px",border:"2px solid",borderColor:"var(--wim-color-border-secondary)"},children:e.jsxs(t,{gap:"lg",style:{height:"100%"},children:[e.jsxs(t,{gap:"lg",align:"center",style:{flex:1},children:[e.jsxs(t,{gap:"xs",align:"center",children:[e.jsx("div",{style:{minHeight:"48px",display:"flex",alignItems:"flex-start",justifyContent:"center"},children:e.jsx(i,{tag:"h3",size:"sm",align:"center",style:{margin:0},children:n("pricing.starter_title")})}),e.jsxs("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"center",whiteSpace:"nowrap"},children:[e.jsx(i,{tag:"h4",size:"2xl",style:{margin:0},children:"$0"}),e.jsx(r,{content:n("pricing.period"),color:"gray",size:"sm",style:{marginLeft:"2px"}})]})]}),e.jsx("div",{style:{minHeight:"40px",display:"flex",alignItems:"center"},children:e.jsx(r,{content:n("pricing.starter_desc"),size:"sm",color:"deepgray",style:{textAlign:"center",margin:0}})}),e.jsxs(z,{spacing:"normal",style:{marginTop:"24px",alignSelf:"stretch"},children:[e.jsx(l,{iconName:"CheckIcon",children:n("pricing.starter_feat_1")}),e.jsx(l,{iconName:"CheckIcon",children:n("pricing.starter_feat_2")}),e.jsx(l,{iconName:"CheckIcon",children:n("pricing.starter_feat_3")}),e.jsx(l,{iconName:"CheckIcon",className:"wim-color-gray",style:{opacity:.5},children:n("pricing.starter_feat_4")})]})]}),e.jsx(a,{variant:"outline",style:{width:"100%"},children:n("pricing.starter_btn")})]})}),e.jsx(p,{style:{padding:"32px",border:"2px solid #3b82f6",position:"relative"},children:e.jsxs(t,{gap:"lg",style:{height:"100%"},children:[e.jsxs(t,{gap:"lg",align:"center",style:{flex:1},children:[e.jsxs(t,{gap:"xs",align:"center",children:[e.jsx("div",{style:{minHeight:"48px",display:"flex",alignItems:"flex-start",justifyContent:"center"},children:e.jsx(i,{tag:"h3",size:"sm",align:"center",style:{margin:0},children:n("pricing.pro_title")})}),e.jsxs("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"center",whiteSpace:"nowrap"},children:[e.jsx(i,{tag:"h4",size:"2xl",style:{margin:0},children:"$29"}),e.jsx(r,{content:n("pricing.period"),color:"gray",size:"sm",style:{marginLeft:"2px"}})]})]}),e.jsx("div",{style:{minHeight:"40px",display:"flex",alignItems:"center"},children:e.jsx(r,{content:n("pricing.pro_desc"),size:"sm",color:"deepgray",style:{textAlign:"center",margin:0}})}),e.jsxs(z,{spacing:"normal",style:{marginTop:"24px",alignSelf:"stretch"},children:[e.jsx(l,{iconName:"CheckIcon",children:n("pricing.pro_feat_1")}),e.jsx(l,{iconName:"CheckIcon",children:n("pricing.pro_feat_2")}),e.jsx(l,{iconName:"CheckIcon",children:n("pricing.pro_feat_3")}),e.jsx(l,{iconName:"CheckIcon",children:n("pricing.pro_feat_4")})]})]}),e.jsx(a,{variant:"filled",style:{width:"100%"},children:n("pricing.pro_btn")})]})}),e.jsx(p,{style:{padding:"32px",border:"2px solid",borderColor:"var(--wim-color-border-secondary)"},children:e.jsxs(t,{gap:"lg",style:{height:"100%"},children:[e.jsxs(t,{gap:"lg",align:"center",style:{flex:1},children:[e.jsxs(t,{gap:"xs",align:"center",children:[e.jsx("div",{style:{minHeight:"48px",display:"flex",alignItems:"flex-start",justifyContent:"center"},children:e.jsx(i,{tag:"h3",size:"sm",align:"center",style:{margin:0},children:n("pricing.ent_title")})}),e.jsxs("div",{style:{display:"flex",alignItems:"baseline",justifyContent:"center",whiteSpace:"nowrap"},children:[e.jsx(i,{tag:"h4",size:"2xl",style:{margin:0},children:"$99"}),e.jsx(r,{content:n("pricing.period"),color:"gray",size:"sm",style:{marginLeft:"2px"}})]})]}),e.jsx("div",{style:{minHeight:"40px",display:"flex",alignItems:"center"},children:e.jsx(r,{content:n("pricing.ent_desc"),size:"sm",color:"deepgray",style:{textAlign:"center",margin:0}})}),e.jsxs(z,{spacing:"normal",style:{marginTop:"24px",alignSelf:"stretch"},children:[e.jsx(l,{iconName:"CheckIcon",children:n("pricing.ent_feat_1")}),e.jsx(l,{iconName:"CheckIcon",children:n("pricing.ent_feat_2")}),e.jsx(l,{iconName:"CheckIcon",children:n("pricing.ent_feat_3")})]})]}),e.jsx(a,{variant:"outline",style:{width:"100%"},children:n("pricing.ent_btn")})]})})]})]})}},j={render:function(){const{t:n}=h(g);return e.jsx("div",{style:{minHeight:"600px",display:"flex",alignItems:"center",background:"linear-gradient(135deg, var(--wim-color-primary-light, #f0f7ff) 0%, var(--wim-color-surface) 100%)",padding:"80px 24px"},children:e.jsx(C,{children:e.jsxs(_,{cols:{base:1,md:"1fr 1fr"},gap:48,align:"center",children:[e.jsxs(t,{gap:"3xl",children:[e.jsxs(t,{gap:"3xl",children:[e.jsx(L,{intent:"primary",content:n("hero.badge"),style:{width:"fit-content"}}),e.jsxs(t,{gap:"2xl",children:[e.jsx(i,{tag:"h1",size:"2xl",style:{lineHeight:"1",fontWeight:"800"},children:n("hero.title")}),e.jsx(r,{content:n("hero.desc"),size:"lg",color:"deepgray"})]})]}),e.jsxs(T,{gap:"xl",wrap:"wrap",justify:"evenly",children:[e.jsx(a,{variant:"filled",size:"md",children:n("hero.btn_started")}),e.jsx(a,{variant:"outline",size:"md",children:n("hero.btn_docs")})]}),e.jsxs(t,{direction:"row",align:"center",gap:"md",children:[e.jsx(P,{size:"sm",children:[1,2,3,4].map(s=>e.jsx(A,{},s))}),e.jsx(r,{content:n("hero.dev_count"),size:"sm",color:"deepgray"})]})]}),e.jsx("div",{style:{position:"relative"},children:e.jsx(p,{style:{padding:"0",borderRadius:"24px",boxShadow:"0 20px 25px -5px rgba(0, 0, 0, 0.1), 0 10px 10px -5px rgba(0, 0, 0, 0.04)",overflow:"hidden"},children:e.jsxs(t,{gap:"none",children:[e.jsxs(t,{direction:"row",gap:"xs",align:"center",style:{height:"32px",background:"#f3f4f6",borderBottom:"1px solid #e5e7eb",padding:"0 12px"},children:[e.jsx("div",{style:{width:"10px",height:"10px",borderRadius:"50%",background:"#ef4444"}}),e.jsx("div",{style:{width:"10px",height:"10px",borderRadius:"50%",background:"#f59e0b"}}),e.jsx("div",{style:{width:"10px",height:"10px",borderRadius:"50%",background:"#10b981"}})]}),e.jsx("div",{style:{padding:"24px"},children:e.jsxs(t,{gap:"lg",children:[e.jsx(m,{variant:"text",height:20,width:"100%"}),e.jsx(m,{variant:"text",height:20,width:"80%"}),e.jsxs(_,{cols:2,gap:16,children:[e.jsx(m,{variant:"rect",height:100,style:{borderRadius:"8px"}}),e.jsx(m,{variant:"rect",height:100,style:{borderRadius:"8px"}})]}),e.jsx(m,{variant:"rect",height:80,width:"100%",style:{borderRadius:"4px"}})]})})]})})})]})})})}},S={render:function(){const{t:n}=h(g);return e.jsx(H,{style:{height:"100vh",backgroundColor:"var(--wim-color-surface)",padding:"24px"},children:e.jsxs(t,{align:"center",gap:"5xl",style:{maxWidth:"600px",textAlign:"center"},children:[e.jsx("p",{"aria-hidden":"true",style:{fontSize:"120px",fontWeight:"900",color:"var(--wim-color-border-secondary)",lineHeight:"1",margin:"0"},children:"404"}),e.jsxs(t,{gap:"2xl",align:"center",children:[e.jsx(i,{tag:"h1",size:"xl",align:"center",children:n("error.title")}),e.jsx(r,{content:n("error.desc"),color:"gray",style:{textAlign:"center"}})]}),e.jsx(E,{intent:"info",title:n("error.help_title"),style:{textAlign:"left"},children:n("error.help_desc")}),e.jsxs(t,{direction:{base:"column",sm:"row"},gap:"xl",children:[e.jsx(a,{variant:"filled",children:n("error.btn_home")}),e.jsx(a,{variant:"outline",children:n("error.btn_support")})]})]})})}};y.parameters={...y.parameters,docs:{...y.parameters?.docs,source:{originalSource:`{
        ...
        borderColor: "var(--wim-color-border-secondary)"
          ...
          <Stack gap="xl">
            <Stack align="center" gap="md">
              <Heading tag="h2" size="xl" align="center" style={{
              lineHeight: 1
            }}>
                {t("login.title")}
              </Heading>
            ...
            <form onSubmit={e => e.preventDefault()}>
              <Stack gap="lg">
                ...
                <Stack gap="sm">
                  ...
                  width: "100%"
                }} onClick={() => {}}>{t("login.sign_in_google")}</Button>
                </Stack>
              </Stack>
            </form>
                  ...
                  flexWrap: "wrap"
                    ...
                    <Stack gap="xs">
                      ...
                      gap: "12px"
                        ...
                        <Button size="sm" variant="outline">{t("profile.btn_change")}</Button>
  ...
  render: function Render() {
    ...
    return <Container style={{
      ...
      background: "#fff"
          ...
          <Stack align="center" gap="3xl" style={{
        marginBottom: "64px"
      }}>
          ...
          md: "1fr 1fr"
            ...
            <Stack gap="3xl">
              ...
              <Group gap="xl" wrap="wrap" justify="evenly">
                <Button variant="filled" size="md">{t("hero.btn_started")}</Button>
                <Button variant="outline" size="md">{t("hero.btn_docs")}</Button>
              </Group>
...
}`,...S.parameters?.docs?.source}}};const V=["LoginForm","DashboardHeader","UserProfileForm","PricingTable","HeroSection","ErrorPage"],ve=Object.freeze(Object.defineProperty({__proto__:null,DashboardHeader:u,ErrorPage:S,HeroSection:j,LoginForm:y,PricingTable:v,UserProfileForm:b,__namedExportsOrder:V,default:F},Symbol.toStringTag,{value:"Module"}));export{u as D,S as E,j as H,y as L,ve as P,b as U,v as a};
