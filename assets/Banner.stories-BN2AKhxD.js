import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as R}from"./index-B7ARqZ81.js";import{F as j}from"./FeedbackIcon-B9l_g0xa.js";import{F as w}from"./FeedbackCloseButton-DXBVBjP3.js";import{u as a}from"./useTranslation-Iz9XWB8E.js";import{B as A}from"./Button-B9DA9x6X.js";import{A as o}from"./iframe-BIQ3_rbw.js";const s=({title:t,description:e,status:n="info",icon:f=!0,extra:g,onClose:N,className:S,children:b,...x})=>{const{t:y}=a();return r.jsx("div",{className:R("wim-banner",`wim-banner--${n}`,S),role:"banner",...x,children:r.jsxs("div",{className:"wim-banner__container",children:[r.jsxs("div",{className:"wim-banner__content",children:[f!==!1&&r.jsx("div",{className:"wim-banner__icon",children:r.jsx(j,{status:n,icon:typeof f=="boolean"?void 0:f,size:"sm"})}),r.jsxs("div",{className:"wim-banner__text",children:[t&&r.jsx("span",{className:"wim-banner__title",children:y(t)}),t&&(e||b)&&r.jsx("span",{className:"wim-banner__separator",children:" - "}),(e||b)&&r.jsx("span",{className:"wim-banner__description",children:e?y(e):b})]})]}),r.jsxs("div",{className:"wim-banner__actions",children:[g&&r.jsx("div",{className:"wim-banner__action",children:g}),r.jsx(w,{onClose:N,className:"wim-banner__close",size:"sm"})]})]})})};s.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。
