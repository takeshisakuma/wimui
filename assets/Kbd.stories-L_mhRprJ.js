import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as m}from"./index-Ckw0h7AD.js";const r=({children:t,size:o="medium",className:i,...l})=>e.jsx("kbd",{className:m("wim-kbd",`wim-kbd--${o==="small"?"sm":"md"}`,i),...l,children:t});r.__docgenInfo={description:"ユーザーが入力するキーボードのショートカットやキーを表示するためのコンポーネント。",methods:[],displayName:"Kbd",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"キーボードのラベル（または子要素）。"},size:{required:!1,tsType:{name:"union",raw:'"small" | "medium"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'}]},description:"サイズ。",defaultValue:{value:'"medium"',computed:!1}}}};const c={title:"Components/Typography & Icons/Kbd",component:r,tags:[],parameters:{layout:"centered"}},s={args:{children:"⌘",size:"md"}},a={args:{children:"K",size:"sm"}},n={render:()=>e.jsxs("div",{style:{display:"flex",gap:"4px",alignItems:"center"},children:[e.jsx(r,{children:"⌘"}),e.jsx("span",{children:"+"}),e.jsx(r,{children:"K"})]})},d={render:()=>e.jsxs("div",{style:{display:"flex",gap:"8px",flexWrap:"wrap"},children:[e.jsx(r,{children:"Shift"}),e.jsx(r,{children:"Ctrl"}),e.jsx(r,{children:"Option"}),e.jsx(r,{children:"Command"}),e.jsx(r,{children:"Enter"}),e.jsx(r,{children:"⌫"}),e.jsx(r,{children:"⎋"})]})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    children: "⌘",
    size: "md"
  }
