import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as a}from"./iframe-DY0V2adl.js";import{c as h}from"./index-qsBB_Z-V.js";import{I as P}from"./Icon-Bk4PPPQY.js";const j=a.createContext(null),y=()=>{const r=a.useContext(j);if(!r)throw new Error("Accordion components must be used within an Accordion");return r},n=({type:r="single",defaultValue:t,value:s,onValueChange:i,collapsible:o=!0,className:l,children:m,id:f})=>{const I=a.useId(),R=f||I,[v,N]=a.useState(()=>t?Array.isArray(t)?t:[t]:[]),C=s!==void 0,u=a.useMemo(()=>{const c=C?s:v;return Array.isArray(c)?c:c?[c]:[]},[C,s,v]),q=a.useCallback(c=>{let d;r==="single"?u.includes(c)?d=o?[]:[c]:d=[c]:u.includes(c)?d=u.filter(T=>T!==c):d=[...u,c],C||N(d),i?.(r==="single"?d[0]??"":d)},[u,o,C,i,r]);return e.jsx(j.Provider,{value:{value:u,onValueChange:q,type:r,accordionId:R},children:e.jsx("div",{className:h("wim-accordion",l),children:m})})},x=a.createContext(null),w=({value:r,disabled:t=!1,className:s,children:i})=>{const{value:o,accordionId:l}=y(),m=o.includes(r),f=`wim-accordion-trigger-${l}-${r}`,I=`wim-accordion-content-${l}-${r}`;return e.jsx(x.Provider,{value:{value:r,disabled:t,isLogicOpen:m,triggerId:f,contentId:I},children:e.jsx("div",{className:h("wim-accordion__item",t&&"wim-accordion__item--disabled",m&&"wim-accordion__item--open",s),children:i})})},_=({children:r,className:t,...s})=>{const{onValueChange:i}=y(),o=a.useContext(x);if(!o)throw new Error("AccordionTrigger must be used within AccordionItem");const l=m=>{if(o.disabled){m.preventDefault();return}i(o.value)};return e.jsxs("button",{type:"button",id:o.triggerId,className:h("wim-accordion__trigger",t),"aria-expanded":o.isLogicOpen,"aria-controls":o.contentId,"aria-disabled":o.disabled,disabled:o.disabled,onClick:l,...s,children:[e.jsx("span",{className:"wim-accordion__trigger-content",children:r}),e.jsx(P,{name:"ChevronDownIcon",className:h("wim-accordion__chevron",o.isLogicOpen&&"wim-accordion__chevron--open")})]})},b=({children:r,className:t,...s})=>{const i=a.useContext(x);if(!i)throw new Error("AccordionContent must be used within AccordionItem");return e.jsx("div",{id:i.contentId,role:"region","aria-labelledby":i.triggerId,className:h("wim-accordion__content",i.isLogicOpen&&"wim-accordion__content--open",t),...s,children:e.jsx("div",{className:"wim-accordion__content-inner",children:e.jsx("div",{className:"wim-accordion__content-body",children:r})})})};n.Item=w;n.Trigger=_;n.Content=b;n.__docgenInfo={description:`折りたたみ可能なコンテンツのセット。
type="single" の場合は一度に一つ、"multiple" の場合は複数開くことができます。`,methods:[{name:"Item",docblock:null,modifiers:["static"],params:[{name:`{
  ...
  render: args => <Accordion {...args}>\r
      ...
      <Accordion.Item value="item-2">\r
        <Accordion.Trigger>アコーディオン 2</Accordion.Trigger>\r
        <Accordion.Content>これは 2 つ目のアイテムです。</Accordion.Content>\r
      </Accordion.Item>\r
      <Accordion.Item value="item-3">\r
        <Accordion.Trigger>アコーディオン 3</Accordion.Trigger>\r
        <Accordion.Content>これは 3 つ目のアイテムです。</Accordion.Content>\r
      </Accordion.Item>\r
    </Accordion>,
  args: {
    type: "multiple"
