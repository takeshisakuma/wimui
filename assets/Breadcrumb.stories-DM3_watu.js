import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as d}from"./index-CubViWzO.js";import{L as h}from"./Link-B0CYqClc.js";import{I as p}from"./Icon-Bl9Iq_fA.js";import{u as C}from"./useTranslation-1LeyJRh3.js";const b=({items:c,separator:g,size:r="medium",className:f})=>{const{t:i}=C(),y=e.jsx(p,{name:"ChevronRightIcon",size:r,className:"wim-breadcrumb__separator-icon"});return e.jsx("nav",{"aria-label":"Breadcrumb",className:d("wim-breadcrumb",`wim-breadcrumb--${r==="small"?"sm":r==="large"?"lg":"md"}`,f),children:e.jsx("ol",{className:"wim-breadcrumb__list",children:c.map((a,u)=>{const m=u===c.length-1;return e.jsxs("li",{className:"wim-breadcrumb__item",children:[e.jsx("div",{className:"wim-breadcrumb__content",children:a.href&&!m?e.jsx(h,{href:a.href,size:r,priority:"secondary",iconName:a.iconName,className:"wim-breadcrumb__link",children:i(a.label)}):e.jsxs("span",{className:d("wim-breadcrumb__label",m&&"wim-breadcrumb__label--current"),"aria-current":m?"page":void 0,children:[a.iconName&&e.jsx(p,{name:a.iconName,size:r,className:"wim-breadcrumb__label-icon"}),i(a.label)]})}),!m&&e.jsx("span",{className:"wim-breadcrumb__separator","aria-hidden":"true",children:g||y})]},u)})})})};b.__docgenInfo={description:"",methods:[],displayName:"Breadcrumb",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  href?: string;
