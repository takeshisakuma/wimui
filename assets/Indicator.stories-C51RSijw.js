import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as p}from"./index-BKAe34ln.js";import{A as l}from"./Avatar-BfO4YyrB.js";import{I as f}from"./Icon-xLIHigt1.js";import{A as b}from"./iframe-DSE3UbG8.js";import{u as h}from"./useTranslation-DOQQDmnd.js";const e=({children:a,color:o="primary",size:v="medium",position:y="top-right",pulse:x=!1,inline:d=!1,className:g,style:w})=>{const u=o&&(o.startsWith("var(")||o.includes("#")||o.includes("rgb"));return r.jsxs("span",{className:p("wim-indicator",d&&"wim-indicator--inline",g),style:w,children:[a,r.jsx("span",{className:p("wim-indicator__dot",!u&&`wim-indicator__dot--${o}`,`wim-indicator__dot--${v==="small"?"sm":v==="large"?"lg":"md"}`,!d&&`wim-indicator__dot--${y}`,x&&"wim-indicator__dot--pulse"),style:{backgroundColor:u?o:void 0}})]})};e.__docgenInfo={description:"要素の状態（オンライン、未読、エラーなど）を示す小さなドットコンポーネント。",methods:[],displayName:"Indicator",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},color:{required:!1,tsType:{name:"union",raw:'"primary" | "success" | "error" | "warning" | "neutral" | WimColor',elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"neutral"'},{name:"union",raw:"T | (string & {})",elements:[{name:"union",raw:`| "var(--color-destructive)"
| "var(--color-positive)"
| "var(--color-caution)"
| "var(--color-primary)"
| "var(--color-secondary)"
