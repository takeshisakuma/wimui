import{j as r}from"./jsx-runtime-u17CrQMm.js";import{r as C}from"./iframe-BNlQl3jf.js";import{I as R}from"./Input-BLOcXzzR.js";import{L as i}from"./Label-BKCBTd-s.js";import{u as g}from"./useTranslation-C1Yfhr6h.js";const c=({mask:a,maskChar:n="_",value:e,defaultValue:I,onChange:f,..._})=>{const[y,j]=C.useState(I||""),b=e!==void 0,M=b?e:y,T=C.useCallback(o=>{let s="",l=0;const x=o.replace(/[^a-zA-Z0-9]/g,"");let k=0;for(;l<a.length;){const t=a[l];if(t==="9"||t==="a"||t==="*")if(k<x.length){const h=x[k];if(t==="9"&&/[0-9]/.test(h)||t==="a"&&/[a-zA-Z]/.test(h)||t==="*")s+=h,k++;else break}else break;else s+=t;l++}return s},[a]),L=o=>{const s=T(o.target.value);if(b||j(s),f){const l={...o,target:{...o.target,value:s},currentTarget:{...o.currentTarget,value:s}};f(l)}};return r.jsx(R,{..._,value:M,onChange:L,placeholder:_.placeholder||a.replace(/[9a*]/g,n)})};c.__docgenInfo={description:`特定の形式に沿った入力を強制するためのマスク付き入力コンポーネント。
'9': 数字 (0-9)
'a': 英字 (a-z, A-Z)
'*': 英数字
