import{j as a}from"./jsx-runtime-u17CrQMm.js";import{c as o}from"./index-2r2kfcGX.js";const s=({children:t,className:n,...i})=>a.jsx("span",{className:o("wim-visually-hidden",n),...i,children:t});s.__docgenInfo={description:"視覚的には非表示にしつつ、スクリーンリーダーなどのアシスティブテクノロジーにはコンテンツを維持するためのアクセシビリティ用コンポーネント。",methods:[],displayName:"VisuallyHidden",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示されないが、スクリーンリーダーには読み上げられるコンテンツ。"}}};const d={title:"Components/Utilities/VisuallyHidden",component:s,tags:[],parameters:{layout:"centered"}},e={args:{children:"このテキストは視覚的に隠されていますが、スクリーンリーダーでは読み上げられます。"}},r={render:()=>a.jsxs("button",{"aria-label":"閉じる",children:[a.jsx("span",{"aria-hidden":"true",children:"×"}),a.jsx(s,{children:"閉じる"})]})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
