import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as R}from"./index-6KFIEf95.js";import{F as j}from"./FeedbackIcon-DmTZ1FoT.js";import{F as w}from"./FeedbackCloseButton-DhAsVhXt.js";import{u as a}from"./useTranslation-C6_B5Ynz.js";import{B as A}from"./Button-DJaEltzo.js";import{A as o}from"./iframe-BIyQwIaN.js";const s=({title:t,description:e,status:n="info",icon:f=!0,extra:g,onClose:N,className:S,children:b,...x})=>{const{t:y}=a();return r.jsx("div",{className:R("wim-banner",`wim-banner--${n}`,S),role:"banner",...x,children:r.jsxs("div",{className:"wim-banner__container",children:[r.jsxs("div",{className:"wim-banner__content",children:[f!==!1&&r.jsx("div",{className:"wim-banner__icon",children:r.jsx(j,{status:n,icon:typeof f=="boolean"?void 0:f,size:"sm"})}),r.jsxs("div",{className:"wim-banner__text",children:[t&&r.jsx("span",{className:"wim-banner__title",children:y(t)}),t&&(e||b)&&r.jsx("span",{className:"wim-banner__separator",children:" - "}),(e||b)&&r.jsx("span",{className:"wim-banner__description",children:e?y(e):b})]})]}),r.jsxs("div",{className:"wim-banner__actions",children:[g&&r.jsx("div",{className:"wim-banner__action",children:g}),r.jsx(w,{onClose:N,className:"wim-banner__close",size:"sm"})]})]})})};s.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。
