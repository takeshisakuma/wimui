"use client";
import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{Cr as n,br as r,cr as i,xr as a,yr as o}from"./iframe-DiXuc7DI.js";import{t as s,tr as c}from"./src-BE5jBQ9L.js";var l=e({Default:()=>f,Large:()=>m,Small:()=>p,__namedExportsOrder:()=>h,default:()=>d}),u,d,f,p,m,h,g=t((()=>{a(),r(),s(),u=i(),d={title:`Components/Buttons/CopyButton`,component:c,tags:[],argTypes:{size:{control:`radio`,options:[`sm`,`md`,`lg`]}}},f={render:e=>{let{t}=n(o);return(0,u.jsx)(c,{...e,value:t(`story.copybutton_value`)})}},p={args:{value:`Small CopyButton`,size:`sm`}},m={args:{value:`Large CopyButton`,size:`lg`}},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      t
