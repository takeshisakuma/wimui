import{j as o}from"./react-D-G-yZ1o.js";import{L as t}from"./Label-kdNcsahq.js";import{I as s}from"./Input-DIVxSBRG.js";const l={title:"Component/Form Inputs/Label",component:t,parameters:{layout:"centered"}},e={args:{label:"Username",children:o.jsx(s,{placeholder:"Enter your username"})}},r={args:{label:"Email Address",required:!0,children:o.jsx(s,{type:"email",placeholder:"email@example.com"})}},a={args:{label:"Phone Number",showOptional:!0,children:o.jsx(s,{type:"tel",placeholder:"000-0000-0000"})}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Username",
