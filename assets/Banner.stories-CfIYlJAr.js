import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as S}from"./index-DF_nXgT0.js";import{F as v}from"./FeedbackIcon-Dix-KiUX.js";import{F as x}from"./FeedbackCloseButton-DkMriMHL.js";import{B as y}from"./Button-BKQogAGJ.js";import{A as a}from"./iframe-DKmwcFSw.js";import{u as o}from"./useTranslation-cHJIwR7k.js";const s=({title:t,description:e,intent:n="info",icon:f=!0,extra:b,onClose:R,className:N,children:g,...A})=>r.jsx("div",{className:S("wim-banner",`wim-banner--${n}`,N),role:"banner",...A,children:r.jsxs("div",{className:"wim-banner__container",children:[r.jsxs("div",{className:"wim-banner__content",children:[f!==!1&&r.jsx("div",{className:"wim-banner__icon",children:r.jsx(v,{intent:n,icon:typeof f=="boolean"?void 0:f,size:"sm"})}),r.jsxs("div",{className:"wim-banner__text",children:[t&&r.jsx("span",{className:"wim-banner__title",children:t}),t&&(e||g)&&r.jsx("span",{className:"wim-banner__separator",children:" - "}),(e||g)&&r.jsx("span",{className:"wim-banner__description",children:e||g})]})]}),r.jsxs("div",{className:"wim-banner__actions",children:[b&&r.jsx("div",{className:"wim-banner__action",children:b}),r.jsx(x,{onClose:R,className:"wim-banner__close",size:"sm"})]})]})});s.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。
...
| "positive"`,elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"secondary"'},{name:"literal",value:'"success"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"error"'},{name:"literal",value:'"info"'},{name:"literal",value:'"neutral"'},{name:"literal",value:'"default"'},{name:"literal",value:'"destructive"'},{name:"literal",value:'"positive"'}]},description:"バナーのインテント",defaultValue:{value:'"info"',computed:!1}},icon:{required:!1,tsType:{name:"union",raw:"boolean | React.ReactNode",elements:[{name:"boolean"},{name:"ReactReactNode",raw:"React.ReactNode"}]},description:"アイコンを表示するかどうか、またはカスタムアイコン",defaultValue:{value:"true",computed:!1}},extra:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"アクションボタン要素（例：Buttonコンポーネント）"},onClose:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:"閉じるボタンをクリックした時のコールバック。指定すると閉じるボタンが表示されます。"},className:{required:!1,tsType:{name:"string"},description:"追加のクラス名"},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"子要素"}}};const w={title:"Components/Alerts & Notifications/Banner",component:s,tags:[],argTypes:{onClose:{action:"closed"},icon:{control:"boolean"},intent:{control:"select",options:["info","success","warning","error"]}},parameters:{layout:"fullscreen"}},i={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,title:e.title||n("story.banner_update_title"),description:e.description||n("story.banner_update_desc")})},args:{intent:"info"}},c={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,title:e.title||n("story.alert_success_title"),description:e.description||n("story.banner_update_desc")})},args:{intent:"success"}},l={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,title:e.title||n("story.banner_maint_title"),description:e.description||n("story.banner_maint_desc")})},args:{intent:"warning"}},d={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,title:e.title||n("story.banner_conn_error_title"),description:e.description||n("story.banner_conn_error_desc"),onClose:e.onClose??(()=>{})})},args:{intent:"error"}},u={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,title:e.title||n("story.banner_cookie_title"),description:e.description||n("story.banner_cookie_desc"),extra:r.jsx(y,{size:"sm",variant:"outlined",children:n("story.banner_btn_accept")})})},args:{intent:"info"}},p={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,title:e.title||n("story.banner_trial_title"),description:e.description||n("story.banner_trial_desc"),extra:r.jsx(y,{size:"sm",variant:"filled",children:n("story.banner_btn_upgrade")}),onClose:e.onClose??(()=>{})})},args:{intent:"warning"}},m={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,description:e.description||n("story.banner_no_title_desc")})},args:{intent:"info"}},_={render:function(e){const{t:n}=o(a);return r.jsx(s,{...e,title:e.title||n("story.banner_simple_title"),description:e.description||n("story.banner_simple_desc"),icon:!1})},args:{intent:"info"}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  ...
  render: function Render(args) {
    ...
    return <Banner {...args} title={args.title || t("story.banner_cookie_title")} description={args.description || t("story.banner_cookie_desc")} extra={<Button size="sm" variant="outlined">{t("story.banner_btn_accept")}</Button>} />;
  },
  args: {
    intent: "info"
  }
  ...
  render: function Render(args) {
    ...
    return <Banner {...args} title={args.title || t("story.banner_trial_title")} description={args.description || t("story.banner_trial_desc")} extra={<Button size="sm" variant="filled">{t("story.banner_btn_upgrade")}</Button>} onClose={args.onClose ?? (() => {})} />;
  },
  args: {
    intent: "warning"
  }
