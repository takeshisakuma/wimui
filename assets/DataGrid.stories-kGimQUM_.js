...
}`,...K.parameters?.docs?.source}}};const ye=["Default","WithSelection","WithSorting","WithPagination","WithActions","Loading","Empty","Striped","Bordered","StickyHeader","FullFeatured","WithFixedColumn"],Te=Object.freeze(Object.defineProperty({__proto__:null,Bordered:W,Default:C,Empty:P,FullFeatured:V,Loading:z,StickyHeader:q,Striped:A,WithActions:T,WithFixedColumn:K,WithPagination:I,WithSelection:j,WithSorting:R,__namedExportsOrder:ye,default:ge},Symbol.toStringTag,{value:"Module"}));export{W as B,Te as D,P as E,V as F,z as L,A as S,j as W,R as a,I as b,T as c,q as d,K as e};
