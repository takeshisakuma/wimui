import{j as n}from"./jsx-runtime-u17CrQMm.js";import{c as i}from"./index-CWJxLETi.js";import{I as t}from"./IndicatorBase-TQqRr_F5.js";/* empty css              */const s=({children:e,icon:a,className:l,...r})=>n.jsx(t,{prefixClass:"wim-badge",icon:a,className:i(!e&&"wim-badge--icon-only",l),...r,children:e});s.__docgenInfo={description:"状態やカウントなどを表示するためのバッジコンポーネント。",methods:[],displayName:"Badge",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示するコンテンツ"},icon:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"アイコン"},intent:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
