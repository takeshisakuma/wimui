"use client";
import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{t as r}from"./react-DmCNssFd.js";import{Cr as i,br as a,cr as o,xr as s,yr as c}from"./iframe-F5Up1IQq.js";import{Ci as l,Hi as u,Vt as d,_i as f,ki as p,si as m,t as h}from"./src-Ssuy8lr7.js";import{t as g}from"./Icon-dyTmj1rn.js";import{t as _}from"./Button-Dps1MPAd.js";import{t as v}from"./Input-BY9GcYwo.js";var y=e({Default:()=>C,ModernApp:()=>w,Playground:()=>O,WithFooter:()=>E,WithNavbar:()=>D,WithSidebar:()=>T,__namedExportsOrder:()=>k,default:()=>S}),b,x,S,C,w,T,E,D,O,k,A=t((()=>{b=n(r(),1),s(),a(),h(),x=o(),S={title:`Components/Application Shell/AppShell`,component:u,parameters:{layout:`fullscreen`},tags:[],argTypes:{padding:{control:`boolean`,description:`Add padding to the main content`},centered:{control:`boolean`,description:`Center the main content horizontally`},maxWidth:{control:`text`,description:`Specify the maximum width when centered`},header:{table:{disable:!0}},sidebar:{table:{disable:!0}},footer:{table:{disable:!0}},navbar:{table:{disable:!0}},children:{table:{disable:!0}}}},C={args:{centered:!0,maxWidth:1200},render:function(e){let{t}=i(c);return(0,x.jsx)(u,{...e,header:(0,x.jsxs)(l,{bordered:!0,children:[(0,x.jsx)(l.Section,{align:`start`,children:(0,x.jsx)(`div`,{style:{fontWeight:`bold`,fontSize:`1.2rem`},children:`WIM UI`})}),(0,x.jsxs)(l.Section,{align:`end`,style:{gap:`8px`},children:[(0,x.jsx)(_,{variant:`ghost`,size:`sm`,children:t(`story.appshell_docs`)}),(0,x.jsx)(_,{variant:`solid`,size:`sm`,children:t(`story.appshell_signin`)})]})]}),children:(0,x.jsxs)(`div`,{children:[(0,x.jsx)(`h2`,{children:t(`story.appshell_welcome`)}),(0,x.jsx)(`p`,{children:t(`story.appshell_main_content`)}),(0,x.jsx)(`p`,{children:t(`story.appshell_flexible_layout`)})]})})}},w={args:{centered:!0,maxWidth:1200},render:function(e){let{t}=i(c),n=(0,x.jsx)(v,{placeholder:t(`story.appshell_search_placeholder`),leftIcon:`SearchIcon`,fullWidth:!0,"aria-label":t(`story.appshell_search_placeholder`)});return(0,x.jsxs)(x.Fragment,{children:[(0,x.jsx)(`style`,{children:`
