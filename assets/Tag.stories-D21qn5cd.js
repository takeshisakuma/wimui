import{j as n}from"./jsx-runtime-u17CrQMm.js";import{I as m}from"./IndicatorBase-CHzDd9Mq.js";import{I as g}from"./Icon-DdY3T4lx.js";import{A as u}from"./i18nConstants-fBKvcUJT.js";import{u as d}from"./useTranslation-BfYXAya8.js";const a=({children:s,icon:r,...e})=>n.jsx(m,{prefixClass:"wim-tag",icon:r,...e,children:s});a.__docgenInfo={description:"カテゴリ分けや属性のラベルとして使用される非インタラクティブなコンポーネント。",methods:[],displayName:"Tag",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示するコンテンツ"},status:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
