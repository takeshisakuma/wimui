  ...
  render: function FullScreenStory(args) {
    ...
    return <div style={{
      padding: "20px"
        ...
        <p>\r
          Click the button to show a full-screen loading overlay for 3 seconds.\r
        </p>\r
