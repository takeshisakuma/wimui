import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as p}from"./index-x98TZOX1.js";import{A as o}from"./Avatar-BrXbYWRK.js";const a=({children:e,color:l="primary",size:v="medium",position:x="top-right",pulse:g=!1,inline:d=!1,className:y,style:w})=>{const u=l&&(l.startsWith("var(")||l.includes("#")||l.includes("rgb"));return r.jsxs("span",{className:p("wim-indicator",d&&"wim-indicator--inline",y),style:w,children:[e,r.jsx("span",{className:p("wim-indicator__dot",!u&&`wim-indicator__dot--${l}`,`wim-indicator__dot--${v==="small"?"sm":v==="large"?"lg":"md"}`,!d&&`wim-indicator__dot--${x}`,g&&"wim-indicator__dot--pulse"),style:{backgroundColor:u?l:void 0}})]})};a.__docgenInfo={description:"要素の状態（オンライン、未読、エラーなど）を示す小さなドットコンポーネント。",methods:[],displayName:"Indicator",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},color:{required:!1,tsType:{name:"union",raw:'"primary" | "success" | "error" | "warning" | "neutral" | WimColor',elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"neutral"'},{name:"union",raw:"T | (string & {})",elements:[{name:"union",raw:`| "var(--color-destructive)"\r
...
}`,...m.parameters?.docs?.source}}};const f=["Default","Colors","Pulse","Inline","Sizes","WithIcons"],S=Object.freeze(Object.defineProperty({__proto__:null,Colors:n,Default:i,Inline:s,Pulse:t,Sizes:c,WithIcons:m,__namedExportsOrder:f,default:h},Symbol.toStringTag,{value:"Module"}));export{n as C,i as D,S as I,t as P,c as S,s as a};
