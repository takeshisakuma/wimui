import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as h}from"./index-Ckw0h7AD.js";import{u as d}from"./useTranslation-BH3LN071.js";const c=({text:n,children:t,scrollAxis:r="y",maxHeight:m="10rem",style:i,className:_,...p})=>{const{t:u}=d(),y={maxHeight:m,overflowX:r==="x"||r==="both"?"auto":"hidden",overflowY:r==="y"||r==="both"?"auto":"hidden",...i};return e.jsx("div",{className:h("wim-scroll-area",_),style:y,...p,children:t||(n?u(n):null)})};c.__docgenInfo={description:"",methods:[],displayName:"ScrollArea",props:{text:{required:!1,tsType:{name:"string"},description:""},children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},scrollAxis:{required:!1,tsType:{name:"union",raw:'"x" | "y" | "both"',elements:[{name:"literal",value:'"x"'},{name:"literal",value:'"y"'},{name:"literal",value:'"both"'}]},description:"",defaultValue:{value:'"y"',computed:!1}},maxHeight:{required:!1,tsType:{name:"string"},description:""}}};const g={title:"Components/Utilities/ScrollArea",component:c,parameters:{layout:"centered"},argTypes:{scrollAxis:{control:"select",options:["x","y","both"]},maxHeight:{control:"text"}}},o={args:{text:"sampletextforscrollarea",scrollAxis:"y",maxHeight:"10rem"}},s={render:function(t){const{t:r}=d(["docs","common","components"]);return e.jsx(c,{...t,scrollAxis:"x",style:{width:"100%",maxWidth:"80vw"},children:e.jsxs("div",{style:{width:"150rem",background:"#3b82f6",padding:"1rem",color:"white"},children:[r("story_scrollarea_wide_content")," ",r("story_selectbox_opt4")," ",r("story_scrollarea_wide_content")," ",r("story_selectbox_opt4")," ",r("story_scrollarea_wide_content")," ",r("story_selectbox_opt4")]})})}},l={args:{scrollAxis:"y",maxHeight:"12rem"},render:function(t){const{t:r}=d(["docs","common","components"]);return e.jsx(c,{...t,children:e.jsxs("div",{style:{padding:"1rem"},children:[e.jsx("h4",{style:{margin:"0 0 1rem 0"},children:r("story_scrollarea_custom_title")}),e.jsx("p",{children:r("story_scrollarea_custom_desc")}),e.jsxs("ul",{children:[e.jsx("li",{children:r("story_scrollarea_item",{count:1})}),e.jsx("li",{children:r("story_scrollarea_item",{count:2})}),e.jsx("li",{children:r("story_scrollarea_item",{count:3})}),e.jsx("li",{children:r("story_scrollarea_item",{count:4})}),e.jsx("li",{children:r("story_scrollarea_item",{count:5})})]}),e.jsx("p",{children:r("story_scrollarea_scrolling_works")})]})})}},a={args:{scrollAxis:"both",maxHeight:"20rem",style:{width:"100%",maxWidth:"80vw"}},render:function(t){const{t:r}=d(["docs","common","components"]);return e.jsx(c,{...t,children:e.jsxs("div",{style:{width:"40rem",height:"40rem",background:"linear-gradient(135deg, #FF9A9E 0%, #FECFEF 99%, #FECFEF 100%)",padding:"1rem"},children:[e.jsx("h4",{style:{color:"#333"},children:r("story_scrollarea_both_title")}),e.jsx("p",{style:{color:"#555"},children:r("story_scrollarea_both_desc")}),e.jsx("div",{style:{marginTop:"2rem",display:"grid",gridTemplateColumns:"repeat(5, 1fr)",gap:"1rem"},children:[...Array(20)].map((m,i)=>e.jsx("div",{style:{background:"rgba(255,255,255,0.5)",padding:"1rem",borderRadius:"4px"},children:r("story_scrollarea_box",{count:i+1})},i))})]})})}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...a.parameters?.docs?.source}}};const x=["Default","HorizontalScroll","WithChildren","Both"],w=Object.freeze(Object.defineProperty({__proto__:null,Both:a,Default:o,HorizontalScroll:s,WithChildren:l,__namedExportsOrder:x,default:g},Symbol.toStringTag,{value:"Module"}));export{a as B,o as D,s as H,w as S,l as W};
