import{j as r}from"./jsx-runtime-u17CrQMm.js";import{I as m}from"./IndicatorBase-DCO4XJUq.js";import{I as g}from"./Icon-D3mLvHAI.js";import{A as u}from"./iframe-DZKUwcAF.js";import{u as d}from"./useTranslation-D3JcAmfq.js";const a=({children:s,icon:e,...n})=>r.jsx(m,{prefixClass:"wim-tag",icon:e,...n,children:s});a.__docgenInfo={description:"カテゴリ分けや属性のラベルとして使用される非インタラクティブなコンポーネント。",methods:[],displayName:"Tag",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示するコンテンツ"},status:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
