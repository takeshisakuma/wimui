  ...
  render: args => {
    ...
    return <div style={{
      ...
      alignItems: "center"
        ...
        <input type="range" min={0} max={100} value={pos} onChange={e => setPos(Number(e.target.value))} aria-label={t("story.imagecompare_position_label")} style={{
        width: "480px"
      }} />
      </div>;
  }
