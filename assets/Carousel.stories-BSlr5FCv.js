import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as l,R as ae}from"./iframe-Ddm5FQ3s.js";import{c as N}from"./index-DmFcGT-q.js";import{I as B}from"./Icon-MOwUJT5R.js";import{u as p}from"./useTranslation-BxKydHqK.js";import{A as h}from"./i18nConstants-BpHxieg5.js";const te=(n,a)=>typeof n=="number"?n:n?a>=1280&&n.xl?n.xl:a>=1024&&n.lg?n.lg:a>=768&&n.md?n.md:a>=640&&n.sm?n.sm:n.base||1:1,u=({children:n,autoPlay:a=!1,interval:t=5e3,showIndicators:i=!0,showControls:c=!0,loop:r=!0,slidesToShow:z=1,aspectRatio:P,objectFit:O="cover",className:K})=>{const{t:M}=p(),_=l.useMemo(()=>ae.Children.toArray(n),[n]),o=_.length,[F,G]=l.useState(typeof window<"u"?window.innerWidth:0),[m,f]=l.useState(r?o:0),[g,k]=l.useState(!1),[y,U]=l.useState(1),[V,E]=l.useState(!1),$=l.useRef(null),H=l.useRef(null),I=l.useRef(null),L=l.useRef(null);l.useEffect(()=>{const s=()=>G(window.innerWidth);return window.addEventListener("resize",s),()=>window.removeEventListener("resize",s)},[]),l.useEffect(()=>{U(te(z,F))},[z,F]);const J=l.useMemo(()=>!r||o===0?_:[..._,..._,..._],[_,r,o]),x=l.useCallback(()=>{if(!g){if(!r){f(s=>Math.min(s+1,o-y));return}k(!0),f(s=>s+1)}},[g,r,o,y]),q=l.useCallback(()=>{if(!g){if(!r){f(s=>Math.max(s-1,0));return}k(!0),f(s=>s-1)}},[g,r]),Q=s=>{g||(r?(k(!0),f(s+o)):f(s))},Y=()=>{r&&(k(!1),m>=o*2?f(m-o):m<o&&f(m+o))};l.useEffect(()=>(a&&!V&&o>y&&($.current=window.setInterval(x,t)),()=>{$.current&&window.clearInterval($.current)}),[a,t,x,o,y,V]);const Z=s=>{s.key==="ArrowLeft"?q():s.key==="ArrowRight"&&x()},ee=s=>{I.current=s.targetTouches[0].clientX},re=s=>{L.current=s.targetTouches[0].clientX},ne=()=>{if(!I.current||!L.current)return;const s=I.current-L.current,d=50;s>d?x():s<-d&&q(),I.current=null,L.current=null};if(o===0)return null;const W=100/y,se=-m*W;return e.jsxs("div",{className:N("wim-carousel",K),onMouseEnter:()=>E(!0),onMouseLeave:()=>E(!1),onFocus:()=>E(!0),onBlur:()=>E(!1),onKeyDown:Z,tabIndex:0,role:"region","aria-roledescription":"carousel",children:[e.jsx("div",{className:"wim-carousel__viewport",children:e.jsx("div",{ref:H,className:N("wim-carousel__track",g&&"wim-carousel__track--transition"),style:{transform:`translateX(${se}%)`},onTransitionEnd:Y,onTouchStart:ee,onTouchMove:re,onTouchEnd:ne,children:J.map((s,d)=>e.jsx("div",{className:N("wim-carousel__item",P&&"wim-carousel__item--has-aspect-ratio"),style:{flex:`0 0 ${W}%`,width:`${W}%`,...P?{aspectRatio:P,"--wim-carousel-object-fit":O}:{}},role:"group","aria-roledescription":"slide","aria-label":M("story_carousel_slide_label",{number:d%o+1}),children:s},d))})}),c&&o>y&&e.jsxs(e.Fragment,{children:[e.jsx("button",{className:"wim-carousel__control wim-carousel__control--prev",onClick:q,"aria-label":M("a11y_prev_slide"),disabled:!r&&m===0,tabIndex:-1,children:e.jsx(B,{name:"ChevronLeftIcon",size:"medium"})}),e.jsx("button",{className:"wim-carousel__control wim-carousel__control--next",onClick:x,"aria-label":M("a11y_next_slide"),disabled:!r&&m>=o-y,tabIndex:-1,children:e.jsx(B,{name:"ChevronRightIcon",size:"medium"})})]}),i&&o>1&&e.jsx("div",{className:"wim-carousel__indicators",children:_.map((s,d)=>{const X=r?m%o===d:m===d;return e.jsx("button",{className:N("wim-carousel__indicator",X&&"wim-carousel__indicator--active"),onClick:()=>Q(d),"aria-label":`Go to slide ${d+1}`,"aria-current":X?"true":"false"},d)})})]})};u.__docgenInfo={description:"`Carousel` は複数のコンテンツをスライドさせて表示するコンポーネントです。",methods:[],displayName:"Carousel",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"カルーセル内のコンテンツ"},autoPlay:{required:!1,tsType:{name:"boolean"},description:"自動再生するかどうか",defaultValue:{value:"false",computed:!1}},interval:{required:!1,tsType:{name:"number"},description:"自動再生の間隔（ミリ秒）",defaultValue:{value:"5000",computed:!1}},showIndicators:{required:!1,tsType:{name:"boolean"},description:"インジケーターを表示するかどうか",defaultValue:{value:"true",computed:!1}},showControls:{required:!1,tsType:{name:"boolean"},description:"前後ボタンを表示するかどうか",defaultValue:{value:"true",computed:!1}},loop:{required:!1,tsType:{name:"boolean"},description:"無限ループするかどうか（シームレスな切り替え）",defaultValue:{value:"true",computed:!1}},slidesToShow:{required:!1,tsType:{name:"union",raw:"number | Breakpoints",elements:[{name:"number"},{name:"signature",type:"object",raw:`{\r
  base?: number;\r
  sm?: number;\r
  md?: number;\r
  lg?: number;\r
