import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as R}from"./index-DuagTqeO.js";import{F as j}from"./FeedbackIcon-DanNHkwM.js";import{F as w}from"./FeedbackCloseButton-BPTr2oRt.js";import{u as a}from"./useTranslation-C_YAF8hH.js";import{B as A}from"./Button-DP-W9k8s.js";import{A as o}from"./iframe-CrEaZ-m1.js";const s=({title:t,description:e,status:n="info",icon:b=!0,extra:f,onClose:N,className:S,children:g,...x})=>{const{t:y}=a();return r.jsx("div",{className:R("wim-banner",`wim-banner--${n}`,S),role:"banner",...x,children:r.jsxs("div",{className:"wim-banner__container",children:[r.jsxs("div",{className:"wim-banner__content",children:[b!==!1&&r.jsx("div",{className:"wim-banner__icon",children:r.jsx(j,{status:n,icon:typeof b=="boolean"?void 0:b,size:"small"})}),r.jsxs("div",{className:"wim-banner__text",children:[t&&r.jsx("span",{className:"wim-banner__title",children:y(t)}),t&&(e||g)&&r.jsx("span",{className:"wim-banner__separator",children:" - "}),(e||g)&&r.jsx("span",{className:"wim-banner__description",children:e?y(e):g})]})]}),r.jsxs("div",{className:"wim-banner__actions",children:[f&&r.jsx("div",{className:"wim-banner__action",children:f}),r.jsx(w,{onClose:N,className:"wim-banner__close",size:"small"})]})]})})};s.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。
