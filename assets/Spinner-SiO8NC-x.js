import{j as a}from"./jsx-runtime-u17CrQMm.js";import{c as o}from"./index-CYDtE1TD.js";const c=({size:i="md",color:r="primary",label:e,labelPosition:t="right",className:n,style:v,...m})=>{const l=r&&(r.startsWith("var(")||r.includes("#")||r.includes("rgb"));return a.jsxs("div",{className:o("wim-spinner-container",e&&`wim-spinner--with-label-${t}`,n),role:"status","aria-live":"polite",style:{color:l?r:void 0,...v},...m,children:[a.jsxs("svg",{className:o("wim-spinner",`wim-spinner--${i}`,!l&&`wim-spinner--${r}`),viewBox:"0 0 50 50",fill:"none",xmlns:"http://www.w3.org/2000/svg",children:[a.jsx("circle",{className:"wim-spinner__track",cx:"25",cy:"25",r:"20",stroke:"currentColor",strokeWidth:"4"}),a.jsx("circle",{className:"wim-spinner__head",cx:"25",cy:"25",r:"20",stroke:"currentColor",strokeWidth:"4",strokeLinecap:"round",strokeDasharray:"126",strokeDashoffset:"100"})]}),e&&a.jsx("span",{className:"wim-spinner__label",children:e})]})};c.__docgenInfo={description:"読み込み中であることを示すための回転するインジケーター。",methods:[],displayName:"Spinner",props:{size:{required:!1,tsType:{name:"union",raw:'"sm" | "md" | "lg" | "xl"',elements:[{name:"literal",value:'"sm"'},{name:"literal",value:'"md"'},{name:"literal",value:'"lg"'},{name:"literal",value:'"xl"'}]},description:"",defaultValue:{value:'"md"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
