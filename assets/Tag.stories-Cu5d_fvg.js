import{j as r}from"./jsx-runtime-u17CrQMm.js";import{I as g}from"./IndicatorBase-BzoigwMY.js";import{I as m}from"./Icon-CMKyV0sw.js";import{A as d}from"./iframe-BZoygCoD.js";import{u}from"./useTranslation-CVcR0t5u.js";const a=({children:t,icon:e,...n})=>r.jsx(g,{prefixClass:"wim-tag",icon:e,...n,children:t});a.__docgenInfo={description:"カテゴリ分けや属性のラベルとして使用される非インタラクティブなコンポーネント。",methods:[],displayName:"Tag",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示するコンテンツ"},status:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
