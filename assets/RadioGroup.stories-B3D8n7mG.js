import{j as n}from"./jsx-runtime-u17CrQMm.js";import{R as s}from"./RadioGroup-CkgMuUhw.js";import{r as i}from"./iframe-C1RJDA45.js";const u={title:"Component/Selection Controls/RadioGroup",component:s,argTypes:{direction:{control:{type:"radio"},options:["vertical","horizontal"]}}},r=[{label:"Option 1",value:"opt1"},{label:"Option 2",value:"opt2"},{label:"Option 3",value:"opt3"}],e={args:{options:r,name:"default-group",defaultValue:"opt1"}},t={args:{options:r,direction:"horizontal",name:"horizontal-group",defaultValue:"opt1"}},a={args:{options:[{label:"Option 1",value:"opt1"},{label:"Option 2",value:"opt2",disabled:!0},{label:"Option 3",value:"opt3"}],name:"disabled-option-group",defaultValue:"opt1"}},o=()=>{const[l,p]=i.useState("opt1");return n.jsxs("div",{children:[n.jsxs("div",{style:{marginBottom:"1rem"},children:["Selected Value: ",l]}),n.jsx(s,{options:r,value:l,onChange:p,name:"controlled-group"})]})};o.__docgenInfo={description:"",methods:[],displayName:"Controlled"};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
