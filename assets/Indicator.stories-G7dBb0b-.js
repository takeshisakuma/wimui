import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as p}from"./index-D0GPwUjE.js";import{A as i}from"./Avatar-FlR7TxVC.js";import{I as f}from"./Icon-BJ9I8SuJ.js";import{A as b}from"./iframe-BCt2Cqzi.js";import{u as h}from"./useTranslation-iqmbh8MZ.js";const a=({children:e,color:o="primary",size:v="md",position:w="top-right",pulse:g=!1,inline:d=!1,className:x,style:y})=>{const u=o&&(o.startsWith("var(")||o.includes("#")||o.includes("rgb"));return r.jsxs("span",{className:p("wim-indicator",d&&"wim-indicator--inline",x),style:y,children:[e,r.jsx("span",{className:p("wim-indicator__dot",!u&&`wim-indicator__dot--${o}`,`wim-indicator__dot--${v}`,!d&&`wim-indicator__dot--${w}`,g&&"wim-indicator__dot--pulse"),style:{backgroundColor:u?o:void 0}})]})};a.__docgenInfo={description:"要素の状態（オンライン、未読、エラーなど）を示す小さなドットコンポーネント。",methods:[],displayName:"Indicator",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},color:{required:!1,tsType:{name:"union",raw:'"primary" | "success" | "error" | "warning" | "neutral" | WimColor',elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"neutral"'},{name:"union",raw:"T | (string & {})",elements:[{name:"union",raw:`| "var(--wim-color-primary)"
