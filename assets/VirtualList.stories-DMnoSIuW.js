import{j as r}from"./jsx-runtime-u17CrQMm.js";import{r as j,A as u}from"./iframe-Dmg4FORK.js";import{c as A}from"./index-Cg5poqOq.js";import{u as p}from"./useTranslation-CmZQbFUa.js";function a({items:n,itemHeight:e,height:t,renderItem:s,overscan:i=3,className:x,style:y,...b}){const[_,f]=j.useState(0),S=n.length*e,o=Math.max(0,Math.floor(_/e)-i),w=Math.min(n.length-1,Math.ceil((_+t)/e)+i),I=n.slice(o,w+1),L=o*e,T=g=>{f(g.target.scrollTop)};return r.jsx("div",{className:A("wim-virtual-list",x),style:{...y,height:t,overflowY:"auto"},onScroll:T,role:"list",...b,children:r.jsx("div",{className:"wim-virtual-list__inner",style:{height:S,position:"relative"},children:r.jsx("div",{className:"wim-virtual-list__viewport",style:{transform:`translateY(${L}px)`},children:I.map((g,v)=>r.jsx("div",{className:"wim-virtual-list__item",style:{height:e},role:"listitem","aria-setsize":n.length,"aria-posinset":o+v+1,children:s(g,o+v)},o+v))})})})}a.__docgenInfo={description:`大量のデータを効率よく表示するための仮想化リストコンポーネント。
...
}`,...c.parameters?.docs?.source}}};const N=["Default","LargeDataset","WithCustomItemHeight","WithOverscan"],C=Object.freeze(Object.defineProperty({__proto__:null,Default:l,LargeDataset:d,WithCustomItemHeight:m,WithOverscan:c,__namedExportsOrder:N,default:R},Symbol.toStringTag,{value:"Module"}));export{l as D,d as L,C as V,m as W,c as a};
