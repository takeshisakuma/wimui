import{j as e}from"./jsx-runtime-u17CrQMm.js";import{C as c}from"./Container-X2gv7N2r.js";import{B as a}from"./Box-CFs51jrL.js";import{u as i}from"./useTranslation-C_sUcuQ0.js";const f={title:"Components/Layout/Container",component:c,tags:[],argTypes:{size:{control:"select",options:["xs","sm","md","lg","xl"]}}},o={render:function(r){const{t:n}=i(["docs","common","components"]);return e.jsx(c,{...r,children:e.jsx(a,{bg:"#f0f0f0",p:20,style:{border:"1px solid #ccc"},children:n("story_container_content")})})},args:{bg:"#f9f9f9"}},t={render:function(){const{t:r}=i(["docs","common","components"]);return e.jsx("div",{style:{display:"flex",flexDirection:"column",gap:"20px"},children:["xs","sm","md","lg","xl"].map(n=>e.jsx(c,{size:n,bg:"#f8fafc",p:10,children:e.jsxs(a,{bg:"#eff6ff",p:10,style:{textAlign:"center",border:"1px dashed #3b82f6"},children:[r("story_container_size"),": ",n]})},n))})}},s={render:function(r){const{t:n}=i(["docs","common","components"]);return e.jsx(c,{...r,fluid:!0,children:e.jsx(a,{bg:"#eff6ff",p:20,style:{textAlign:"center",border:"1px dashed #3b82f6"},children:n("story_container_fluid")})})},args:{bg:"#f8fafc"}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
