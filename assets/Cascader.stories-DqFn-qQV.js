...
}`,...O.parameters?.docs?.source}}};const we=["Default","WithLabel","HoverExpand","Disabled","CustomSeparator"],je=Object.freeze(Object.defineProperty({__proto__:null,CustomSeparator:O,Default:x,Disabled:T,HoverExpand:S,WithLabel:A,__namedExportsOrder:we,default:ke},Symbol.toStringTag,{value:"Module"}));export{je as C,x as D,S as H,A as W,T as a,O as b};
