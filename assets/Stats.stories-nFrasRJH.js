import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as d}from"./index-MafWY-Pw.js";const a=({variant:t="default",className:n,children:s,...m})=>e.jsx("div",{className:d("wim-stats",`wim-stats--${t}`,n),...m,children:s}),u=({className:t,children:n,...s})=>e.jsx("div",{className:d("wim-stats__label",t),...s,children:n}),p=({className:t,children:n,...s})=>e.jsx("div",{className:d("wim-stats__value",t),...s,children:n}),h=({className:t,children:n,...s})=>e.jsx("div",{className:d("wim-stats__description",t),...s,children:n}),S=({direction:t="up",className:n,children:s,...m})=>e.jsxs("div",{className:d("wim-stats__trend",`wim-stats__trend--${t}`,n),...m,children:[e.jsxs("span",{className:"wim-stats__trend-icon",children:[t==="up"&&"↑",t==="down"&&"↓",t==="neutral"&&"→"]}),e.jsx("span",{className:"wim-stats__trend-value",children:s})]});a.Label=u;a.Value=p;a.Description=h;a.Trend=S;a.__docgenInfo={description:"`Stats` は統計情報やメトリクスを表示するためのコンポーネントです。",methods:[{name:"Label",docblock:null,modifiers:["static"],params:[{name:`{\r
    className,\r
    children,\r
    ...props\r
    ...
    direction?: "up" | "down" | "neutral";\r
}`,signature:{properties:[{key:"direction",value:{name:"union",raw:'"up" | "down" | "neutral"',elements:[{name:"literal",value:'"up"'},{name:"literal",value:'"down"'},{name:"literal",value:'"neutral"'}],required:!1}}]}}],alias:"StatsTrendProps"}}],returns:null}],displayName:"Stats",props:{variant:{required:!1,tsType:{name:"union",raw:'"default" | "outline" | "flat"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"outline"'},{name:"literal",value:'"flat"'}]},description:"バリアント",defaultValue:{value:'"default"',computed:!1}}}};u.__docgenInfo={description:"",methods:[],displayName:"StatsLabel"};p.__docgenInfo={description:"",methods:[],displayName:"StatsValue"};h.__docgenInfo={description:"",methods:[],displayName:"StatsDescription"};S.__docgenInfo={description:"",methods:[],displayName:"StatsTrend",props:{direction:{required:!1,tsType:{name:"union",raw:'"up" | "down" | "neutral"',elements:[{name:"literal",value:'"up"'},{name:"literal",value:'"down"'},{name:"literal",value:'"neutral"'}]},description:"",defaultValue:{value:'"up"',computed:!1}}}};const f={title:"Component/Data Display/Stats",component:a,parameters:{layout:"centered"},tags:[]},r={args:{children:e.jsxs(e.Fragment,{children:[e.jsx(a.Label,{children:"Total Users"}),e.jsx(a.Value,{children:"1,234"}),e.jsx(a.Description,{children:"+12.5% from last month"})]})}},l={args:{children:e.jsxs(e.Fragment,{children:[e.jsx(a.Label,{children:"Revenue"}),e.jsx(a.Value,{children:"$45,231.89"}),e.jsx(a.Trend,{direction:"up",children:"+20.1%"})]})}},o={args:{children:e.jsxs(e.Fragment,{children:[e.jsx(a.Label,{children:"Active Alerts"}),e.jsx(a.Value,{children:"12"}),e.jsx(a.Trend,{direction:"down",children:"-5%"})]})}},i={args:{variant:"outline",children:e.jsxs(e.Fragment,{children:[e.jsx(a.Label,{children:"Page Views"}),e.jsx(a.Value,{children:"12,456"}),e.jsx(a.Trend,{direction:"neutral",children:"0%"})]})}},c={args:{variant:"flat",children:e.jsxs(e.Fragment,{children:[e.jsx(a.Label,{children:"Avg. Session Time"}),e.jsx(a.Value,{children:"2m 34s"}),e.jsx(a.Description,{children:"Sessions over 5 minutes"})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    children: <>\r
...
}`,...c.parameters?.docs?.source}}};const v=["Default","WithTrend","NegativeTrend","Outline","Flat"],j=Object.freeze(Object.defineProperty({__proto__:null,Default:r,Flat:c,NegativeTrend:o,Outline:i,WithTrend:l,__namedExportsOrder:v,default:f},Symbol.toStringTag,{value:"Module"}));export{r as D,c as F,i as O,j as S,l as W};
