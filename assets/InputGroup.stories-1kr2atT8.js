import{j as e}from"./jsx-runtime-u17CrQMm.js";import{c as d}from"./index-BAMiKEDR.js";import{I as c}from"./Input-CmInB37J.js";import{B as l}from"./Button-DomQnHKu.js";const s=({children:r,fullWidth:i=!1,className:m})=>e.jsx("div",{className:d("wim-input-group",i&&"wim-input-group--full-width",m),children:r}),t=({children:r,className:i})=>e.jsx("span",{className:d("wim-input-group-text",i),children:r});s.__docgenInfo={description:"複数の入力要素やボタン、テキストを組み合わせて一つのユニットとして表示するコンポーネント。",methods:[],displayName:"InputGroup",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},fullWidth:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""}}};t.__docgenInfo={description:"InputGroup内でテキストやアイコンを表示するためのアドオンコンポーネント。",methods:[],displayName:"InputGroupText",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const h={title:"Component/Form Inputs/InputGroup",component:s,parameters:{layout:"centered"}},n={render:r=>e.jsxs(s,{...r,children:[e.jsx(t,{children:"@"}),e.jsx(c,{placeholder:"username"})]})},o={render:r=>e.jsxs(s,{...r,children:[e.jsx(c,{placeholder:"Search..."}),e.jsx(l,{priority:"primary",iconName:"SearchIcon",label:"Search"})]})},a={render:r=>e.jsxs(s,{...r,children:[e.jsx(c,{placeholder:"Recipient's username"}),e.jsx(t,{children:"@example.com"})]})},p={render:r=>e.jsxs(s,{...r,children:[e.jsx(t,{children:"$"}),e.jsx(t,{children:"0.00"}),e.jsx(c,{placeholder:"Price"}),e.jsx(t,{children:".00"})]})},u={args:{fullWidth:!0},render:r=>e.jsx("div",{style:{width:"600px"},children:e.jsxs(s,{...r,children:[e.jsx(t,{children:"Search"}),e.jsx(c,{placeholder:"Type something..."}),e.jsx(l,{priority:"primary",label:"Go"})]})})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
