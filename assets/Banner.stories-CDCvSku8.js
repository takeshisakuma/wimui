import{j as e}from"./jsx-runtime-u17CrQMm.js";import{R as T}from"./iframe-BSv3CQ2B.js";import{P as n}from"./index-CogSwlJB.js";import{I as f}from"./Icon-DyvtjtDA.js";import{u as j}from"./useTranslation-BmmjQ9nD.js";import{B as w}from"./Button-3HkaewL4.js";const g=({title:m,description:p,variant:v="info",icon:d=!0,action:y,onClose:b,className:_="",children:u,...x})=>{const{t:h}=j(),N=()=>d?T.isValidElement(d)?d:v==="success"?e.jsx(f,{name:"CheckIcon",size:"small"}):e.jsx(f,{name:"CircleIcon",size:"small"}):null;return e.jsx("div",{className:["wim-banner",`wim-banner--${v}`,_].filter(Boolean).join(" "),role:"banner",...x,children:e.jsxs("div",{className:"wim-banner__container",children:[e.jsxs("div",{className:"wim-banner__content",children:[d&&e.jsx("div",{className:"wim-banner__icon",children:N()}),e.jsxs("div",{className:"wim-banner__text",children:[m&&e.jsx("span",{className:"wim-banner__title",children:h(m)}),m&&(p||u)&&e.jsx("span",{className:"wim-banner__separator",children:" - "}),(p||u)&&e.jsx("span",{className:"wim-banner__description",children:p?h(p):u})]})]}),e.jsxs("div",{className:"wim-banner__actions",children:[y&&e.jsx("div",{className:"wim-banner__action",children:y}),b&&e.jsx("button",{type:"button",className:"wim-banner__close",onClick:b,"aria-label":"Close",children:e.jsx(f,{name:"CloseIcon",size:"small"})})]})]})})};g.propTypes={title:n.string,description:n.string,variant:n.oneOf(["info","success","warning","error"]),icon:n.oneOfType([n.bool,n.node]),action:n.node,onClose:n.func,className:n.string,children:n.node};g.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。\r
