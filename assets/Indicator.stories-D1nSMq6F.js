import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as p}from"./index-Ckw0h7AD.js";import{A as l}from"./Avatar-Bxk5P7gS.js";import{u as f}from"./useTranslation-BH3LN071.js";const a=({children:e,color:o="primary",size:v="medium",position:x="top-right",pulse:g=!1,inline:d=!1,className:y,style:w})=>{const u=o&&(o.startsWith("var(")||o.includes("#")||o.includes("rgb"));return r.jsxs("span",{className:p("wim-indicator",d&&"wim-indicator--inline",y),style:w,children:[e,r.jsx("span",{className:p("wim-indicator__dot",!u&&`wim-indicator__dot--${o}`,`wim-indicator__dot--${v==="small"?"sm":v==="large"?"lg":"md"}`,!d&&`wim-indicator__dot--${x}`,g&&"wim-indicator__dot--pulse"),style:{backgroundColor:u?o:void 0}})]})};a.__docgenInfo={description:"要素の状態（オンライン、未読、エラーなど）を示す小さなドットコンポーネント。",methods:[],displayName:"Indicator",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},color:{required:!1,tsType:{name:"union",raw:'"primary" | "success" | "error" | "warning" | "neutral" | WimColor',elements:[{name:"literal",value:'"primary"'},{name:"literal",value:'"success"'},{name:"literal",value:'"error"'},{name:"literal",value:'"warning"'},{name:"literal",value:'"neutral"'},{name:"union",raw:"T | (string & {})",elements:[{name:"union",raw:`| "var(--color-destructive)"\r
...
}`,...m.parameters?.docs?.source}}};const b=["Default","Colors","Pulse","Inline","Sizes","WithIcons"],k=Object.freeze(Object.defineProperty({__proto__:null,Colors:t,Default:n,Inline:s,Pulse:i,Sizes:c,WithIcons:m,__namedExportsOrder:b,default:h},Symbol.toStringTag,{value:"Module"}));export{t as C,n as D,k as I,i as P,c as S,s as a};
