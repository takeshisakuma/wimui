import{j as e}from"./jsx-runtime-u17CrQMm.js";import{B as s}from"./BaseListItem-DITYqeU5.js";import{I as m}from"./Icon-DG-VY8Tp.js";import{C as g}from"./Chip-Ccq3dX58.js";import{A as d}from"./iframe-DD-5vQ8N.js";import{u as l}from"./useTranslation-BGm1MMYI.js";const p={title:"Components/Internal/BaseListItem",component:s,parameters:{layout:"centered"}},r={render:function(n){const{t}=l(d);return e.jsx(s,{...n,children:n.children||t("standard_list_item")})},args:{style:{width:"240px"}}},a={render:function(n){const{t}=l(d);return e.jsx(s,{...n,icon:e.jsx(m,{name:"EditIcon"}),children:t("home")})},args:{...r.args}},o={render:function(n){const{t}=l(d);return e.jsx(s,{...n,icon:e.jsx(m,{name:"SettingsIcon"}),rightSection:e.jsx(m,{name:"ChevronRightIcon",size:"small"}),children:t("a11y_settings")})},args:{...r.args}},i={render:function(n){const{t}=l(d);return e.jsx(s,{...n,icon:e.jsx(m,{name:"BellIcon"}),rightSection:e.jsx(g,{size:"small",children:t("new")}),children:t("notifications")})},args:{...r.args}},c={render:function(n){const{t}=l(d);return e.jsxs("div",{style:{width:"240px",display:"flex",flexDirection:"column",gap:"4px"},children:[e.jsx(s,{...n,children:t("home")}),e.jsx(s,{...n,active:!0,children:t("profile")}),e.jsx(s,{...n,disabled:!0,children:t("a11y_settings")}),e.jsx(s,{...n,danger:!0,icon:e.jsx(m,{name:"TrashIcon"}),children:t("a11y_delete")})]})}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  ...
  render: function Render(args) {
    ...
    return <BaseListItem {...args} icon={<Icon name="BellIcon" />} rightSection={<Chip size="small">{t("new")}</Chip>}>
        {t("notifications")}
      </BaseListItem>;
  },
  args: {
