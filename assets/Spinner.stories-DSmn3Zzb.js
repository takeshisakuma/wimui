import{j as r}from"./jsx-runtime-u17CrQMm.js";import{S as n}from"./Spinner-BLJxqxO1.js";const l={title:"Components/Loading States/Spinner",component:n,tags:[],argTypes:{color:{control:"select",options:["primary","secondary","success","warning","error","neutral","currentColor"]},size:{control:"select",options:["small","medium","large","xlarge"]},labelPosition:{control:"radio",options:["right","bottom"]}}},s={args:{label:"Loading..."},render:e=>r.jsx(n,{...e})},o={render:e=>r.jsxs("div",{style:{display:"flex",gap:"24px",alignItems:"center"},children:[r.jsx(n,{...e,color:"primary"}),r.jsx(n,{...e,color:"secondary"}),r.jsx(n,{...e,color:"success"}),r.jsx(n,{...e,color:"warning"}),r.jsx(n,{...e,color:"error"}),r.jsx(n,{...e,color:"neutral"})]})},a={render:e=>r.jsxs("div",{style:{display:"flex",gap:"24px",alignItems:"center"},children:[r.jsx(n,{...e,size:"small"}),r.jsx(n,{...e,size:"medium"}),r.jsx(n,{...e,size:"large"}),r.jsx(n,{...e,size:"xlarge"})]})},i={render:e=>r.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"32px"},children:[r.jsx(n,{...e,label:"Loading right...",labelPosition:"right"}),r.jsx(n,{...e,label:"Loading bottom...",labelPosition:"bottom"})]})};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    label: "Loading..."
  },
