"use client";
import{a as e,i as t,s as n}from"./preload-helper-CT_b8DTk.js";import{t as r}from"./react-DmCNssFd.js";import{Cr as i,Sr as a,Tr as o,ur as s,xr as c}from"./iframe-wf1-Tomv.js";import{n as l,t as u}from"./TagInput-DTpY3cvz.js";var d=e({Controlled:()=>g,Default:()=>h,Disabled:()=>v,MaxTags:()=>_,__namedExportsOrder:()=>y,default:()=>m}),f,p,m,h,g,_,v,y,b=t((()=>{f=n(r(),1),i(),a(),l(),p=s(),m={title:`Components/Advanced Inputs/TagInput`,component:u,parameters:{layout:`centered`}},h={render:e=>{let{t}=o(c);return(0,p.jsx)(u,{...e,placeholder:t(`story.taginput_placeholder_default`),defaultValue:[`React`,`TypeScript`,`SCSS`]})}},g={render:()=>{let{t:e}=o(c),[t,n]=f.useState([`WIM UI`,`Premium`,`Modern`]);return(0,p.jsxs)(`div`,{style:{display:`flex`,flexDirection:`column`,gap:`var(--wim-spacing-md)`},children:[(0,p.jsxs)(`p`,{style:{margin:0,fontSize:`var(--wim-font-size-sm)`,color:`var(--wim-color-text-secondary)`},children:[e(`story.taginput_current_tags`),` `,t.join(`, `)]}),(0,p.jsx)(u,{value:t,onChange:n,placeholder:`frontend`})]})}},_={render:e=>{let{t}=o(c);return(0,p.jsx)(u,{...e,maxTags:5,placeholder:t(`story.taginput_placeholder_max`),defaultValue:[`One`,`Two`,`Three`]})}},v={args:{disabled:!0,defaultValue:[`Locked`,`Tags`]}},y=[`Default`,`Controlled`,`MaxTags`,`Disabled`],h.parameters={...h.parameters,docs:{...h.parameters?.docs,source:{originalSource:`{
  render: args => {
    const {
      t
...
}`,...v.parameters?.docs?.source}}}}));b();export{g as Controlled,h as Default,v as Disabled,_ as MaxTags,y as __namedExportsOrder,m as default,b as n,d as t};