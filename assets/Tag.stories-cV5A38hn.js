import{j as e}from"./jsx-runtime-u17CrQMm.js";import{I as u}from"./IndicatorBase-9y2_k8Jp.js";import{I as _}from"./Icon-DKMNswuj.js";import{u as l}from"./useTranslation-CTezHt8M.js";const o=({children:a,icon:s,...n})=>e.jsx(u,{prefixClass:"wim-tag",icon:s,...n,children:a});o.__docgenInfo={description:"カテゴリ分けや属性のラベルとして使用される非インタラクティブなコンポーネント。",methods:[],displayName:"Tag",props:{children:{required:!1,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:"表示するコンテンツ"},status:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
