...
| "separator"`,elements:[{name:"literal",value:'"bold"'},{name:"literal",value:'"italic"'},{name:"literal",value:'"underline"'},{name:"literal",value:'"strikethrough"'},{name:"literal",value:'"h1"'},{name:"literal",value:'"h2"'},{name:"literal",value:'"h3"'},{name:"literal",value:'"ul"'},{name:"literal",value:'"ol"'},{name:"literal",value:'"link"'},{name:"literal",value:'"unlink"'},{name:"literal",value:'"removeFormat"'},{name:"literal",value:'"separator"'}]}],raw:"RichTextEditorToolbarItem[]"},description:"",defaultValue:{value:`[
  ...
  "separator",
  "removeFormat",
]`,computed:!1}},"aria-label":{required:!1,tsType:{name:"string"},description:""},"aria-labelledby":{required:!1,tsType:{name:"string"},description:""}}};const fe={title:"Components/Basic Inputs/RichTextEditor",component:p,argTypes:{status:{control:{type:"select"},options:["default","error","disabled"]},variant:{control:{type:"select"},options:["outline","ghost"]},fullWidth:{control:{type:"boolean"}}}},v={render:function(a){const{t:r}=x(f);return e.jsx(p,{...a,label:r("story_rte_label_content"),placeholder:r("story_rte_placeholder_default")})}},g={render:function(a){const{t:r}=x(f);return e.jsx(p,{...a,label:r("story_rte_label_article"),defaultValue:`<h2>${r("story_rte_default_heading")}</h2><p>${r("story_rte_default_body")}</p>`})}},k={render:function(a){const{t:r}=x(f),[h,b]=o.useState(`<p>${r("story_rte_controlled_initial")}</p>`);return e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"16px"},children:[e.jsx(p,{...a,label:r("story_rte_label_content"),value:h,onChange:b}),e.jsxs("div",{children:[e.jsx("strong",{children:r("story_rte_output_label")}),e.jsx("pre",{style:{fontSize:"0.75rem",whiteSpace:"pre-wrap",wordBreak:"break-all",padding:"8px",background:"var(--wim-color-surface-variant)",borderRadius:"4px"},children:h})]})]})}},j={render:function(a){const{t:r}=x(f);return e.jsx(p,{...a,label:r("story_rte_label_content"),status:"error",error:r("story_rte_error_required"),placeholder:r("story_rte_placeholder_default")})}},C={render:function(a){const{t:r}=x(f);return e.jsx(p,{...a,label:r("story_rte_label_content"),disabled:!0,defaultValue:`<p>${r("story_rte_disabled_content")}</p>`})}},T={render:function(a){const{t:r}=x(f);return e.jsx(p,{...a,label:r("story_rte_label_note"),variant:"ghost",placeholder:r("story_rte_placeholder_default")})}},S={render:function(a){const{t:r}=x(f);return e.jsx(p,{...a,label:r("story_rte_label_article"),fullWidth:!0,placeholder:r("story_rte_placeholder_default")})}},R={render:function(a){const{t:r}=x(f);return e.jsx(p,{...a,label:r("story_rte_label_comment"),toolbar:["bold","italic","underline","separator","link"],placeholder:r("story_rte_placeholder_comment")})}};v.parameters={...v.parameters,docs:{...v.parameters?.docs,source:{originalSource:`{
