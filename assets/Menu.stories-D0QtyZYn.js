import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as N,R as v}from"./iframe-C-4JLACx.js";import{c as p}from"./index-HB-Qm5fy.js";import{T as w}from"./Transition-Nf0ZMRg0.js";import{I as a}from"./Icon-D6zGy4PL.js";const _=v.createContext({expandedItems:new Set,toggleItem:()=>{}}),m=({children:s,className:o,mode:r="vertical",defaultOpenKeys:l=[]})=>{const[u,d]=N.useState(new Set(l)),i=c=>{d(y=>{const t=new Set(y);return t.has(c)?t.delete(c):t.add(c),t})};return e.jsx(_.Provider,{value:{expandedItems:u,toggleItem:i},children:e.jsx("ul",{className:p("wim-menu",`wim-menu--${r}`,o),role:"menu",children:s})})},n=({children:s,onClick:o,disabled:r=!1,className:l,icon:u})=>{const d=i=>{i.stopPropagation(),!r&&o&&o()};return e.jsxs("li",{className:p("wim-menu-item",r&&"wim-menu-item--disabled",l),onClick:d,role:"menuitem",tabIndex:r?-1:0,"aria-disabled":r,onKeyDown:i=>{!r&&(i.key==="Enter"||i.key===" ")&&(i.preventDefault(),d(i))},children:[u&&e.jsx("span",{className:"wim-menu-item__icon",children:u}),e.jsx("span",{className:"wim-menu-item__content",children:s})]})},S=({children:s,title:o,className:r})=>e.jsxs("li",{className:p("wim-menu-item-group",r),children:[o&&e.jsx("div",{className:"wim-menu-item-group__title",children:o}),e.jsx("ul",{className:"wim-menu-item-group__list",role:"group",children:s})]}),b=({children:s,title:o,className:r,icon:l,itemKey:u})=>{const{expandedItems:d,toggleItem:i}=v.useContext(_),c=d.has(u),y=t=>{t.stopPropagation(),i(u)};return e.jsxs("li",{className:p("wim-menu-submenu",c&&"wim-menu-submenu--open",r),children:[e.jsxs("div",{className:"wim-menu-submenu__title",onClick:y,role:"menuitem","aria-haspopup":"true","aria-expanded":c,tabIndex:0,onKeyDown:t=>{(t.key==="Enter"||t.key===" ")&&(t.preventDefault(),y(t))},children:[l&&e.jsx("span",{className:"wim-menu-item__icon",children:l}),e.jsx("span",{className:"wim-menu-item__content",children:o}),e.jsx("span",{className:p("wim-menu-submenu__arrow",c&&"wim-menu-submenu__arrow--open"),children:e.jsx(a,{name:"ChevronRightIcon",size:"small"})})]}),e.jsx(w,{show:c,enter:"fade-enter",enterFrom:"fade-enter-from",enterTo:"fade-enter-to",leave:"fade-leave",leaveFrom:"fade-leave-from",leaveTo:"fade-leave-to",className:"wim-menu-submenu__list",role:"menu",children:e.jsx("ul",{className:"wim-menu-submenu__list",children:s})})]})},C=({className:s})=>e.jsx("li",{className:p("wim-menu-divider",s),role:"separator"});m.__docgenInfo={description:"",methods:[],displayName:"Menu",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""},mode:{required:!1,tsType:{name:"union",raw:'"vertical" | "horizontal" | "inline"',elements:[{name:"literal",value:'"vertical"'},{name:"literal",value:'"horizontal"'},{name:"literal",value:'"inline"'}]},description:"Mode of the menu",defaultValue:{value:'"vertical"',computed:!1}},defaultSelectedKeys:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"Default selected keys"},defaultOpenKeys:{required:!1,tsType:{name:"Array",elements:[{name:"string"}],raw:"string[]"},description:"Default opened submenu keys",defaultValue:{value:"[]",computed:!1}}}};n.__docgenInfo={description:"",methods:[],displayName:"MenuItem",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},onClick:{required:!1,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},className:{required:!1,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},itemKey:{required:!1,tsType:{name:"string"},description:"Unique key for this item"}}};S.__docgenInfo={description:"",methods:[],displayName:"MenuItemGroup",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},title:{required:!1,tsType:{name:"string"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};b.__docgenInfo={description:"",methods:[],displayName:"SubMenu",props:{children:{required:!0,tsType:{name:"ReactNode"},description:""},title:{required:!0,tsType:{name:"ReactNode"},description:""},className:{required:!1,tsType:{name:"string"},description:""},icon:{required:!1,tsType:{name:"ReactNode"},description:""},itemKey:{required:!0,tsType:{name:"string"},description:"Unique key for this submenu"}}};C.__docgenInfo={description:"",methods:[],displayName:"MenuDivider",props:{className:{required:!1,tsType:{name:"string"},description:""}}};const z={title:"Components/Overlays/Menu",component:m,parameters:{layout:"centered"}},I={render:s=>e.jsxs(m,{...s,children:[e.jsx(n,{children:"Home"}),e.jsx(n,{children:"About"}),e.jsx(n,{children:"Services"}),e.jsx(n,{children:"Contact"})]})},M={render:s=>e.jsxs(m,{...s,children:[e.jsx(n,{icon:e.jsx(a,{name:"CheckIcon",size:"small"}),children:"Dashboard"}),e.jsx(n,{icon:e.jsx(a,{name:"CopyIcon",size:"small"}),children:"Projects"}),e.jsx(n,{icon:e.jsx(a,{name:"CloseIcon",size:"small"}),children:"Settings"})]})},h={render:s=>e.jsxs(m,{...s,defaultOpenKeys:["sub1"],children:[e.jsx(n,{icon:e.jsx(a,{name:"CheckIcon",size:"small"}),children:"Dashboard"}),e.jsxs(b,{itemKey:"sub1",title:"Products",icon:e.jsx(a,{name:"CopyIcon",size:"small"}),children:[e.jsx(n,{children:"Product 1"}),e.jsx(n,{children:"Product 2"}),e.jsx(n,{children:"Product 3"})]}),e.jsxs(b,{itemKey:"sub2",title:"Services",icon:e.jsx(a,{name:"CloseIcon",size:"small"}),children:[e.jsx(n,{children:"Service A"}),e.jsx(n,{children:"Service B"})]}),e.jsx(n,{children:"Contact"})]})},x={render:s=>e.jsxs(m,{...s,children:[e.jsxs(S,{title:"Main Pages",children:[e.jsx(n,{children:"Home"}),e.jsx(n,{children:"About"}),e.jsx(n,{children:"Contact"})]}),e.jsx(C,{}),e.jsxs(S,{title:"User Actions",children:[e.jsx(n,{children:"Profile"}),e.jsx(n,{children:"Settings"}),e.jsx(n,{children:"Logout"})]})]})},j={render:s=>e.jsxs(m,{...s,mode:"horizontal",children:[e.jsx(n,{children:"Home"}),e.jsx(n,{children:"About"}),e.jsx(n,{children:"Services"}),e.jsx(n,{children:"Contact"})]})},g={render:s=>e.jsxs(m,{...s,mode:"inline",defaultOpenKeys:["sub1"],children:[e.jsx(n,{icon:e.jsx(a,{name:"CheckIcon",size:"small"}),children:"Dashboard"}),e.jsxs(b,{itemKey:"sub1",title:"Settings",icon:e.jsx(a,{name:"CopyIcon",size:"small"}),children:[e.jsx(n,{children:"Profile Settings"}),e.jsx(n,{children:"Account Settings"}),e.jsx(n,{children:"Privacy Settings"})]}),e.jsx(n,{icon:e.jsx(a,{name:"CloseIcon",size:"small"}),children:"Logout"})]})},f={render:s=>e.jsxs(m,{...s,children:[e.jsx(n,{children:"Active Item"}),e.jsx(n,{disabled:!0,children:"Disabled Item"}),e.jsx(n,{children:"Another Active Item"})]})};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  ...
  render: args => <Menu {...args}>\r
      ...
      <MenuItem icon={<Icon name="CopyIcon" size="small" />}>Projects</MenuItem>\r
  ...
  render: args => <Menu {...args} mode="inline" defaultOpenKeys={["sub1"]}>\r
      ...
      <MenuItem icon={<Icon name="CloseIcon" size="small" />}>Logout</MenuItem>\r
    </Menu>
