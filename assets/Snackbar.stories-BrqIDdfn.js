...
}`,...f.parameters?.docs?.source}}};const K=["Default","WithAction","WithCloseButton","Success","ErrorStatus","Warning","Info","InteractiveDemo"],os=Object.freeze(Object.defineProperty({__proto__:null,Default:d,ErrorStatus:_,Info:g,InteractiveDemo:f,Success:m,Warning:p,WithAction:u,WithCloseButton:l,__namedExportsOrder:K,default:J},Symbol.toStringTag,{value:"Module"}));export{d as D,_ as E,g as I,os as S,u as W,l as a,m as b,p as c,f as d};
