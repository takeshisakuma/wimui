    ...
    return <div style={{
      ...
      borderRadius: "8px"
        ...
        marginBottom: "10px"
          ...
          <p>\r
            このグレーの枠線内は <strong>overflow: hidden</strong> です。\r
          </p>\r
        ...
        {show && <Portal>\r
          ...
          animation: "popUp 0.3s ease-out"
            ...
            lineHeight: "1.5"
                ...
                私は親要素の <code>overflow: hidden</code>{" "}\r
                を無視して、画面の右下に独立して表示されています。\r
              </p>\r
              <div style={{
            marginTop: "12px",
            textAlign: "right"
        ...
        <div className="notification-grid">\r
          <Stack gap="md">\r
            ...
            color: "#666"
              ...
              各コンポーネントの状態変更が、右側のモニタリングエリアに Portal\r
              経由で通知されます。\r
            </p>\r
...
\r
                ...
                color: "#94a3b8"
                    ...
                    ※リスト上の別のタスクに切り替えても、再選択すれば入力内容は保持されています（コンポーネントが破棄されていないため）。\r
                  </p>\r
                </Stack>\r
              </div>\r
            </Portal>}\r
