        ...
        <Table.Body>
          {sampleData.slice(0, 2).map(row => <Table.Row key={row.id}>
              ...
              justifyContent: "flex-start"
                  ...
                  <IconButton iconName="TrashIcon" aria-label={t("story_dropdown_delete")} size="small" priority="tertiary" intent="destructive" />
                </div>
              </Table.Cell>
            </Table.Row>)}
        </Table.Body>
