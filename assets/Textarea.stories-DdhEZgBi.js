import{j as e}from"./jsx-runtime-u17CrQMm.js";import{P as t}from"./index-CK2Sb_AK.js";import{L as p}from"./Label-1ck9eLLu.js";import{F as f}from"./FieldError-BHlHiYNp.js";const r=({state:a="default",variant:x="outline",fullWidth:h=!1,className:g="",disabled:v,...m})=>{const b=`wim-textarea--${a}`,y=`wim-textarea--${x}`,j=h?"wim-textarea--full-width":"";return e.jsx("textarea",{className:["wim-textarea",b,y,j,m.fieldSizing==="content"?"wim-textarea--field-sizing-content":"",g].filter(Boolean).join(" "),disabled:v||a==="disabled",...m})};r.propTypes={state:t.oneOf(["default","error","disabled"]),variant:t.oneOf(["outline","ghost"]),fullWidth:t.bool,className:t.string,fieldSizing:t.oneOf(["fixed","content"])};r.__docgenInfo={description:"複数行のテキスト入力を受け付けるコンポーネント。",methods:[],displayName:"Textarea",props:{state:{required:!1,tsType:{name:"union",raw:'"default" | "error" | "disabled"',elements:[{name:"literal",value:'"default"'},{name:"literal",value:'"error"'},{name:"literal",value:'"disabled"'}]},description:"入力フィールドの状態。",defaultValue:{value:'"default"',computed:!1},type:{name:"enum",value:[{value:'"default"',computed:!1},{value:'"error"',computed:!1},{value:'"disabled"',computed:!1}]}},variant:{required:!1,tsType:{name:"union",raw:'"outline" | "ghost"',elements:[{name:"literal",value:'"outline"'},{name:"literal",value:'"ghost"'}]},description:"入力フィールドのデザインバリエーション。",defaultValue:{value:'"outline"',computed:!1},type:{name:"enum",value:[{value:'"outline"',computed:!1},{value:'"ghost"',computed:!1}]}},fullWidth:{required:!1,tsType:{name:"boolean"},description:"横幅を100%にするかどうか。",defaultValue:{value:"false",computed:!1},type:{name:"bool"}},fieldSizing:{required:!1,tsType:{name:"union",raw:'"fixed" | "content"',elements:[{name:"literal",value:'"fixed"'},{name:"literal",value:'"content"'}]},description:"テキストエリアのサイズ調整方法。",type:{name:"enum",value:[{value:'"fixed"',computed:!1},{value:'"content"',computed:!1}]}},className:{defaultValue:{value:'""',computed:!1},description:"追加のクラス名。",type:{name:"string"},required:!1}}};const S={title:"Component/Forms/Textarea",component:r,argTypes:{state:{control:{type:"select"},options:["default","error","disabled"]},variant:{control:{type:"select"},options:["outline","ghost"]},fullWidth:{control:{type:"boolean"}},fieldSizing:{control:{type:"select"},options:["fixed","content"]}}},l={args:{placeholder:"テキストを入力してください..."}},n={args:{variant:"ghost",placeholder:"Ghost Variant..."}},s={args:{state:"error",defaultValue:"エラーが発生しています"}},o={args:{state:"disabled",defaultValue:"無効化された入力エリア"}},i={args:{fullWidth:!0,placeholder:"幅いっぱいに広がります..."}},d={args:{fieldSizing:"content",placeholder:"入力内容に合わせて高さが変わります..."}},c={render:a=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"4px",maxWidth:"400px"},children:[e.jsx(p,{htmlFor:"comment",required:!0,label:"コメント",children:e.jsx(r,{id:"comment",...a})}),a.state==="error"&&e.jsx(f,{content:"入力内容をご確認ください。"})]}),args:{placeholder:"ご意見・ご要望を入力してください",rows:4,fullWidth:!0}},u={render:()=>e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"24px",maxWidth:"500px"},children:[e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[e.jsx(p,{htmlFor:"description",required:!0,label:"自己紹介"}),e.jsx(r,{id:"description",placeholder:"詳細は...",rows:3,fullWidth:!0})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"8px"},children:[e.jsx(p,{htmlFor:"notes",label:"備考",showOptional:!0}),e.jsx(r,{id:"notes",placeholder:"その他連絡事項があれば...",rows:2,fullWidth:!0})]}),e.jsxs("div",{style:{display:"flex",flexDirection:"column",gap:"4px"},children:[e.jsx(p,{htmlFor:"feedback",required:!0,label:"フィードバック",children:e.jsx(r,{id:"feedback",state:"error",defaultValue:"短すぎます",rows:3,fullWidth:!0})}),e.jsx(f,{content:"10文字以上で入力してください。"})]})]})};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  args: {
