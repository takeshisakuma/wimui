import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as S}from"./index-D2yuEKMw.js";import{F as v}from"./FeedbackIcon-CrLUssnu.js";import{F as x}from"./FeedbackCloseButton-Bb3FRM0Z.js";import{B as y}from"./Button-QGSE8HgO.js";import{A as a}from"./iframe-DxE0GiY5.js";import{u as o}from"./useTranslation-CHwI6HGF.js";const s=({title:t,description:e,intent:n="info",icon:f=!0,extra:g,onClose:R,className:N,children:b,...A})=>r.jsx("div",{className:S("wim-banner",`wim-banner--${n}`,N),role:"banner",...A,children:r.jsxs("div",{className:"wim-banner__container",children:[r.jsxs("div",{className:"wim-banner__content",children:[f!==!1&&r.jsx("div",{className:"wim-banner__icon",children:r.jsx(v,{intent:n,icon:typeof f=="boolean"?void 0:f,size:"sm"})}),r.jsxs("div",{className:"wim-banner__text",children:[t&&r.jsx("span",{className:"wim-banner__title",children:t}),t&&(e||b)&&r.jsx("span",{className:"wim-banner__separator",children:" - "}),(e||b)&&r.jsx("span",{className:"wim-banner__description",children:e||b})]})]}),r.jsxs("div",{className:"wim-banner__actions",children:[g&&r.jsx("div",{className:"wim-banner__action",children:g}),r.jsx(x,{onClose:R,className:"wim-banner__close",size:"sm"})]})]})});s.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。
