      ...
      gap: "2rem"
        ...
        <div>
          ...
          marginBottom: "1rem"
            ...
            <Button variant="filled" onClick={() => setAudioKey(prev => prev + 1)} label={t("story.audio_premium_features_reload")} icon="RefreshIcon" />
          </div>
