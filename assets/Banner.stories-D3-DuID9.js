import{j as n}from"./jsx-runtime-u17CrQMm.js";import{c as w}from"./index-30w8ikAG.js";import{F as N}from"./FeedbackIcon-B6IHT8oS.js";import{F as B}from"./FeedbackCloseButton-DN74YLwz.js";import{u as o}from"./useTranslation-ZF4WB21B.js";import{B as g}from"./Button-DhroN8PM.js";const s=({title:t,description:r,status:e="info",icon:p=!0,extra:f,onClose:x,className:R,children:b,...j})=>{const{t:y}=o();return n.jsx("div",{className:w("wim-banner",`wim-banner--${e}`,R),role:"banner",...j,children:n.jsxs("div",{className:"wim-banner__container",children:[n.jsxs("div",{className:"wim-banner__content",children:[p!==!1&&n.jsx("div",{className:"wim-banner__icon",children:n.jsx(N,{status:e,icon:typeof p=="boolean"?void 0:p,size:"small"})}),n.jsxs("div",{className:"wim-banner__text",children:[t&&n.jsx("span",{className:"wim-banner__title",children:y(t)}),t&&(r||b)&&n.jsx("span",{className:"wim-banner__separator",children:" - "}),(r||b)&&n.jsx("span",{className:"wim-banner__description",children:r?y(r):b})]})]}),n.jsxs("div",{className:"wim-banner__actions",children:[f&&n.jsx("div",{className:"wim-banner__action",children:f}),n.jsx(B,{onClose:x,className:"wim-banner__close",size:"small"})]})]})})};s.__docgenInfo={description:`重要なメッセージやアクションをユーザーに提示するためのバナーコンポーネント。
