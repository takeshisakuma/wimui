import{j as n}from"./jsx-runtime-u17CrQMm.js";import{r as t,A as o}from"./iframe-Bn5mqC8Q.js";import{B as R}from"./Button-xp1wFFLS.js";import{c as N}from"./index-K9UxIAwh.js";import{F as G}from"./FeedbackIcon-FHHOVuFE.js";import{F as J}from"./FeedbackCloseButton-Dc1gI0Km.js";import{u as i}from"./useTranslation-Cn4N2seM.js";const r=({message:a,open:e=!1,intent:s="default",position:_="bottom-center",autoHideDuration:u=5e3,showCloseButton:M=!1,actionLabel:w,onAction:A,onClose:S,className:B})=>{const[P,k]=t.useState(!1),[q,h]=t.useState(!1),[I,O]=t.useState(e);e!==I&&(O(e),e?h(!0):k(!1)),t.useEffect(()=>{if(e){const c=setTimeout(()=>k(!0),10);return()=>clearTimeout(c)}else{const c=setTimeout(()=>h(!1),300);return()=>clearTimeout(c)}},[e]);const y=t.useCallback(()=>{k(!1),setTimeout(()=>{S&&S()},300)},[S]),[T,D]=t.useState(u),[V,x]=t.useState(()=>Date.now()),[E,L]=t.useState(!1);t.useEffect(()=>{if(e&&u>0&&!E){const c=setTimeout(()=>{y()},T);return x(Date.now()),()=>clearTimeout(c)}},[e,u,y,E,T]);const C=()=>{if(u>0){L(!0);const c=Date.now()-V;D($=>Math.max(0,$-c))}},j=()=>{u>0&&(x(Date.now()),L(!1))},W=()=>{A&&A()};if(!q&&!e)return null;const F=s==="error"||s==="warning"?"alert":"status",z=s==="error"||s==="warning"?"assertive":"polite";return n.jsx("div",{className:N("wim-snackbar-wrapper",`wim-snackbar-wrapper--${_}`),children:n.jsxs("div",{className:N("wim-snackbar",`wim-snackbar--${s}`,P&&"wim-snackbar--visible",B),role:F,"aria-live":z,onMouseEnter:C,onMouseLeave:j,onFocus:C,onBlur:j,children:[n.jsxs("div",{className:"wim-snackbar__content",children:[s!=="default"&&n.jsx("div",{className:"wim-snackbar__icon",children:n.jsx(G,{intent:s,size:"sm"})}),n.jsx("span",{className:"wim-snackbar__message",children:a})]}),n.jsxs("div",{className:"wim-snackbar__actions",children:[w&&n.jsx(R,{variant:"ghost",size:"sm",onClick:W,className:"wim-snackbar__action-button",children:w}),n.jsx(J,{onClose:M?y:void 0,className:"wim-snackbar__close-button",size:"sm"})]})]})})};t.createContext(void 0);r.__docgenInfo={description:"ユーザーに短いメッセージを通知するためのスナックバーコンポーネント。",methods:[],displayName:"Snackbar",props:{message:{required:!0,tsType:{name:"string"},description:"スナックバーに表示するメッセージ"},open:{required:!1,tsType:{name:"boolean"},description:"表示状態",defaultValue:{value:"false",computed:!1}},intent:{required:!1,tsType:{name:"union",raw:`| "primary"
| "secondary"
| "success"
| "warning"
| "error"
...
}`,...v.parameters?.docs?.source}}};const Q=["Default","WithAction","WithCloseButton","Success","ErrorStatus","Warning","Info","InteractiveDemo"],ne=Object.freeze(Object.defineProperty({__proto__:null,Default:l,ErrorStatus:g,Info:b,InteractiveDemo:v,Success:p,Warning:f,WithAction:m,WithCloseButton:d,__namedExportsOrder:Q,default:K},Symbol.toStringTag,{value:"Module"}));export{g as E,b as I,ne as S,f as W,p as a};
