import{j as t}from"./jsx-runtime-u17CrQMm.js";import{c as d}from"./index-DWoaxWMs.js";const c=({children:s,block:a=!1,language:n,className:l})=>{const i=a?"pre":"code";return t.jsx(i,{className:d("wim-code",a?"wim-code--block":"wim-code--inline",n&&`language-${n}`,l),children:a?t.jsx("code",{className:n&&`language-${n}`,children:s}):s})};c.__docgenInfo={description:"",methods:[],displayName:"Code",props:{children:{required:!0,tsType:{name:"ReactReactNode",raw:"React.ReactNode"},description:""},block:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},language:{required:!1,tsType:{name:"string"},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const p={title:"Component/Data Display/Code",component:c,parameters:{layout:"centered"},argTypes:{block:{control:"boolean"},language:{control:"text"}}},e={args:{children:"const x = 10;",block:!1}},o={args:{children:`function helloWorld() {
