import{j as n}from"./jsx-runtime-u17CrQMm.js";import{r as _,R as z,A as F}from"./iframe-Ctdkiilp.js";import{c as C}from"./index-DSjzljfy.js";import{F as $}from"./FieldTemplate-Cv_dN3Mm.js";import{u as D}from"./useTranslation-BTb00TCF.js";const S=({length:r=6,value:o="",onChange:u,disabled:b=!1,error:y,required:j,label:T,layout:A,className:E})=>{const{t:q}=D(["components"]),[l,p]=_.useState(Array(r).fill("")),[O,L]=_.useState(o),c=_.useRef([]),w=`wim-otp-input-${z.useId()}`,N=T?`${w}-label`:void 0,I=y?`${w}-error`:void 0;if(o!==O){L(o);const a=o.split("").slice(0,r),e=Array(r).fill("").map((t,s)=>a[s]||"");p(e)}const h=a=>{const e=a.join("");u&&u(e)},P=(a,e)=>{const s=a.target.value.slice(-1),d=[...l];d[e]=s,p(d),h(d),s&&e<r-1&&c.current[e+1]?.focus()},k=(a,e)=>{if(a.key==="Backspace"){if(!l[e]&&e>0){const t=[...l];t[e-1]="",p(t),h(t),c.current[e-1]?.focus()}else if(l[e]){const t=[...l];t[e]="",p(t),h(t)}}else a.key==="ArrowLeft"&&e>0?(a.preventDefault(),c.current[e-1]?.focus()):a.key==="ArrowRight"&&e<r-1&&(a.preventDefault(),c.current[e+1]?.focus())},R=a=>{a.preventDefault();const t=a.clipboardData.getData("text").slice(0,r).split(""),s=[...l];t.forEach((M,V)=>{V<r&&(s[V]=M)}),p(s),h(s);const d=Math.min(t.length,r-1);c.current[d]?.focus()};return n.jsx($,{label:T,error:y,required:j,layout:A,labelId:N,errorId:I,className:E,children:n.jsx("div",{className:"wim-otp-input-wrapper",children:n.jsx("div",{className:C("wim-otp-input-container",b&&"wim-otp-input-container--disabled"),children:Array.from({length:r}).map((a,e)=>n.jsx("input",{id:e===0?w:void 0,ref:t=>{c.current[e]=t},className:C("wim-otp-input",y&&"wim-otp-input--error",b&&"wim-otp-input--disabled"),type:"text",maxLength:1,value:l[e],onChange:t=>P(t,e),onKeyDown:t=>k(t,e),onPaste:R,disabled:b,"aria-label":q("otp_digit",{index:e+1}),"aria-invalid":!!y,"aria-describedby":I},e))})})})};S.__docgenInfo={description:"OTP（ワンタイムパスワード）入力用コンポーネント。",methods:[],displayName:"OtpInput",props:{length:{required:!1,tsType:{name:"number"},description:"",defaultValue:{value:"6",computed:!1}},value:{required:!1,tsType:{name:"string"},description:"",defaultValue:{value:'""',computed:!1}},onChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(value: string) => void",signature:{arguments:[{type:{name:"string"},name:"value"}],return:{name:"void"}}},description:""},disabled:{required:!1,tsType:{name:"boolean"},description:"",defaultValue:{value:"false",computed:!1}},error:{required:!1,tsType:{name:"string"},description:""},required:{required:!1,tsType:{name:"boolean"},description:""},label:{required:!1,tsType:{name:"string"},description:""},layout:{required:!1,tsType:{name:"union",raw:'"vertical" | "horizontal"',elements:[{name:"literal",value:'"vertical"'},{name:"literal",value:'"horizontal"'}]},description:""},className:{required:!1,tsType:{name:"string"},description:""}}};const x={title:"Components/Basic Inputs/OtpInput",component:S,args:{disabled:!1},argTypes:{disabled:{control:"boolean"},onChange:{action:"changed"}}},m={args:{length:4}},f={args:{length:6}},g={args:{length:4,disabled:!0,value:"1234"}},v={args:{length:6,error:"Invalid code",value:"123456"}},i=()=>{const{t:r}=D(F),[o,u]=_.useState("");return n.jsxs("div",{children:[n.jsx(S,{value:o,onChange:u,length:6}),n.jsxs("p",{style:{marginTop:"1rem"},children:[r("story_otp_current_value"),": ",o]}),n.jsx("button",{onClick:()=>u(""),style:{marginTop:"0.5rem"},children:r("story_otp_clear")})]})};i.__docgenInfo={description:"",methods:[],displayName:"Controlled"};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    length: 4
  }
