  ...
  render: args => <Drawer {...args}>\r
      ...
      <DrawerContent>\r
        <DrawerHeader>\r
          ...
          <DrawerDescription>Sliding in from the left side.</DrawerDescription>\r
        </DrawerHeader>\r
        <div style={{
        padding: "20px"
      }}>\r
  ...
  render: args => <Drawer {...args}>\r
      ...
      <DrawerContent>\r
        <DrawerHeader>\r
          ...
          <DrawerDescription>Sliding in from the top.</DrawerDescription>\r
        </DrawerHeader>\r
        <div style={{
        padding: "20px"
      }}>\r
  ...
  render: args => <Drawer {...args}>\r
      ...
      <DrawerContent>\r
        <DrawerHeader>\r
          ...
          <DrawerDescription>Sliding in from the bottom.</DrawerDescription>\r
        </DrawerHeader>\r
        <div style={{
        padding: "20px"
      }}>\r
  ...
  render: args => <Drawer {...args}>\r
      ...
      <DrawerContent>\r
        ...
        padding: "20px"
          ...
          <p>\r
            The slideIn and slideOut options are set to false, so the drawer\r
            only fades in and out along with the overlay.\r
          </p>\r
        </div>\r
        <DrawerFooter>\r
          <DrawerClose asChild>\r
