"use client";
import{a as e,i as t}from"./preload-helper-CT_b8DTk.js";import{t as n}from"./react-DmCNssFd.js";import{Cr as r,br as i,cr as a,xr as o,yr as s}from"./iframe-F5Up1IQq.js";import{t as c,zn as l}from"./src-Ssuy8lr7.js";import{t as u}from"./Button-Dps1MPAd.js";var d=e({Danger:()=>v,Default:()=>m,DescriptionOnly:()=>x,Info:()=>h,LongContent:()=>S,NoIcon:()=>C,Success:()=>g,Warning:()=>_,WithAction:()=>y,WithCloseAndAction:()=>b,__namedExportsOrder:()=>w,default:()=>p}),f,p,m,h,g,_,v,y,b,x,S,C,w,T=t((()=>{n(),o(),i(),c(),f=a(),p={title:`Components/Alerts & Notifications/Banner`,component:l,tags:[],argTypes:{onClose:{action:`closed`},icon:{control:`boolean`},intent:{control:`select`,options:[`default`,`info`,`success`,`warning`,`danger`]}},parameters:{layout:`fullscreen`}},m={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_cookie_title`),description:e.description||t(`story.banner_cookie_desc`)})},args:{intent:`default`}},h={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_update_title`),description:e.description||t(`story.banner_update_desc`)})},args:{intent:`info`}},g={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.alert_success_title`),description:e.description||t(`story.banner_update_desc`)})},args:{intent:`success`}},_={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_maint_title`),description:e.description||t(`story.banner_maint_desc`)})},args:{intent:`warning`}},v={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_conn_error_title`),description:e.description||t(`story.banner_conn_error_desc`),onClose:e.onClose??(()=>{})})},args:{intent:`danger`}},y={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_cookie_title`),description:e.description||t(`story.banner_cookie_desc`),extra:(0,f.jsx)(u,{size:`sm`,variant:`outline`,children:t(`story.banner_btn_accept`)})})},args:{intent:`info`}},b={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_trial_title`),description:e.description||t(`story.banner_trial_desc`),extra:(0,f.jsx)(u,{size:`sm`,variant:`solid`,children:t(`story.banner_btn_upgrade`)}),onClose:e.onClose??(()=>{})})},args:{intent:`warning`}},x={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,description:e.description||t(`story.banner_no_title_desc`)})},args:{intent:`info`}},S={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_maint_title`),description:e.description||t(`story.banner_long_desc`)})},args:{intent:`warning`}},C={render:function(e){let{t}=r(s);return(0,f.jsx)(l,{...e,title:e.title||t(`story.banner_simple_title`),description:e.description||t(`story.banner_simple_desc`),icon:!1})},args:{intent:`info`}},m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
...
}`,...C.parameters?.docs?.source}}},w=[`Default`,`Info`,`Success`,`Warning`,`Danger`,`WithAction`,`WithCloseAndAction`,`DescriptionOnly`,`LongContent`,`NoIcon`]}));T();export{v as Danger,m as Default,x as DescriptionOnly,h as Info,S as LongContent,C as NoIcon,g as Success,_ as Warning,y as WithAction,b as WithCloseAndAction,w as __namedExportsOrder,p as default,T as n,d as t};