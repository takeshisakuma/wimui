import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as _}from"./index-BgvlPezX.js";import{u as a}from"./useTranslation-oYtfLuBR.js";const t=({size:o="medium",content:e,cite:s,color:d="black",border:p=!0,className:g,...y})=>{const{t:m}=a();return r.jsxs("blockquote",{className:_("wim-quote",`wim-quote--${o==="small"?"sm":o==="large"?"lg":"md"}`,`wim-quote--${d}`,p&&"wim-quote--border",g),...y,children:[r.jsx("div",{className:"wim-quote__content",children:m(e)}),s&&r.jsx("cite",{className:"wim-quote__cite",children:m(s)})]})};t.__docgenInfo={description:"",methods:[],displayName:"Quote",props:{size:{required:!1,tsType:{name:"union",raw:'"small" | "medium" | "large"',elements:[{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
