import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as g}from"./index-Dz-H0ba_.js";import{L as x}from"./Link-cv57Jjlm.js";import{I as f}from"./Icon-Dymv0mT2.js";import{u as t}from"./useTranslation-R4wwOoyb.js";const c=({items:n,separator:a,size:e="medium",className:h})=>{const{t:b}=t(),v=r.jsx(f,{name:"ChevronRightIcon",size:e,className:"wim-breadcrumb__separator-icon"}),N=o=>{const _=o.currentTarget,s=Array.from(_.querySelectorAll(".wim-breadcrumb__link, .wim-breadcrumb__label--current")),y=s.indexOf(document.activeElement);if(y!==-1){if(o.key==="ArrowRight"){o.preventDefault();const p=(y+1)%s.length;s[p].focus()}else if(o.key==="ArrowLeft"){o.preventDefault();const p=(y-1+s.length)%s.length;s[p].focus()}}};return r.jsx("nav",{"aria-label":b("a11y_breadcrumb"),className:g("wim-breadcrumb",`wim-breadcrumb--${e==="small"?"sm":e==="large"?"lg":"md"}`,h),onKeyDown:N,children:r.jsx("ol",{className:"wim-breadcrumb__list",children:n.map((o,_)=>{const s=_===n.length-1;return r.jsxs("li",{className:"wim-breadcrumb__item",children:[r.jsx("div",{className:"wim-breadcrumb__content",children:o.href&&!s?r.jsx(x,{href:o.href,size:e,priority:"secondary",iconName:o.iconName,className:"wim-breadcrumb__link",children:b(o.label)}):r.jsxs("span",{className:g("wim-breadcrumb__label",s&&"wim-breadcrumb__label--current"),"aria-current":s?"page":void 0,tabIndex:s?0:void 0,role:s?"link":void 0,children:[o.iconName&&r.jsx(f,{name:o.iconName,size:e,className:"wim-breadcrumb__label-icon"}),b(o.label)]})}),!s&&r.jsx("span",{className:"wim-breadcrumb__separator","aria-hidden":"true",children:a||v})]},_)})})})};c.__docgenInfo={description:"",methods:[],displayName:"Breadcrumb",props:{items:{required:!0,tsType:{name:"Array",elements:[{name:"signature",type:"object",raw:`{
  label: string;
  href?: string;
