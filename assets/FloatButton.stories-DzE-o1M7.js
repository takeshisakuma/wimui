import{j as e}from"./jsx-runtime-u17CrQMm.js";import{r as x}from"./iframe-Dzm9idsv.js";import{c as j}from"./index-BpsP6pOz.js";import{I as V}from"./Icon-DdY3T4lx.js";import{u as l}from"./useTranslation-BfYXAya8.js";import{A as c}from"./i18nConstants-fBKvcUJT.js";const r=({iconName:t="CircleIcon",variant:a="default",shape:o="circle",size:i="medium",label:s,shrink:N=!1,position:A="bottom-right",description:_,badge:S,backTop:n=!1,visibilityHeight:C=400,className:T,style:E,onClick:k,"aria-label":q,...B})=>{const{t:I}=l(),[L,F]=x.useState(()=>n?typeof window<"u"?(window.pageYOffset||document.documentElement.scrollTop)>C:!1:!0),z=x.useCallback(()=>{if(n){const w=window.pageYOffset||document.documentElement.scrollTop;F(w>C)}},[n,C]);x.useEffect(()=>{if(n)return window.addEventListener("scroll",z),()=>window.removeEventListener("scroll",z)},[n,z]);const P=w=>{n&&window.scrollTo({top:0,behavior:"smooth"}),k?.(w)};return!L&&n?null:e.jsxs("button",{type:"button",className:j("wim-float-button",`wim-float-button--${a}`,`wim-float-button--${o}`,`wim-float-button--${i==="small"?"sm":i==="large"?"lg":"md"}`,`wim-float-button--${A}`,s&&"wim-float-button--extended",N&&"wim-float-button--shrink",T),style:E,onClick:P,title:_?I(_):void 0,"aria-label":q||(s?I(s):t),...B,children:[e.jsxs("span",{className:"wim-float-button__inner",children:[e.jsx(V,{name:n?"ChevronDownIcon":t,size:i,className:j(n&&"wim-float-button__icon--backtop")}),s&&e.jsx("span",{className:"wim-float-button__label-wrapper",children:e.jsx("span",{className:"wim-float-button__label",children:I(s)})}),S&&e.jsx("span",{className:j(S===!0?"wim-float-button__badge--dot":"wim-float-button__badge"),children:typeof S=="number"?S:""})]}),_&&e.jsx("span",{className:"wim-float-button__description",children:I(_)})]})};r.__docgenInfo={description:"",methods:[],displayName:"FloatButton",props:{iconName:{required:!1,tsType:{name:"union",raw:`| "CircleIcon"\r
| "SquareIcon"\r
| "LoadingIcon"\r
| "ExternalLinkIcon"\r
| "ArrowUpIcon"\r
