import{j as t}from"./jsx-runtime-u17CrQMm.js";import{R as g}from"./iframe-B4b1QYqI.js";import{c as Re}from"./index-Dz-H0ba_.js";import{T as Ie,a as Te,b as Q,c as he,d as ze,e as X}from"./Table-CVsnBu5G.js";import{C as fe}from"./Checkbox-BUHgEPjR.js";import{P as Ae}from"./Pagination-DCZrD5kZ.js";import{S as _e}from"./Spinner-ZHpPlpWP.js";import{E as qe}from"./EmptyState-DdpvWGSp.js";import{u as U}from"./useTranslation-R4wwOoyb.js";import{B as ge}from"./Badge-BoG-pKUS.js";import{B as Y}from"./Button-dW8UAzVq.js";import{I as ee}from"./Icon-Dymv0mT2.js";function Ge(e,n){return!n||e==="none"?"asc":e==="asc"?"desc":"none"}function l({columns:e,rows:n,loading:s=!1,selection:r=!1,selectedRowKeys:d=[],onSelectionChange:c,rowKey:y="id",sortConfig:u,onSort:x,pagination:_,loadMore:m,striped:D=!1,bordered:k=!1,hoverable:te=!0,stickyHeader:b=!1,height:j,maxHeight:ae,mobileCard:ne=!1,className:re,emptyMessage:Z,a11y_select_all_rows:J}){const{t:se}=U(["components","common"]),oe=Z??se("datagrid_empty"),we=J??se("a11y_select_all_rows"),[S,T]=g.useState({row:-1,col:r?-1:0}),ye=g.useRef(null),ie=g.useRef(null);g.useEffect(()=>{if(!m||!m.hasMore||m.loading)return;const a=new IntersectionObserver(o=>{o[0].isIntersecting&&m.onLoadMore()},{threshold:m.threshold||.1});return ie.current&&a.observe(ie.current),()=>a.disconnect()},[m]);const pe=a=>typeof y=="function"?y(a):a[y],xe=a=>{c&&c(a?n.map(o=>pe(o)):[])},Se=(a,o)=>{c&&c(o?[...d,a]:d.filter(p=>p!==a))},be=a=>{if(!x)return;const o=Ge(u?.direction||"none",u?.key===a);x(a,o)},ve=n.length>0&&d.length===n.length,De=d.length>0&&d.length<n.length,de=k?1:0,ce={};let le=r?48+de:0,ke=20;e.forEach(a=>{if(a.fixed===!0||a.fixed==="left"){ce[a.key]={offset:le===0?0:`${le}px`,zIndex:ke--};let o=0;typeof a.width=="number"?o=a.width:typeof a.width=="string"&&a.width.endsWith("px")&&(o=parseInt(a.width,10)),le+=o+de}});const ue={};let me=0,Ce=20;[...e].reverse().forEach(a=>{if(a.fixed==="right"){ue[a.key]={offset:me===0?0:`${me}px`,zIndex:Ce--};let o=0;typeof a.width=="number"?o=a.width:typeof a.width=="string"&&a.width.endsWith("px")&&(o=parseInt(a.width,10)),me+=o+de}});const je=a=>{const{row:o,col:p}=S;let h=o,i=p;const f=r?-1:0,R=e.length-1,z=-1,A=n.length-1;switch(a.key){case"ArrowRight":p<R&&i++;break;case"ArrowLeft":p>f&&i--;break;case"ArrowDown":o<A&&h++;break;case"ArrowUp":o>z&&h--;break;case"Home":a.ctrlKey&&(h=z),i=f;break;case"End":a.ctrlKey&&(h=A),i=R;break;case"Enter":case" ":{const C=document.activeElement;if(C?.getAttribute("role")==="columnheader")return;if(C?.classList.contains("wim-table__cell")){const q=C.querySelector('input, button, [role="button"]');q&&(q.click(),a.preventDefault())}return}default:return}(h!==o||i!==p)&&(a.preventDefault(),T({row:h,col:i}),setTimeout(()=>{ye.current?.querySelector(`[data-row="${h}"][data-col="${i}"]`)?.focus()},0))};return t.jsxs("div",{ref:ye,className:Re("wim-datagrid",s&&"wim-datagrid--loading",re),role:"grid",tabIndex:0,onKeyDown:je,children:[t.jsxs("div",{className:"wim-datagrid__container",children:[t.jsxs(Ie,{striped:D,bordered:k,hoverable:te,stickyHeader:b,fullWidth:!0,height:j,maxHeight:ae,mobileCard:ne,children:[t.jsx(Te,{children:t.jsxs(Q,{children:[r&&t.jsx(he,{selection:!0,stickyLeft:!0,leftOffset:0,stickyZIndex:b?121:21,"data-row":-1,"data-col":-1,tabIndex:S.row===-1&&S.col===-1?0:-1,onFocus:()=>T({row:-1,col:-1}),children:t.jsx(fe,{checked:ve,indeterminate:De,onChange:a=>xe(a.target.checked),"aria-label":we,tabIndex:-1})}),e.map((a,o)=>{const p=a.fixed===!0||a.fixed==="left",h=a.fixed==="right",i=p?ce[a.key]:void 0,f=h?ue[a.key]:void 0;return t.jsx(he,{style:{width:a.width,minWidth:a.width,maxWidth:a.width,textAlign:a.align},sortable:a.sortable,sortDirection:u?.key===a.key?u.direction:"none",onSort:()=>be(a.key),stickyLeft:p,leftOffset:i?.offset,stickyRight:h,rightOffset:f?.offset,stickyZIndex:i?b?i.zIndex+100:i.zIndex:f?b?f.zIndex+100:f.zIndex:void 0,"data-row":-1,"data-col":o,tabIndex:S.row===-1&&S.col===o?0:-1,onFocus:()=>T({row:-1,col:o}),children:a.header},a.key)})]})}),t.jsxs(ze,{children:[n.length===0&&!s?t.jsx(Q,{children:t.jsx(X,{colSpan:e.length+(r?1:0),children:t.jsx("div",{className:"wim-datagrid__empty",children:typeof oe=="string"?t.jsx(qe,{title:"No Data",description:oe}):oe})})}):n.map((a,o)=>{const p=pe(a),h=d.includes(p);return t.jsxs(Q,{selected:h,children:[r&&t.jsx(X,{selection:!0,stickyLeft:!0,leftOffset:0,stickyZIndex:21,"data-row":o,"data-col":-1,tabIndex:S.row===o&&S.col===-1?0:-1,onFocus:()=>T({row:o,col:-1}),children:t.jsx(fe,{checked:h,onChange:i=>Se(p,i.target.checked),"aria-label":se("datagrid_select_row",{index:o+1}),tabIndex:-1})}),e.map((i,f)=>{const R=i.dataIndex?a[i.dataIndex]:a[i.key],z=i.fixed===!0||i.fixed==="left",A=i.fixed==="right",C=z?ce[i.key]:void 0,q=A?ue[i.key]:void 0;return t.jsx(X,{style:{minWidth:i.width,maxWidth:i.width,textAlign:i.align},label:typeof i.header=="string"?i.header:void 0,stickyLeft:z,leftOffset:C?.offset,stickyRight:A,rightOffset:q?.offset,stickyZIndex:C?.zIndex||q?.zIndex,"data-row":o,"data-col":f,tabIndex:S.row===o&&S.col===f?0:-1,onFocus:()=>T({row:o,col:f}),children:i.render?i.render(R,a,o):R},i.key)})]},p)}),m&&m.hasMore&&t.jsx(Q,{children:t.jsx(X,{colSpan:e.length+(r?1:0),children:t.jsx("div",{ref:ie,className:"wim-datagrid__loader",children:m.loading&&t.jsx(_e,{size:"small"})})})})]})]}),s&&t.jsx("div",{className:"wim-datagrid__loading-overlay",children:t.jsx(_e,{size:"large"})})]}),_&&t.jsx("div",{className:"wim-datagrid__footer",children:t.jsx(Ae,{total:_.total,pageSize:_.pageSize,current:_.current,onChange:_.onPageChange})})]})}l.__docgenInfo={description:"",methods:[],displayName:"DataGrid",props:{columns:{required:!0,tsType:{name:"Array",elements:[{name:"DataGridColumn",elements:[{name:"T"}],raw:"DataGridColumn<T>"}],raw:"DataGridColumn<T>[]"},description:"Column definitions"},rows:{required:!0,tsType:{name:"Array",elements:[{name:"T"}],raw:"T[]"},description:"Data rows"},loading:{required:!1,tsType:{name:"boolean"},description:"Loading state",defaultValue:{value:"false",computed:!1}},selection:{required:!1,tsType:{name:"boolean"},description:"Whether to show selection checkboxes",defaultValue:{value:"false",computed:!1}},selectedRowKeys:{required:!1,tsType:{name:"Array",elements:[{name:"ReactKey",raw:"React.Key"}],raw:"React.Key[]"},description:"Array of selected row keys",defaultValue:{value:"[]",computed:!1}},onSelectionChange:{required:!1,tsType:{name:"signature",type:"function",raw:"(selectedRowKeys: React.Key[]) => void",signature:{arguments:[{type:{name:"Array",elements:[{name:"ReactKey",raw:"React.Key"}],raw:"React.Key[]"},name:"selectedRowKeys"}],return:{name:"void"}}},description:"Callback when selection changes"},rowKey:{required:!1,tsType:{name:"union",raw:"keyof T | ((row: T) => React.Key)",elements:[{name:"T"},{name:"unknown"}]},description:"Unique key for each row",defaultValue:{value:'"id"',computed:!1}},sortConfig:{required:!1,tsType:{name:"signature",type:"object",raw:'{ key: string; direction: "asc" | "desc" | "none" }',signature:{properties:[{key:"key",value:{name:"string",required:!0}},{key:"direction",value:{name:"union",raw:'"asc" | "desc" | "none"',elements:[{name:"literal",value:'"asc"'},{name:"literal",value:'"desc"'},{name:"literal",value:'"none"'}],required:!0}}]}},description:"Current sort configuration"},onSort:{required:!1,tsType:{name:"signature",type:"function",raw:'(key: string, direction: "asc" | "desc" | "none") => void',signature:{arguments:[{type:{name:"string"},name:"key"},{type:{name:"union",raw:'"asc" | "desc" | "none"',elements:[{name:"literal",value:'"asc"'},{name:"literal",value:'"desc"'},{name:"literal",value:'"none"'}]},name:"direction"}],return:{name:"void"}}},description:"Callback when sorting changes"},pagination:{required:!1,tsType:{name:"signature",type:"object",raw:`{\r
  total: number;\r
  pageSize: number;\r
  current: number;\r
