import{j as a}from"./jsx-runtime-u17CrQMm.js";import{c as j}from"./index-DmsXWWEZ.js";import{I as N}from"./Icon-DG-VY8Tp.js";import{u as o}from"./useTranslation-BGm1MMYI.js";import{A as t}from"./iframe-DD-5vQ8N.js";const n=({size:e="medium",content:r="span",color:l="black",weight:b="normal",fontStyle:A="normal",iconName:S=void 0,iconPosition:h="left",decoration:f="none",className:E,style:L,...z})=>{const{t:P}=o(),T={"ex-small":"xs",small:"sm",medium:"md",large:"lg","ex-large":"xl"},C={"ex-small":"small",small:"small",medium:"medium",large:"large","ex-large":"large"}[e]||"medium",x=S?a.jsx(N,{name:S,size:C}):null,M=a.jsxs(a.Fragment,{children:[S&&h==="left"&&x,a.jsx("span",{children:P(r)}),S&&h==="right"&&x]}),_=l&&(l.startsWith("var(")||l.includes("#")||l.includes("rgb"));return a.jsx("span",{className:j("wim-span",`wim-span--${T[e]}`,!_&&`wim-span--${l}`,b==="bold"&&"wim-span--bold",A==="italic"&&"wim-span--italic",f!=="none"&&`wim-span--${f}`,E),style:{color:_?l:void 0,...L},...z,children:M})};n.__docgenInfo={description:"",methods:[],displayName:"Span",props:{size:{required:!1,tsType:{name:"union",raw:'"ex-small" | "small" | "medium" | "large" | "ex-large"',elements:[{name:"literal",value:'"ex-small"'},{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'},{name:"literal",value:'"ex-large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
