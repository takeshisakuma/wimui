import{I as o}from"./Icon-DIpFMY3W.js";import"./jsx-runtime-D_zvdyIk.js";import"./index-ml2n-spZ.js";import"./iframe-C2TPIdbu.js";const{fn:a}=__STORYBOOK_MODULE_TEST__,m={title:"Component/Icon",component:o,parameters:{layout:"centered"},tags:["autodocs"],argTypes:{color:{control:{type:"radio"},options:["semantic-danger","semantic-success","semantic-warning","semantic-primary","semantic-secondary"]},backgroundColor:{control:"color"}},args:{onClick:a()}},e={args:{name:"SquareIcon",size:"medium",color:"semantic-primary"}},r={args:{name:"CircleIcon",size:"large",color:"semantic-danger"}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    name: "SquareIcon",
    size: "medium",
