import{j as e}from"./jsx-runtime-u17CrQMm.js";import{S as t}from"./Stats-CLBiJikz.js";import{A as d}from"./iframe-GzHoau5L.js";import{u as l}from"./useTranslation-Ckw9ivsw.js";const S={title:"Components/Data Structures/Stats",component:t,parameters:{layout:"centered"},tags:[]},a={render:function(r){const{t:s}=l(d);return e.jsxs(t,{...r,children:[e.jsx(t.Label,{children:s("story.stats_total_users")}),e.jsx(t.Value,{children:"1,234"}),e.jsx(t.Description,{children:s("story.stats_desc_users")})]})}},n={render:function(r){const{t:s}=l(d);return e.jsxs(t,{...r,children:[e.jsx(t.Label,{children:s("story.stats_revenue")}),e.jsx(t.Value,{children:"$45,231.89"}),e.jsx(t.Trend,{direction:"up",children:"+20.1%"})]})}},o={render:function(r){const{t:s}=l(d);return e.jsxs(t,{...r,children:[e.jsx(t.Label,{children:s("story.stats_active_alerts")}),e.jsx(t.Value,{children:"12"}),e.jsx(t.Trend,{direction:"down",children:"-5%"})]})}},c={render:function(r){const{t:s}=l(d);return e.jsxs(t,{...r,variant:"outline",children:[e.jsx(t.Label,{children:s("story.stats_page_views")}),e.jsx(t.Value,{children:"12,456"}),e.jsx(t.Trend,{direction:"neutral",children:"0%"})]})}},i={render:function(r){const{t:s}=l(d);return e.jsxs(t,{...r,variant:"flat",children:[e.jsx(t.Label,{children:s("story.stats_avg_session")}),e.jsx(t.Value,{children:"2m 34s"}),e.jsx(t.Description,{children:s("story.stats_desc_session")})]})}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
