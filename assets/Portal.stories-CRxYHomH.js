...
}`,...t.parameters?.docs?.source},description:{story:"特定の DOM 要素へのレンダリング例",...t.parameters?.docs?.description}}};const l=["OverflowEscape","CustomContainer"],f=Object.freeze(Object.defineProperty({__proto__:null,CustomContainer:t,OverflowEscape:r,__namedExportsOrder:l,default:a},Symbol.toStringTag,{value:"Module"}));export{t as C,r as O,f as P};
