import{j as r}from"./jsx-runtime-u17CrQMm.js";import{c as d}from"./index-HB-Qm5fy.js";import{u as g}from"./useTranslation-BFGhrLDt.js";const c=({size:e="medium",content:a="text",color:t="black",weight:i="normal",lineHeight:m="normal-latn",fontStyle:u="normal",decoration:l="none",className:o,...s})=>{const{t:n}=g(),p=l!=="none"?r.jsx("span",{className:`wim-paragraph--${l}`,children:n(a)}):n(a);return r.jsx("p",{className:d("wim-paragraph",`wim-paragraph--${e==="ex-small"?"xs":e==="small"?"sm":e==="large"?"lg":e==="ex-large"?"xl":"md"}`,`wim-paragraph--${m}`,i==="bold"&&"wim-paragraph--bold",u==="italic"&&"wim-paragraph--italic",`wim-paragraph--${t}`,o),...s,children:p})};c.__docgenInfo={description:"",methods:[],displayName:"Paragraph",props:{size:{required:!1,tsType:{name:"union",raw:'"ex-small" | "small" | "medium" | "large" | "ex-large"',elements:[{name:"literal",value:'"ex-small"'},{name:"literal",value:'"small"'},{name:"literal",value:'"medium"'},{name:"literal",value:'"large"'},{name:"literal",value:'"ex-large"'}]},description:"",defaultValue:{value:'"medium"',computed:!1}},color:{required:!1,tsType:{name:"union",raw:`| "black"
| "deepgray"
| "gray"
| "lightgray"
| "white"
