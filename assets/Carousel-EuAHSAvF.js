import{j as s}from"./jsx-runtime-u17CrQMm.js";import{useMDXComponents as i}from"./index-D7JioatO.js";import{M as l,C as d,a as h}from"./index-BKFBczYz.js";import{C as c,B as x,M as j,R as t,A as o,N as a,W as p}from"./Carousel.stories-bHyGKdwo.js";import{T as u}from"./T-nsot-ahh.js";import"./iframe-CSw8miVe.js";import"./preload-helper-PPVm8Dsz.js";import"./index-B01WBnR_.js";import"./index-o37wOg_n.js";import"./index-DTYd7l1E.js";import"./index-CqnWhT4T.js";import"./index-DXEgh6kp.js";import"./index-DVluPYyD.js";import"./Icon-BhAkmYKE.js";import"./imagesanple-VDI2Kzk_.js";import"./useTranslation-DbtuPNOy.js";function e(r){const n={code:"code",h1:"h1",h2:"h2",h3:"h3",hr:"hr",li:"li",p:"p",pre:"pre",ul:"ul",...i(),...r.components};return s.jsxs(s.Fragment,{children:[s.jsx(l,{of:c}),`
`,s.jsx(n.h1,{id:"carousel",children:"Carousel"}),`
`,s.jsx("p",{style:{margin:"0 0 16px 0",fontSize:"18px",lineHeight:"28px",color:"#6c757d"},children:s.jsx(u,{k:"doc_carousel_title"})}),`
...
`,s.jsxs("table",{children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{children:"要件"}),s.jsx("th",{children:"詳細"})]})}),s.jsxs("tbody",{children:[s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"移動ボタン"})}),s.jsx("td",{children:"左右の矢印ボタンやスワイプ操作で前後に移動できること。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"インジケーター"})}),s.jsx("td",{children:"現在位置を示し、特定のスライドへ直接ジャンプできること（ドットなど）。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"自動回転の制御"})}),s.jsx("td",{children:"ユーザーが操作中は一時停止する、または停止ボタンを提供する。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"ループ機能"})}),s.jsx("td",{children:"最後のスライドから最初に戻るシームレスなループ。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"キーボード操作"})}),s.jsx("td",{children:"矢印キーで移動できるなど、アクセシビリティへの配慮。"})]})]})]}),`
`,s.jsx(n.h2,{id:"実装採用時のポイント",children:"実装・採用時のポイント"}),`
`,s.jsxs("table",{children:[s.jsx("thead",{children:s.jsxs("tr",{children:[s.jsx("th",{children:"ポイント"}),s.jsx("th",{children:"詳細"})]})}),s.jsxs("tbody",{children:[s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"コンテンツの吟味"})}),s.jsx("td",{children:"テーマを統一し、スライド枚数は3〜5枚程度に抑える。重要な情報は1枚目に。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"レスポンシブ対応"})}),s.jsx("td",{children:"PCでは複数カラム、SPでは1カラムなど、デバイスに応じた表示。"})]}),s.jsxs("tr",{children:[s.jsx("td",{children:s.jsx("strong",{children:"直感的な操作性"})}),s.jsx("td",{children:"「スワイプできそう」「クリックできそう」な視覚的アフォーダンスを提供する。"})]})]})]})]})}function L(r={}){const{wrapper:n}={...i(),...r.components};return n?s.jsx(n,{...r,children:s.jsx(e,{...r})}):e(r)}export{L as default};
