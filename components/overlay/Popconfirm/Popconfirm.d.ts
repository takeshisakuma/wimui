...
export declare const Popconfirm: ({ title, description, onConfirm, onCancel, okText, cancelText, okType, children, icon, disabled, }: PopconfirmProps) => React.JSX.Element;
