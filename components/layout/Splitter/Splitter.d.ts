...
declare const Splitter: {
    ({ orientation, className, children, ...props }: SplitterProps): React.JSX.Element;
    displayName: string;
};
...
declare const SplitterPanel: {
    ({ defaultSize: _defaultSize, minSize: _minSize, maxSize: _maxSize, size, style, className, children, ...props }: SplitterPanelProps): React.JSX.Element;
    displayName: string;
};
...
declare const SplitterHandle: {
    ({ index, active, className, ariaLabel, ...props }: SplitterHandleProps): React.JSX.Element;
    displayName: string;
};
