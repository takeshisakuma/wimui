 ...
 */
export declare const RangeCalendar: ({ value, onChange, defaultValue, className, disabled, minDate, maxDate, disabledDates, isDateDisabled, weekStartsOn, ...props }: RangeCalendarProps) => React.JSX.Element;
