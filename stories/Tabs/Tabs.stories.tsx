    ...
    return (
      <Tabs defaultValue="1">
        ...
        <Tabs.Content value="1">
          Manage your general application preferences and theme settings.
        </Tabs.Content>
        <Tabs.Content value="2">
          View and update your personal information and public profile details.
        </Tabs.Content>
        <Tabs.Content value="3">
          Configure how and when you receive alerts from the application.
        </Tabs.Content>
        <Tabs.Content value="4">
          Set up two-factor authentication and manage your data privacy
          settings.
        </Tabs.Content>
        <Tabs.Content value="5">
          Connect and manage third-party tools and services with your account.
        </Tabs.Content>
      </Tabs>
    );
  },
    ...
    return (
      ...
      >
        ...
        <Tabs.Content value="1">
          ...
          <p>
            Welcome to your central management hub. Here you can see a summary
            of all active tasks.
          </p>
        </Tabs.Content>
        <Tabs.Content value="2">
          Detailed insights and performance metrics for your latest projects.
        </Tabs.Content>
        <Tabs.Content value="3">
          Real-time audit trail and developer debug information.
        </Tabs.Content>
        <Tabs.Content value="4">
          Need help? Browse our documentation or contact support.
        </Tabs.Content>
      </Tabs>
    );
  },
