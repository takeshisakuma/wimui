...
export default function WelcomeCard() {
  return (
    <Card variant="glass" padding="xl">
      <Stack gap="md">
        <Title tag="h2" size="lg">Hello Artifacts!</Title>
        <Text>This is a live preview generated by AI.</Text>
      </Stack>
    </Card>
  );
}`;
      ...
      <Box style={{ 
        ...
        >
          <Box p="md" style={{ borderBottom: "1px solid var(--wim-color-border)", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <Title tag="h3" size="sm">AI Assistant</Title>
            {isMobile && (
          ...
          <ChatMessageList style={{ flex: 1, padding: "var(--wim-spacing-md)" }}>
            ...
            >
              <Text size="sm">
                I&apos;ve created a React component for your welcome card. You can preview it and check the code on the right panel.
              </Text>
              <Box mt="sm">
                <Card 
                  variant="outline" 
                ...
                >
                  <Flex align="center" gap="sm">
                    ...
                    <Box style={{ flex: 1 }}>
                      ...
                      <Text size="xs" color="text-secondary">React Component</Text>
                    </Box>
                  </Flex>
                </Card>
              </Box>
            ...
            >
              <Text size="sm">That looks great! Can you make it glassmorphic?</Text>
            </ChatMessage>
          ...
          >
            ...
            <Flex gap="md">
               <Flex align="center" gap="xs">
                 ...
                 <Text size="xs" color="text-secondary">Desktop</Text>
               </Flex>
               <Flex align="center" gap="xs">
                 <Icon component={ExternalLinkIcon} size="xs" color="secondary" />
                 <Text size="xs" color="text-secondary">Published</Text>
               </Flex>
            </Flex>
          </Box>
        </Box>
