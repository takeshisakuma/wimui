...
describe("Timeline", () => {
    ...
    it("applies alignment classes", () => {
        const { container } = render(<Timeline align="alternate"><TimelineItem>Test</TimelineItem></Timeline>);
        expect(container.firstChild).toHaveClass("wim-timeline--alternate");
        expect(container.querySelector(".wim-timeline-item")).toHaveClass("wim-timeline-item--alternate");
    });
