...
const meta: Meta<typeof Popover> = {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: "A popover component for displaying rich content in a portal-like overlay triggered by a button.",
            },
        },
    },
    // tags: ["autodocs"],
        ...
        <Popover {...args}>
            ...
            <PopoverContent>
                <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                    ...
                    <p style={{ margin: 0, color: "var(--text-secondary)", fontSize: "0.9rem" }}>Set the dimensions for the layer.</p>
                    <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                        <div>
                            <Label label="Width" htmlFor="width" style={{ marginBottom: "5px" }} />
                            <Input id="width" defaultValue="100%" />
                        </div>
                        <div>
                            <Label label="Height" htmlFor="height" style={{ marginBottom: "5px" }} />
    ...
    render: (args) => {
        ...
        return (
            <Popover {...args}>
                ...
                <PopoverContent className="custom-width-popover" style={{ width, height }}>
                    <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
                        ...
                        <div style={{ display: "flex", flexDirection: "column", gap: "20px" }}>
                            <div>
                                <Label label="Width" htmlFor="interactive-width" style={{ marginBottom: "5px" }} />
                                <Input
                            ...
                            <div>
                                <Label label="Height" htmlFor="interactive-height" style={{ marginBottom: "5px" }} />
                                <Input
