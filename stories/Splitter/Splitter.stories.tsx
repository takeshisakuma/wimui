...
const PanelContent = ({ children, color }: { children: React.ReactNode; color: string }) => (
    <div style={{
        height: "100%",
        display: "flex",
        alignItems: "center",
...
export const Horizontal: Story = {
    render: () => (
        <div style={{ height: "400px", border: "1px solid var(--wim-color-border-subtle)" }}>
...
export const Nested: Story = {
    render: () => (
        <div style={{ height: "600px", border: "1px solid var(--wim-color-border-subtle)" }}>
            <Splitter orientation="horizontal">
