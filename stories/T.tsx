    ...
    setInterval(() => {
        try {
            ...
            if (targetLocale && currentLang !== targetLocale) {
                ...
                if (!currentLang.startsWith(targetLocale) && !targetLocale.startsWith(currentLang)) {
                    console.log(`[T-GlobalSync] Detection: target=${targetLocale}, current=${currentLang}`);
                    ...
                    if (targetLocale === 'en' && currentLang !== 'en') {
                        console.log(`[T-GlobalSync] Force switching to en: current=${currentLang}`);
