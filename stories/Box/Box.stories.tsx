...
export const Spacing: Story = {
    render: () => (
        <Box bg="#f8fafc" p={20} radius={8} style={{ border: "1px solid #e2e8f0" }}>
            <Box bg="#eff6ff" p={15} mb={15} color="#1d4ed8" radius={4} style={{ border: "1px solid #bfdbfe" }}>
                Margin Bottom 15
            </Box>
            <Box bg="#f0fdf4" p={15} color="#15803d" radius={4} style={{ border: "1px solid #bbf7d0" }}>
                Box 2
            </Box>
        </Box>
    ),
