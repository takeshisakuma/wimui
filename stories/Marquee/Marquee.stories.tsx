    ...
    render: (args) => (
        <div style={{ height: "200px", border: "1px solid #ccc" }}>
            <Marquee {...args} vertical duration={5}>
                <div style={{ padding: "10px", textAlign: "center", fontWeight: "bold" }}>Item 1</div>
                <div style={{ padding: "10px", textAlign: "center", fontWeight: "bold" }}>Item 2</div>
                <div style={{ padding: "10px", textAlign: "center", fontWeight: "bold" }}>Item 3</div>
            </Marquee>
        </div>
    ),
};
