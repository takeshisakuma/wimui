...
export const Container = React.forwardRef(
    <C extends React.ElementType = "div">(
        { size = "lg", fluid = false, style, className, children, ...props }: ContainerProps<C>,
        ref: React.Ref<any>
    ) => {
        const maxWidth = fluid ? "100%" : SIZES[size as keyof typeof SIZES] || (typeof size === "number" ? `${size}px` : size);
