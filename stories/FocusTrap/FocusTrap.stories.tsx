            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", alignItems: "center" }}>
                ...
                {active && (
                    <FocusTrap {...args} active={active}>
                        <div style={{ padding: "20px", border: "2px solid #007bff", borderRadius: "8px", display: "flex", flexDirection: "column", gap: "10px" }}>
                            <h3>Focus Trapped Area</h3>
                            <p>Try tabbing through these elements. Focus will not leave this box.</p>
    ...
    render: (args) => {
        ...
        return (
            <div style={{ display: "flex", flexDirection: "column", gap: "20px", alignItems: "center" }}>
                ...
                {active && (
                    <FocusTrap {...args} active={active}>
                        <div style={{ padding: "20px", border: "2px solid #28a745", borderRadius: "8px", display: "flex", flexDirection: "column", gap: "10px" }}>
