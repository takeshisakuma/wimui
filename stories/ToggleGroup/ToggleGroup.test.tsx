...
describe("ToggleGroup", () => {
    ...
    it("handles single selection", () => {
        ...
        expect(screen.getByText("Option 1").parentElement).toHaveClass("wim-toggle-group__item--active");
    ...
    it("handles multiple selection", () => {
        const handleChange = vi.fn();
        render(<ToggleGroup options={options} selectionMode="multiple" onChange={handleChange} />);
    ...
    it("applies size and fullWidth classes", () => {
        const { container } = render(<ToggleGroup options={options} size="large" fullWidth />);
