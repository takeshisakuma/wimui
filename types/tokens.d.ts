import { WimColorKey as GeneratedColorKey, WimSpacingKey as GeneratedSpacingKey, WimRadiusKey as GeneratedRadiusKey, WimShadowKey as GeneratedShadowKey, WimZIndexKey as GeneratedZIndexKey, WimOpacityKey as GeneratedOpacityKey, WimFontSizeKey as GeneratedFontSizeKey, WimFontWeightKey as GeneratedFontWeightKey, WimLineHeightKey as GeneratedLineHeightKey } from './generated-tokens';
import { WimIntent as GeneratedWimIntent, ButtonIntent as GeneratedButtonIntent, IndicatorIntent as GeneratedIndicatorIntent, FeedbackIntent as GeneratedFeedbackIntent, FieldIntent as GeneratedFieldIntent } from './generated-intents';
/**
 ...
 */
export type WimColorToken = `var(--wim-color-${WimColorKey})` | `var(--wim-${WimColorKey})`;
