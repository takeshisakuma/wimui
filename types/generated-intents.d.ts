...
export declare const WIM_INTENTS: readonly ["primary", "secondary", "success", "warning", "danger", "info", "neutral", "default"];
/**
 * Unified semantic intent values for components.
 */
export type WimIntent = "primary" | "secondary" | "success" | "warning" | "danger" | "info" | "neutral" | "default";
/**
