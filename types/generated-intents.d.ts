...
export declare const WIM_INTENTS: readonly ["primary", "success", "warning", "danger", "info", "neutral", "default"];
/**
 * Unified semantic intent values for components.
 */
export type WimIntent = "primary" | "success" | "warning" | "danger" | "info" | "neutral" | "default";
/**
 ...
 */
export type IndicatorIntent = "primary" | "success" | "warning" | "danger" | "info" | "neutral";
/**
