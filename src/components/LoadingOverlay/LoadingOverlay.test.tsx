...
describe("LoadingOverlay", () => {
    ...
    it("applies fixed class when fixed prop is true", () => {
        const { container } = render(<LoadingOverlay visible={true} fixed={true} />);
    ...
    it("applies custom zIndex when provided", () => {
        ...
        const overlay = container.querySelector(".wim-loading-overlay") as HTMLElement;
    ...
    it("applies blur class", () => {
        const { container } = render(
            <LoadingOverlay visible={true} blur="lg" />
        );
        const backdrop = container.querySelector(
