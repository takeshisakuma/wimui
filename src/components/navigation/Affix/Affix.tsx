...
export const Affix = ({
  ...
  const updatePosition = useCallback(() => {
    ...
    const targetRect =
      targetElement === window || targetElement instanceof Window
    ...
    setState((prevState) => {
      ...
      if (
        ...
        JSON.stringify(prevState.affixStyle) ===
          JSON.stringify(newAffixStyle) &&
        JSON.stringify(prevState.placeholderStyle) ===
          JSON.stringify(newPlaceholderStyle)
      ) {
        return prevState;
      }
      return {
