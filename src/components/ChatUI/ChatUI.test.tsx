...
import { ChatContainer, ChatMessageList, ChatMessage, ChatInput, ChatAvatar } from './ChatUI';
...
describe('ChatContainer', () => {
    ...
    it('applies custom className', () => {
        ...
        expect(container.firstChild).toHaveClass('wim-chat-container', 'custom-class');
    });
});
...
describe('ChatMessageList', () => {
    ...
    it('applies custom className', () => {
        ...
        expect(container.firstChild).toHaveClass('wim-chat-message-list', 'custom-list');
    });
});
...
describe('ChatMessage', () => {
    ...
    it('renders with right position', () => {
        const { container } = render(<ChatMessage position="right">Test</ChatMessage>);
    ...
    it('applies variant classes', () => {
        const { container } = render(<ChatMessage variant="primary">Test</ChatMessage>);
...
describe('ChatAvatar', () => {
    it('renders image when src is provided', () => {
        render(<ChatAvatar src="https://example.com/avatar.jpg" alt="User Avatar" />);
