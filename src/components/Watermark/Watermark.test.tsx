...
describe("Watermark", () => {
    beforeEach(() => {
        ...
        vi.spyOn(HTMLCanvasElement.prototype, 'toDataURL').mockReturnValue("data:image/png;base64,xxxx");
    });
    ...
    it("applies opacity and z-index", () => {
        const { container } = render(<Watermark content="Confidential" zIndex={100} />);
        const watermarkDiv = container.querySelector(".wim-watermark") as HTMLElement;
