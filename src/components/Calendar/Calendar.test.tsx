...
describe("Calendar", () => {
  ...
  it("navigates to previous month", () => {
    ...
    expect(screen.getByText("5 2024")).toBeInTheDocument();
  });
  ...
  it("navigates to next month", () => {
    ...
    expect(screen.getByText("7 2024")).toBeInTheDocument();
  });
  ...
  it("navigates to previous year with Ctrl+PageUp", () => {
    ...
    expect(screen.getByText("6 2023")).toBeInTheDocument();
  });
  ...
  it("disables dates before minDate", () => {
    ...
    const day10 = screen.getByLabelText("1/10/2024");
  ...
  it("disables dates after maxDate", () => {
    ...
    const day20 = screen.getByLabelText("1/20/2024");
  ...
  it("supports rangeMode selection", () => {
    ...
    fireEvent.click(screen.getByLabelText("1/10/2024"));
    expect(onRangeChange).toHaveBeenCalledWith(
      expect.objectContaining({ start: expect.any(Date), end: null }),
    );
    fireEvent.click(screen.getByLabelText("1/20/2024"));
    expect(onRangeChange).toHaveBeenCalledWith(
