...
describe("Accordion", () => {
  ...
  it("handles single selection", async () => {
    ...
    await waitFor(() => {
      const content1 = screen
        .getByText("Content 1")
        .closest(".wim-accordion__content");
  ...
  it("handles multiple selection", async () => {
    ...
    await waitFor(() => {
      expect(
        screen.getByText("Content 1").closest(".wim-accordion__content"),
      ).toHaveClass("wim-accordion__content--open");
      expect(
        screen.getByText("Content 2").closest(".wim-accordion__content"),
      ).toHaveClass("wim-accordion__content--open");
    });
  });
  ...
  it("handles disabled item", () => {
    ...
    expect(
      screen.getByText("Content 1").closest(".wim-accordion__content"),
    ).not.toHaveClass("wim-accordion__content--open");
  });
});
