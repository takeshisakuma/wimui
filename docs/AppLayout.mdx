...
<div className="layout-container">
  <div className="layout-header"><T k="layout_diagram_header" /></div>
  <div className="layout-sidebar"><T k="layout_diagram_sidebar" /></div>
  <div className="layout-main">
    <div className="layout-page-header"><T k="layout_diagram_page_header" /></div>
    <div className="layout-main-content"><T k="layout_diagram_main_content" /></div>
    <div className="layout-toast"><T k="layout_diagram_toast" /></div>
  </div>
  <div className="layout-right"><T k="layout_diagram_right_panel" /></div>
  <div className="layout-footer"><T k="layout_diagram_footer" /></div>
</div>
...
- <T k="guide_layout_responsive_mobile" />
- <T k="guide_layout_responsive_tablet" />
- <T k="guide_layout_responsive_desktop" />
