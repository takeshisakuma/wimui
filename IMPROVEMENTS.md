...
**T70 / T71 は同日に完了した**（どちらも実測つき。詳細は下表）。**次は T32 の 4 枚目（モバイル前提のレイアウト）。** 残る未完了は 6 件（T32 / T65〜T69）。
