...
**T70 / T71 / T65 は同日に完了した**（いずれも実測つき。詳細は下表）。**次は T32 の 4 枚目（モバイル前提のレイアウト）。** 残る未完了は 4 件（T32 / T66 / T68 / T69）。**T67 は 2026-08-05 に完了**（下表）。
