...
// 使っていた箇所が 4 件減った。
// 39 → 35: 2026-08-13（T164）。実測が 35 に下がっていたのに baseline が 39 のままで、
// **新しい違反を 4 件入れても緑のままだった**。スクリプト自身が「下げてコミットしてください」
// と出力していたが、**このガードは husky の hook でしか走っていなかった**ため、
// その出力を読む機会が CI にも audit にも無かった。緩みはガード本体ではなく
// 「どこで走らせるか」の問題だったので、audit-all.js への登録と同時に締める。
const BASELINE = 35;
